...
///     old `MXB App` value survives, pointing into a folder the installer no longer owns.
/// v3: the product is `MXB App` again. Same story the other way round.
pub const AUTOSTART_BINDING_REV: u32 = 3;
