...
export const en = {
  ...
  // The debrief: a session read out one thing at a time.
  "debrief.title": "Session debrief",
  "debrief.headline": "{{n}} laps at {{track}}",
  "debrief.readOn": "read on lap {{lap}}, your fastest",
  "debrief.allLaps": "All laps",
  "debrief.idealLap": "Your ideal lap",
  "debrief.inYou": "{{s}} s already in you",
  "debrief.laps": "Laps",
  "debrief.lapsNote": "{{n}} timed",
  "debrief.verdictBody": "{{n}} sections are worth a look. We'll walk them, then ask how the bike felt.",
  "debrief.theLap": "The lap, start to finish",
  "debrief.fullReview": "Full review of lap {{lap}}",
  "debrief.back": "Back",
  "debrief.nextButton": "Next",
  "debrief.next": "Next: {{what}}",
  "debrief.nextThemes": "what the lap was about",
  "debrief.nextScrub": "how to scrub",
  "debrief.nextBike": "how the bike felt",
  "debrief.thatsIt": "That's the session",
  "debrief.scrubLabel": "Technique",
  "debrief.scrubEyebrow": "Jump technique",
  "debrief.scrubTitle": "Scrub: roll the bike, don't whip it",
  "debrief.scrubBody":
    "A scrub keeps the flight low by rolling the bike as it leaves the lip. Yawing it sideways is a whip: useful for style, but it does not flatten the jump the same way.",
  "debrief.scrub.face.title": "Sit into the face",
  "debrief.scrub.face.body": "Stay low and move the rider forward so the bike has room to lean underneath you.",
  "debrief.scrub.lip.title": "Roll it at the lip",
  "debrief.scrub.lip.body": "Lean the bike over as the rear wheel leaves. Starting once you are airborne is too late.",
  "debrief.scrub.air.title": "Keep the flight low",
  "debrief.scrub.air.body": "Commit to roll, not yaw. Let the bike travel underneath you instead of lifting your body with it.",
  "debrief.scrub.land.title": "Bring it back",
  "debrief.scrub.land.body": "Counter the lean in the air early enough to put both wheels down straight.",
  "debrief.scrubCue":
    "When the fast lap demonstrates it, Coach calls SCRUB at the takeoff. If your lap floats, its section explains which part—timing, roll, stance, rider position, or return—you missed.",
  ...
  "review.tabSub.lap": "The whole lap: where the time went and the traces behind it.",
  "review.tabSub.sections": "One corner at a time: where it is, and what you did in it.",
  "review.tabSub.setup": "What the lap did to the suspension, and what to change on the bike.",
  "review.tabSub.ingame": "What the coach tells you while you ride, and where it sits on screen.",
  ...
  "susp.title": "Suspension",
  "susp.body": "How much of each end's travel this lap used, and the deepest it went.",
  "susp.front": "Fork",
  "susp.rear": "Shock",
  "susp.reading": "{{used}} used, {{deep}} deepest",
  "susp.fork": "Fork: {{used}} of its travel used, {{deep}} at the deepest",
  "susp.shock": "Shock: {{used}} of its travel used, {{deep}} at the deepest",
  "review.legendYou": "Your line",
  "review.legendRef": "Fast lap",
  "review.legendLaps": "Every other lap, fastest to slowest",
  "review.legendMapLost": "Your line, where it lost time",
  "review.legendMapGained": "Your line, where it gained",
  "review.legendMapPicked": "{{name}}, the corner you're on",
  "review.legendLost": "{{name}} — where this lap lost time",
  "review.legendGained": "{{name}} — where this lap gained",
  "review.legendLevel": "{{name}} — level with the fast lap",
  ...
  "overlay.linkDown": "Coach couldn't open its link to MXB App, so the two can't share one shortcut or show each other's tabs. Coach is holding its own shortcut. A firewall or antivirus blocking local connections is the usual cause.",
  ...
  "overlay.deferred.updateCoach": "Update Coach to share this shortcut with MXB App.",
  "debrief.viewLine": "The line",
  "debrief.viewReplay": "What you did",
  "replay.title": "What you did here",
  "replay.play": "Play",
  "replay.pause": "Pause",
  "replay.again": "Again",
  "replay.endStop": "Stop at the end",
  "replay.endLoop": "Play it round again",
  "replay.endNext": "Run on to the next corner",
  "replay.you": "You",
  "replay.best": "Your best lap",
  "replay.speed": "Speed",
  "replay.gear": "Gear",
  "replay.throttle": "Throttle",
  "replay.brake": "Brake",
  "replay.entry": "Entry",
  "replay.apex": "Apex",
  "replay.exit": "Exit",
  "replay.slower": "{{s}}s slower here",
  "replay.faster": "{{s}}s faster here",
  "replay.bodyUnknown": "Your body isn't in this recording, so only the bike moves. Bind the lean and sit controls in MX Bikes and the coach will record them next time.",
  "replay.noFrames": "This section wasn't recorded in enough detail to play back.",
};
