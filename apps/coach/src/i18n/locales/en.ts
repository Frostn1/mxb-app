...
export const en = {
  ...
  "review.tabSub.sections": "One corner at a time, and where it is on the track.",
  "review.tabSub.track": "The track in 3D, with your line on it and where it pays to run.",
