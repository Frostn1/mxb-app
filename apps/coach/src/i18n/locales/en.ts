...
export const en = {
  ...
  "cues.moveOn":
    "The calls move on. Send them again after a few laps and the coach drops what you've taken and calls what's costing you time now.",
  ...
  "hud.cuePosBody": "Pick a corner of the screen for the live cue. Needs the recorder from FrostMod 0.24 or newer.",
