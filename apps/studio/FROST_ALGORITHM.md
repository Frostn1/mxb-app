...
|---|---|---|---|
| 0.35.0 | 2026-09-15 | feature/track-discipline | MX, SX and SMX: a rules table per discipline (plot, lap, width, start, finish jump, gates, review bands); SX is a new stadium walker, parallel lanes joined by 180s on a flat floor with a 22-gate start; SMX walks the outdoor lap flatter and tighter; MX draws exactly what it drew before |
