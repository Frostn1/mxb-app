...
|---|---|---|---|
| 0.33.0 | 2026-09-15 | feature/byo-llm-trackgen | the random lap takes settings — lap length, width, corners, jumps, surface, wear, ARL roughness, hills — so a model can pick them from a brief; with none given it draws exactly what it drew before |
