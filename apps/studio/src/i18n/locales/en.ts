...
export const en = {
  ...
  "bike.multiPartHint": "This looks like more than one part — chassis, suspension, wheels… Studio can't split a whole bike into parts yet, so check the role, or bring each part in its own file.",
  "bike.noRole": "No role",
