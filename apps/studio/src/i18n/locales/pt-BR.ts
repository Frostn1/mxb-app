...
export const ptBR: Translation = {
  ...
  "bike.multiPartHint": "Isso parece ser mais de uma peça — chassi, suspensão, rodas… O Studio ainda não consegue dividir uma moto inteira em peças, então confira a função, ou traga cada peça em seu próprio arquivo.",
