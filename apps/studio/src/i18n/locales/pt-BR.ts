...
export const ptBR: Translation = {
  ...
  "designer.aiTitle": "Edição por IA",
  "designer.aiPlaceholder": "Coloque o logo no para-lama direito…",
  "designer.aiApply": "Aplicar edição por IA",
  "designer.aiChanged": "Pintura editada",
  "designer.aiNoChange": "A IA não retornou uma edição segura",
  "designer.aiFailed": "Não foi possível editar a pintura",
  "track.askAi": "Perguntar à IA",
  "track.edited": "Pista editada",
  "track.editFailed": "Não foi possível editar a pista",
  "nav.pose": "Pose",
  ...
  "bike.step2": "Peças",
  "bike.step3": "Construção",
  "bike.shadowModel": "Modelo de sombra — uma malha de baixo detalhe e sem textura que o MX Bikes usa para sombras, não o modelo dirigível.",
  "bike.missingTextures": "Texturas ausentes: {{names}}",
  "bike.blender": "Blender",
  "bike.looking": "Procurando o Blender…",
  "bike.blenderFound": "Blender {{version}} está pronto.",
  "bike.blenderTooOld": "O Blender {{version}} é antigo demais. O montador de motos precisa do {{min}} ou mais recente.",
  "bike.blenderMissing": "Blender não encontrado. Instale o Blender {{min}} ou mais recente (é grátis) ou escolha o blender.exe.",
  "bike.chooseBlender": "Escolher blender.exe",
  "bike.findBlender": "Encontrar automaticamente",
  "bike.notBlender": "Isso não é um Blender que o Studio consiga abrir.",
  "bike.blenderCheckFailed": "Não foi possível verificar o Blender",
  "bike.partFiles": "Peças de moto",
  "bike.parts": "Peças",
  "bike.addParts": "Adicionar peças…",
  "bike.adding": "Adicionando {{n}} de {{of}}…",
  "bike.partsEmpty": "Nenhuma peça ainda. Adicione arquivos .blend, .fbx ou .obj: o Blender abre cada um em segundo plano, renderiza uma miniatura e adivinha o que é.",
  "bike.partStats": "{{tris}} triângulos · {{empties}} pontos de fixação",
  "bike.partMissing": "O arquivo sumiu",
  "bike.partStale": "O arquivo mudou: atualize",
  "bike.dragToPlace": "Arraste para a moto para preencher o espaço dela",
  "bike.multiPartHint": "Isso parece ser mais de uma peça — chassi, suspensão, rodas… Divida em peças, ou confira a função se a intenção era trazer como uma peça só.",
  "bike.splitIntoParts": "Dividir em peças",
  "bike.splitFailed": "Não foi possível dividir em peças",
  "bike.roleHintsFound": "Parece ter:",
  "bike.useAsBase": "Usar como moto base",
  "bike.useAsBaseFailed": "Não foi possível usar como moto base",
  "bike.makeAPart": "Criar uma peça…",
  "bike.place": "Colocar ▸",
  "bike.placed": "Colocada",
  "bike.placeNeedsRole": "Defina uma função primeiro",
  "bike.placeFailed": "Não foi possível colocar a peça",
  "bike.noRole": "Sem função",
  "bike.guessed": "palpite",
  "bike.refreshPart": "Passar pelo Blender de novo",
  "bike.removePart": "Tirar da biblioteca (seu arquivo fica)",
  "bike.slots": "Moto",
  "bike.slotsHint": "Uma peça em cada espaço. Cada espaço lista as peças com a sua função.",
  "bike.collapseSlots": "Recolher a lista",
  "bike.emptySlot": "Vazio",
  "bike.noPartsForRole": "Nenhuma peça com essa função",
  "bike.libraryFailed": "Não foi possível ler a biblioteca de peças",
  "bike.addFailed": "Não foi possível adicionar {{name}}",
  "bike.roleFailed": "Não foi possível definir a função",
  "bike.removeFailed": "Não foi possível remover a peça",
  "bike.slotFailed": "Não foi possível preencher o espaço",
  "bike.role.chassis": "Chassi",
  "bike.role.steer": "Direção",
  "bike.role.fsusp": "Suspensão dianteira",
  "bike.role.rsusp": "Suspensão traseira",
  "bike.role.wheel_f": "Roda dianteira",
  "bike.role.wheel_r": "Roda traseira",
  "bike.role.levers": "Manetes",
  "bike.role.pedals": "Pedaleiras e pedais",
  "bike.modeAssemble": "Montar",
  "bike.modeMaker": "Oficina de peças",
  "bike.assemble": "Montagem",
  "bike.addPlaceholder": "Adicionar moto de exemplo",
  "bike.placeholderHint": "A própria moto de exemplo do Studio, sem peças reais — boa para testar a montagem antes de ter a geometria de uma moto instalada.",
  "bike.placeholderFailed": "Não foi possível criar a moto de exemplo",
  "bike.template": "Modelo",
  ...
  "bike.startFromBikeScopeNote": "Suas motos de mods instaladas. Motos OEM/de fábrica que vêm com o próprio jogo ainda não aparecem aqui.",
  "bike.bikeProtected": "Conteúdo protegido — esta versão não consegue lê-lo",
  ...
  "bike.templateFailed": "Essa moto não pode ser modelo",
  "bike.templateProblem": "Não foi possível ler o modelo, então o exemplo entra no lugar: {{problem}}",
  "bike.baseBikeHint": "Escolha uma moto instalada, importe um arquivo de moto completa, ou comece pelo exemplo.",
  "bike.baseBikeStep": "Passo 1: moto base",
  "bike.pickBaseBike": "Escolher uma moto base",
  "bike.importFullBikeFile": "Importar um arquivo de moto completa…",
  "bike.importBaseFailed": "Não foi possível importar como moto base",
  "bike.assembleEmpty": "Preencha alguns espaços à esquerda para ver a moto aqui.",
  "bike.pickBaseFirst": "Escolha uma moto base acima para começar.",
  "bike.assemblyFailed": "Não foi possível montar a moto",
  "bike.pickToNudge": "Clique numa peça, ou escolha uma abaixo, para ajustá-la.",
  "bike.nudgeFor": "Ajustar {{role}}:",
  "bike.forward": "Frente",
  "bike.back": "Trás",
  "bike.up": "Cima",
  "bike.down": "Baixo",
  "bike.left": "Esquerda",
  "bike.right": "Direita",
  "bike.resetNudge": "Voltar para onde encaixou",
  "bike.removeFromSlot": "Tirar deste espaço (continua na bandeja)",
  "bike.nudged": "movida x {{x}} y {{y}} z {{z}} mm",
  "bike.nudgeFailed": "Não foi possível ajustar a peça",
  "bike.previewPartFailed": "{{role}} não carregou: {{message}}",
  "bike.snappedBy": "encaixada pelo {{by}}",
  "bike.by.empty": "ponto de fixação",
  "bike.by.centre": "centro",
  "bike.by.modelled": "lugar onde foi modelada",
  "bike.build": "Construir",
  "bike.buildNamePlaceholder": "Nome da moto",
  "bike.buildIt": "Construir a moto",
  "bike.buildReport": "Como ela foi construída",
  "bike.buildFailed": "A construção falhou",
  "bike.openFolder": "Abrir pasta",
  "bike.shadow": "sombra",
  "bike.maker": "Oficina de peças",
  "bike.makerHint": "Descreva uma peça, ou escolha um modelo e mexa nos controles. O Blender a constrói; guarde-a e ela vai para a bandeja com sua função.",
  "bike.briefPlaceholder": "ex.: protetores de mão envolventes estilo KTM, laranja, baixos",
  "bike.makeIt": "Criar",
  "bike.addImages": "Imagens de referência",
  "bike.images": "Imagens",
  "bike.removeImage": "Remover imagem",
  "bike.byWords": "lido das palavras (configure um modelo nas Configurações para descrever livremente)",
  "bike.byModel": "por {{model}}",
  "bike.askFailed": "Não foi possível ler a descrição",
  "bike.makerFailed": "Não foi possível carregar os modelos da oficina",
  "bike.previewFailed": "O Blender não conseguiu construir a peça",
  "bike.codeHint": "Nenhum modelo serve, então a IA escreveu código do Blender. Ele é verificado antes de rodar: leia e depois rode.",
  "bike.runCode": "Rodar no Blender",
  "bike.backToTemplate": "Voltar ao modelo",
  "bike.makerTemplate": "Modelo",
  "bike.colour": "Cor",
  "bike.updatePreview": "Atualizar prévia",
  "bike.madeStats": "{{role}} · {{tris}} triângulos",
  "bike.partName": "Nome da peça",
  "bike.keepPart": "Adicionar à bandeja",
  "bike.kept": "{{name}} está na bandeja",
  "bike.keepFailed": "Não foi possível guardar a peça",
  "bike.role.handguards": "Protetores de mão",
  "bike.role.plate": "Placa de número",

  // ── Replay ────────────────────────────────────────────────────────────────
  "nav.replay": "Replay",
  "replay.title": "Replay",
  "replay.setup": "Gravação",
  "replay.recordNow": "Gravar",
  "replay.stop": "Parar",
  "replay.recording": "Gravando — {{time}}",
  "replay.byTheMod": "Quem começou foi o Replay Mod. Para quando o plano acaba.",
  "replay.byHand": "Começou na mão. Vai até você parar ou o limite estourar.",
  "replay.waiting": "Pronto",
  "replay.waitingDetail": "Voe um caminho de câmera no jogo e o Studio guarda. Nada para apertar.",
  "replay.noFfmpeg": "Ainda sem codificador",
  "replay.noFfmpegDetail": "Gravar precisa do ffmpeg. O Studio pode baixar um — vai para a pasta dele, não para o Windows.",
  "replay.noMod": "O Replay Mod nunca rodou aqui",
  "replay.noModDetail": "Instale pela página de Plugins do MXB App e reproduza um caminho uma vez, para o jogo e o Studio se encontrarem.",
  "replay.gameClosed": "MX Bikes não está aberto",
  "replay.gameClosedDetail": "Abra o jogo e um replay. Esta janela pode ficar fechada: a gravação não precisa dela.",
  "replay.fullscreenWarning": "Seu ffmpeg não captura um jogo em tela cheia exclusiva, então sairia preto. Jogue em janela sem bordas, ou baixe o ffmpeg do Studio.",
  "replay.recordings": "Gravações",
  "replay.noRecordings": "Nada gravado ainda",
  "replay.openFolder": "Abrir pasta",
  "replay.reveal": "Mostrar na pasta",
  "replay.paths": "Caminhos de câmera",
  "replay.pathsDesc": "Os arquivos .fcam que o mod salvou. Dá para compartilhar: passe um e outro piloto voa o seu plano.",
  "replay.noPaths": "Nenhum caminho salvo ainda",
  "replay.slotN": "Slot {{n}}",
  "replay.auto": "Gravar sozinho",
  "replay.autoDesc": "Começa quando o mod voa um caminho e para junto com ele. É essa opção que substitui o OBS.",
  "replay.quality": "Qualidade",
  "replay.qualityHigh": "Alta",
  "replay.qualityBalanced": "Equilibrada",
  "replay.qualitySmall": "Leve",
  "replay.fps": "Quadros por segundo",
  "replay.encoder": "Codificador",
  "replay.encoderDesc": "Auto usa o da sua placa de vídeo e deixa o processador para o jogo.",
  "replay.encoderAuto": "Auto",
  "replay.encoderBinary": "ffmpeg",
  "replay.ffmpegMissing": "Não encontrado neste computador",
  "replay.getFfmpeg": "Obter ffmpeg",
  "replay.ffmpegReady": "ffmpeg está pronto. Já dá para gravar.",
  "replay.folder": "Salvar em",
  "replay.folderDefault": "Vídeos\\Frost Replays",
  "replay.audio": "Som",
  "replay.audioDesc": "Um dispositivo de gravação do Windows, com o nome exato que o ffmpeg dá. Vazio grava em silêncio.",
  "replay.audioSilent": "Sem som",
  "replay.hotkey": "Tecla de gravação",
  "replay.hotkeyDesc": "Funciona dentro do jogo, então você nunca sai dele para começar.",
  ...
  "studioSettings.model": "IA do Studio",
  ...
  "place.searchHint": "Mire no meio do circuito, não no portão. Quando achar algo, você pode abrir a foto aérea e apontar para a pista. Nada é baixado até você pedir.",
  "place.noHits": "Nada encontrado com esse nome, e nenhuma pista com esse nome no mapa. Procure a cidade mais próxima e toque em “Pistas por perto”.",
  "place.near": "Pistas por perto",
  "place.nearSearching": "Procurando…",
  "place.nearHint": "Todas as pistas de motocross num raio de 40 km, direto do mapa. Sem coordenadas.",
  "place.noneNear": "Não há nenhuma pista de motocross mapeada num raio de 40 km daí. Tente uma cidade mais perto, ou aponte na foto aérea.",
  "place.away": "a {{km}} km",
