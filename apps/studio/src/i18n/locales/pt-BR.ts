...
export const ptBR: Translation = {
  ...
  "track.ask.program": "Volta inteira",
  "track.ask.settings": "Só ajustes",
  "track.generatingSettingsHint":
    "O modelo escolhe os ajustes e depois uma volta é traçada a partir deles. Em geral menos de um minuto.",
