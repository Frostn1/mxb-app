...
export const de: Translation = {
  ...
  "bike.multiPartHint": "Das sieht nach mehr als einem Teil aus – Rahmen, Federung, Räder… Studio kann ein ganzes Bike noch nicht automatisch in Teile zerlegen, also prüfe die Rolle oder bringe jedes Teil in einer eigenen Datei mit.",
