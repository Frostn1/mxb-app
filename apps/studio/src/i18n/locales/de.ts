...
export const de: Translation = {
  ...
  "track.ask.program": "Ganze Runde",
  "track.ask.settings": "Nur Einstellungen",
  "track.generatingSettingsHint":
    "Das Modell wählt die Einstellungen, dann wird daraus eine Runde gezeichnet. Meist unter einer Minute.",
