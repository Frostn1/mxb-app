...
export const de: Translation = {
  ...
  "designer.aiTitle": "KI-Bearbeitung",
  "designer.aiPlaceholder": "Platziere das Logo auf dem rechten Kotflügel…",
  "designer.aiApply": "KI-Bearbeitung anwenden",
  "designer.aiChanged": "Lackierung bearbeitet",
  "designer.aiNoChange": "Die KI hat keine sichere Bearbeitung geliefert",
  "designer.aiFailed": "Lackierung konnte nicht bearbeitet werden",
  "track.askAi": "KI fragen",
  "track.edited": "Strecke bearbeitet",
  "track.editFailed": "Strecke konnte nicht bearbeitet werden",
  "nav.pose": "Pose",
  ...
  "bike.parts": "Teile",
  "bike.addParts": "Teile hinzufügen…",
  "bike.adding": "Füge {{n}} von {{of}} hinzu…",
  "bike.partsEmpty": "Noch keine Teile. Füge .blend-, .fbx- oder .obj-Dateien hinzu: Blender öffnet jede im Hintergrund, rendert ein Vorschaubild und errät, was sie ist.",
  "bike.partStats": "{{tris}} Dreiecke · {{empties}} Ankerpunkte",
  "bike.partMissing": "Die Datei ist weg",
  "bike.partStale": "Die Datei hat sich geändert: aktualisieren",
  "bike.dragToPlace": "Auf das Bike ziehen, um den Platz zu belegen",
  "bike.multiPartHint": "Das sieht nach mehr als einem Teil aus – Rahmen, Federung, Räder… Zerlege es in seine Teile, oder prüfe die Rolle, wenn es als ein Teil gedacht war.",
  "bike.splitIntoParts": "In Teile zerlegen",
  "bike.splitFailed": "Konnte nicht in Teile zerlegt werden",
  "bike.roleHintsFound": "Sieht aus wie:",
  "bike.useAsBase": "Als Basis-Bike verwenden",
  "bike.useAsBaseFailed": "Konnte nicht als Basis-Bike verwendet werden",
  "bike.makeAPart": "Teil erstellen…",
  "bike.place": "Platzieren ▸",
  "bike.placed": "Platziert",
  "bike.placeNeedsRole": "Erst eine Rolle festlegen",
  "bike.placeFailed": "Teil konnte nicht platziert werden",
  "bike.noRole": "Keine Rolle",
  "bike.guessed": "geraten",
  "bike.refreshPart": "Nochmal durch Blender laufen lassen",
  "bike.removePart": "Aus der Bibliothek entfernen (deine Datei bleibt)",
  "bike.slots": "Bike",
  "bike.slotsHint": "Ein Teil pro Platz. Jeder Platz zeigt die Teile mit seiner Rolle.",
  "bike.collapseSlots": "Liste einklappen",
  "bike.emptySlot": "Leer",
  "bike.noPartsForRole": "Keine Teile mit dieser Rolle",
  "bike.libraryFailed": "Die Teilebibliothek konnte nicht gelesen werden",
  "bike.addFailed": "{{name}} konnte nicht hinzugefügt werden",
  "bike.roleFailed": "Die Rolle konnte nicht gesetzt werden",
  "bike.removeFailed": "Das Teil konnte nicht entfernt werden",
  "bike.slotFailed": "Der Platz konnte nicht belegt werden",
  "bike.role.chassis": "Rahmen",
  "bike.role.steer": "Lenkung",
  "bike.role.fsusp": "Vorderradfederung",
  "bike.role.rsusp": "Hinterradfederung",
  "bike.role.wheel_f": "Vorderrad",
  "bike.role.wheel_r": "Hinterrad",
  "bike.role.levers": "Hebel",
  "bike.role.pedals": "Fußrasten & Pedale",
  "bike.modeAssemble": "Zusammenbauen",
  "bike.modeMaker": "Teile-Werkstatt",
  "bike.assemble": "Zusammenbauen",
  "bike.addPlaceholder": "Platzhalter-Bike hinzufügen",
  "bike.placeholderHint": "Studios eigenes Bike, ohne echte Teile – gut, um den Zusammenbau zu testen, bevor du die Geometrie eines installierten Bikes hast.",
  "bike.placeholderFailed": "Das Platzhalter-Bike konnte nicht erstellt werden",
  "bike.template": "Vorlage",
  "bike.placeholderTemplate": "Studios Platzhalter",
  "bike.startFromBike": "Von einem installierten Bike starten",
  "bike.startFromBikeEmpty": "Noch keine installierten Bikes im Mods-Ordner gefunden.",
  "bike.startFromBikeScopeNote": "Deine installierten Mod-Bikes. OEM-/Serien-Bikes, die mit dem Spiel selbst kommen, stehen hier noch nicht.",
  "bike.bikeProtected": "Geschützter Inhalt – diese Version kann ihn nicht lesen",
  "bike.bikeLocked": "Gesperrt – kann ohne Entschlüsselung nicht gelesen werden",
  "bike.chooseTemplate": "Bike wählen…",
  ...
  "bike.pickBaseBike": "Basis-Bike wählen",
  ...
  "bike.assembleEmpty": "Belege ein paar Plätze links, um das Bike hier zu sehen.",
  "bike.pickBaseFirst": "Wähle oben ein Basis-Bike, um loszulegen.",
  "bike.assemblyFailed": "Das Bike konnte nicht zusammengebaut werden",
  "bike.pickToNudge": "Klicke auf ein Teil oder wähle unten eins, um es zu verschieben.",
  "bike.nudgeFor": "{{role}} verschieben:",
  "bike.forward": "Vor",
  "bike.back": "Zurück",
  "bike.up": "Hoch",
  "bike.down": "Runter",
  "bike.left": "Links",
  "bike.right": "Rechts",
  "bike.resetNudge": "Zurück an den Einrastpunkt",
  "bike.removeFromSlot": "Aus diesem Platz entfernen (bleibt im Fach)",
  "bike.nudged": "verschoben x {{x}} y {{y}} z {{z}} mm",
  "bike.nudgeFailed": "Das Teil konnte nicht verschoben werden",
  "bike.previewPartFailed": "{{role}} konnte nicht geladen werden: {{message}}",
  "bike.snappedBy": "eingerastet über {{by}}",
  "bike.by.empty": "seinen Ankerpunkt",
  "bike.by.centre": "seine Mitte",
  "bike.by.modelled": "seine modellierte Lage",
  "bike.build": "Bauen",
  ...
  "bike.maker": "Teile-Werkstatt",
  "bike.makerHint": "Beschreibe ein Teil oder wähle eine Vorlage und bewege die Regler. Blender baut es; behalte es, und es landet mit seiner Rolle in der Ablage.",
  "bike.briefPlaceholder": "z. B. KTM-Handprotektoren mit Alubügel, orange, flach",
  "bike.makeIt": "Bauen",
  "bike.addImages": "Referenzbilder",
  "bike.images": "Bilder",
  "bike.removeImage": "Bild entfernen",
  "bike.byWords": "aus den Worten gelesen (richte in den Einstellungen ein Modell ein, um Teile frei zu beschreiben)",
  "bike.byModel": "von {{model}}",
  "bike.askFailed": "Die Beschreibung konnte nicht gelesen werden",
  "bike.makerFailed": "Die Vorlagen der Teile-Werkstatt konnten nicht geladen werden",
  "bike.previewFailed": "Blender konnte das Teil nicht bauen",
  "bike.codeHint": "Keine Vorlage passt, also hat das Modell Blender-Code geschrieben. Er wird vor dem Ausführen geprüft: lies ihn, dann führe ihn aus.",
  "bike.runCode": "In Blender ausführen",
  "bike.backToTemplate": "Zurück zur Vorlage",
  "bike.makerTemplate": "Vorlage",
  "bike.colour": "Farbe",
  "bike.updatePreview": "Vorschau aktualisieren",
  "bike.madeStats": "{{role}} · {{tris}} Dreiecke",
  "bike.partName": "Teilename",
  "bike.keepPart": "In die Ablage",
  "bike.kept": "{{name}} ist in der Ablage",
  "bike.keepFailed": "Das Teil konnte nicht behalten werden",
  "bike.role.handguards": "Handprotektoren",
  "bike.role.plate": "Startnummerntafel",
  ...
  "studioSettings.model": "Studio-KI",
