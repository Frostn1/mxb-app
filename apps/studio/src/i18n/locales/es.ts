...
export const es: Translation = {
  ...
  "track.ask.program": "Vuelta completa",
  "track.ask.settings": "Solo ajustes",
  "track.generatingSettingsHint":
    "El modelo elige los ajustes y con ellos se traza una vuelta. Normalmente menos de un minuto.",
