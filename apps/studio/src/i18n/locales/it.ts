...
export const it: Translation = {
  ...
  "track.ask.program": "Giro intero",
  "track.ask.settings": "Solo impostazioni",
  "track.generatingSettingsHint":
    "Il modello sceglie le impostazioni, poi da quelle si traccia un giro. Di solito meno di un minuto.",
