...
export const it: Translation = {
  ...
  "bike.multiPartHint": "Sembra più di una parte — telaio, sospensioni, ruote… Studio non può ancora dividere una moto intera in parti, quindi controlla il ruolo, oppure porta ogni parte nel suo file.",
