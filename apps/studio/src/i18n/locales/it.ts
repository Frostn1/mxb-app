...
export const it: Translation = {
  ...
  "designer.aiTitle": "Modifica IA",
  "designer.aiPlaceholder": "Metti il logo sul parafango destro…",
  "designer.aiApply": "Applica modifica IA",
  "designer.aiChanged": "Livrea modificata",
  "designer.aiNoChange": "L'IA non ha restituito una modifica sicura",
  "designer.aiFailed": "Impossibile modificare la livrea",
  "track.askAi": "Chiedi all'IA",
  "track.edited": "Pista modificata",
  "track.editFailed": "Impossibile modificare la pista",
  "nav.pose": "Posa",
  ...
  "bike.step2": "Parti",
  "bike.step3": "Costruzione",
  "bike.shadowModel": "Modello ombra — una mesh a bassa risoluzione senza texture che MX Bikes usa per le ombre, non il modello guidabile.",
  "bike.missingTextures": "Texture mancanti: {{names}}",
  "bike.blender": "Blender",
  "bike.looking": "Cerco Blender…",
  "bike.blenderFound": "Blender {{version}} è pronto.",
  "bike.blenderTooOld": "Blender {{version}} è troppo vecchio. Il costruttore di moto richiede {{min}} o successivo.",
  "bike.blenderMissing": "Blender non trovato. Installa Blender {{min}} o successivo (è gratuito) oppure scegli blender.exe.",
  "bike.chooseBlender": "Scegli blender.exe",
  "bike.findBlender": "Trovalo automaticamente",
  "bike.notBlender": "Questo non è un Blender che Studio può avviare.",
  "bike.blenderCheckFailed": "Impossibile verificare Blender",
  "bike.partFiles": "Pezzi della moto",
  "bike.parts": "Parti",
  "bike.addParts": "Aggiungi parti…",
  "bike.adding": "Aggiungo {{n}} di {{of}}…",
  "bike.partsEmpty": "Ancora nessuna parte. Aggiungi file .blend, .fbx o .obj: Blender apre ciascuno in background, crea una miniatura e indovina cos'è.",
  "bike.partStats": "{{tris}} triangoli · {{empties}} punti di aggancio",
  "bike.partMissing": "Il file non c'è più",
  "bike.partStale": "Il file è cambiato: aggiornalo",
  "bike.dragToPlace": "Trascinala sulla moto per riempire il suo slot",
  "bike.multiPartHint": "Sembra più di una parte — telaio, sospensioni, ruote… Dividila nelle sue parti, oppure controlla il ruolo se volevi portarla come una sola.",
  "bike.splitIntoParts": "Dividi in parti",
  "bike.splitFailed": "Impossibile dividerla in parti",
  "bike.roleHintsFound": "Sembra che ci sia:",
  "bike.useAsBase": "Usa come moto base",
  "bike.useAsBaseFailed": "Impossibile usarla come moto base",
  "bike.makeAPart": "Crea un pezzo…",
  "bike.place": "Posiziona ▸",
  "bike.placed": "Posizionato",
  "bike.placeNeedsRole": "Imposta prima un ruolo",
  "bike.placeFailed": "Impossibile posizionare il pezzo",
  "bike.noRole": "Nessun ruolo",
  "bike.guessed": "indovinato",
  "bike.refreshPart": "Ripassalo in Blender",
  "bike.removePart": "Togli dalla libreria (il tuo file resta)",
  "bike.slots": "Moto",
  "bike.slotsHint": "Una parte per slot. Ogni slot elenca le parti del suo ruolo.",
  "bike.collapseSlots": "Comprimi l'elenco",
  "bike.emptySlot": "Vuoto",
  "bike.noPartsForRole": "Nessuna parte con questo ruolo",
  "bike.libraryFailed": "Impossibile leggere la libreria delle parti",
  "bike.addFailed": "Impossibile aggiungere {{name}}",
  "bike.roleFailed": "Impossibile impostare il ruolo",
  "bike.removeFailed": "Impossibile togliere la parte",
  "bike.slotFailed": "Impossibile riempire lo slot",
  "bike.role.chassis": "Telaio",
  "bike.role.steer": "Sterzo",
  "bike.role.fsusp": "Sospensione anteriore",
  "bike.role.rsusp": "Sospensione posteriore",
  "bike.role.wheel_f": "Ruota anteriore",
  "bike.role.wheel_r": "Ruota posteriore",
  "bike.role.levers": "Leve",
  "bike.role.pedals": "Pedane e pedali",
  "bike.modeAssemble": "Assembla",
  "bike.modeMaker": "Officina parti",
  "bike.assemble": "Assemblaggio",
  "bike.addPlaceholder": "Aggiungi moto di prova",
  "bike.placeholderHint": "La moto di prova di Studio, senza parti reali — utile per provare il montaggio prima di avere la geometria di una moto installata.",
  "bike.placeholderFailed": "Impossibile creare la moto di prova",
  "bike.template": "Modello",
  ...
  "bike.startFromBikeScopeNote": "Le tue moto mod installate. Le moto OEM/di serie incluse nel gioco stesso non sono ancora qui.",
  "bike.bikeProtected": "Contenuto protetto — questa build non può leggerlo",
  ...
  "bike.templateFailed": "Quella moto non può fare da modello",
  "bike.templateProblem": "Il modello non si legge, lo sostituisce quella di prova: {{problem}}",
  "bike.baseBikeHint": "Scegli una moto installata, importa un file di moto completa, oppure parti da quella di prova.",
  "bike.baseBikeStep": "Passo 1: moto base",
  "bike.pickBaseBike": "Scegli una moto base",
  "bike.importFullBikeFile": "Importa un file di moto completa…",
  "bike.importBaseFailed": "Impossibile importarla come moto base",
  "bike.assembleEmpty": "Riempi qualche slot a sinistra per vedere la moto qui.",
  "bike.pickBaseFirst": "Scegli una moto base qui sopra per iniziare.",
  "bike.assemblyFailed": "Impossibile assemblare la moto",
  "bike.pickToNudge": "Clicca una parte, o sceglila qui sotto, per spostarla.",
  "bike.nudgeFor": "Sposta {{role}}:",
  "bike.forward": "Avanti",
  "bike.back": "Indietro",
  "bike.up": "Su",
  "bike.down": "Giù",
  "bike.left": "Sinistra",
  "bike.right": "Destra",
  "bike.resetNudge": "Rimettila dove si è agganciata",
  "bike.removeFromSlot": "Toglila da questo slot (resta nel vassoio)",
  "bike.nudged": "spostata x {{x}} y {{y}} z {{z}} mm",
  "bike.nudgeFailed": "Impossibile spostare la parte",
  "bike.previewPartFailed": "{{role}} non si è caricata: {{message}}",
  "bike.snappedBy": "agganciata da {{by}}",
  "bike.by.empty": "il suo punto di aggancio",
  "bike.by.centre": "il suo centro",
  "bike.by.modelled": "dov'era modellata",
  "bike.build": "Costruisci",
  "bike.buildNamePlaceholder": "Nome della moto",
  "bike.buildIt": "Costruisci la moto",
  "bike.buildReport": "Come è stata costruita",
  "bike.buildFailed": "La costruzione è fallita",
  "bike.openFolder": "Apri cartella",
  "bike.shadow": "ombra",
  "bike.maker": "Officina parti",
  "bike.makerHint": "Descrivi una parte, o scegli un modello e muovi i cursori. Blender la costruisce; tienila e finisce nel vassoio con il suo ruolo.",
  "bike.briefPlaceholder": "es. paramani avvolgenti stile KTM, arancioni, bassi",
  "bike.makeIt": "Crea",
  "bike.addImages": "Immagini di riferimento",
  "bike.images": "Immagini",
  "bike.removeImage": "Rimuovi immagine",
  "bike.byWords": "letto dalle parole (configura un modello nelle Impostazioni per descrivere liberamente)",
  "bike.byModel": "da {{model}}",
  "bike.askFailed": "Impossibile leggere la descrizione",
  "bike.makerFailed": "Impossibile caricare i modelli dell'officina",
  "bike.previewFailed": "Blender non è riuscito a costruire la parte",
  "bike.codeHint": "Nessun modello va bene, quindi l'IA ha scritto codice Blender. Viene controllato prima di girare: leggilo, poi eseguilo.",
  "bike.runCode": "Esegui in Blender",
  "bike.backToTemplate": "Torna al modello",
  "bike.makerTemplate": "Modello",
  "bike.colour": "Colore",
  "bike.updatePreview": "Aggiorna anteprima",
  "bike.madeStats": "{{role}} · {{tris}} triangoli",
  "bike.partName": "Nome della parte",
  "bike.keepPart": "Aggiungi al vassoio",
  "bike.kept": "{{name}} è nel vassoio",
  "bike.keepFailed": "Impossibile tenere la parte",
  "bike.role.handguards": "Paramani",
  "bike.role.plate": "Tabella portanumero",

  // ── Replay ────────────────────────────────────────────────────────────────
  "nav.replay": "Replay",
  "replay.title": "Replay",
  "replay.setup": "Registrazione",
  "replay.recordNow": "Registra",
  "replay.stop": "Ferma",
  "replay.recording": "Registrazione — {{time}}",
  "replay.byTheMod": "L'ha avviata il Replay Mod. Finisce quando finisce l'inquadratura.",
  "replay.byHand": "Avviata a mano. Va avanti finché non la fermi o scatta il limite.",
  "replay.waiting": "Pronto",
  "replay.waitingDetail": "Fai volare un percorso di camera nel gioco e lo Studio lo tiene. Niente da premere.",
  "replay.noFfmpeg": "Ancora nessun encoder",
  "replay.noFfmpegDetail": "Per registrare serve ffmpeg. Lo Studio può scaricarlo — finisce nella sua cartella, non in Windows.",
  "replay.noMod": "Il Replay Mod non è mai partito qui",
  "replay.noModDetail": "Installalo dalla pagina Plugin di MXB App, poi riproduci un percorso una volta, così gioco e Studio si conoscono.",
  "replay.gameClosed": "MX Bikes non è in esecuzione",
  "replay.gameClosedDetail": "Avvia il gioco e apri un replay. Questa finestra può restare chiusa: alla registrazione non serve.",
  "replay.fullscreenWarning": "Il tuo ffmpeg non può catturare un gioco a schermo intero esclusivo: il video verrebbe nero. Gioca in finestra senza bordi, o scarica l'ffmpeg dello Studio.",
  "replay.recordings": "Registrazioni",
  "replay.noRecordings": "Ancora niente di registrato",
  "replay.openFolder": "Apri cartella",
  "replay.reveal": "Mostra nella cartella",
  "replay.paths": "Percorsi di camera",
  "replay.pathsDesc": "I file .fcam salvati dal mod. Si condividono: passane uno e un altro pilota vola la tua inquadratura.",
  "replay.noPaths": "Nessun percorso salvato",
  "replay.slotN": "Slot {{n}}",
  "replay.auto": "Registra da sola",
  "replay.autoDesc": "Parte quando il mod vola un percorso e finisce con lui. È l'impostazione che sostituisce OBS.",
  "replay.quality": "Qualità",
  "replay.qualityHigh": "Alta",
  "replay.qualityBalanced": "Bilanciata",
  "replay.qualitySmall": "Leggera",
  "replay.fps": "Fotogrammi al secondo",
  "replay.encoder": "Encoder",
  "replay.encoderDesc": "Auto prende quello della scheda video e lascia il processore al gioco.",
  "replay.encoderAuto": "Auto",
  "replay.encoderBinary": "ffmpeg",
  "replay.ffmpegMissing": "Non trovato su questo computer",
  "replay.getFfmpeg": "Ottieni ffmpeg",
  "replay.ffmpegReady": "ffmpeg è pronto. Ora si può registrare.",
  "replay.folder": "Salva in",
  "replay.folderDefault": "Video\\Frost Replays",
  "replay.audio": "Audio",
  "replay.audioDesc": "Un dispositivo di registrazione di Windows, col nome esatto che gli dà ffmpeg. Vuoto registra in silenzio.",
  "replay.audioSilent": "Muto",
  "replay.hotkey": "Tasto di registrazione",
  "replay.hotkeyDesc": "Funziona dentro il gioco, così non esci mai per iniziare.",
  "diagnose.swapTitle": "Compatibilità model swap",
  "diagnose.swapDesc": "Scegli una moto per vedere con quali altre moto installate si allinea un model swap fatto per lei: quelle con cannotto, perno, forcella e assi entro 10 mm.",
  "diagnose.swapEmpty": "Nessuna moto nella cartella mods",
  "diagnose.linesUp": "Si allinea con",
  "diagnose.linesUpNone": "Non si allinea con nessun’altra moto installata",
  "diagnose.guidTitle": "GUID bloccato",
  "diagnose.guidDesc": "Aggiungi file protetti o una cartella per vedere a quale GUID è bloccato ogni file.",
  "diagnose.notProtected": "Non protetto",
  "diagnose.guidUnavailable": "Leggere un GUID bloccato richiede il modulo di protezione locale, assente in questa build.",
  "diagnose.addFiles": "Aggiungi file",
  "diagnose.addFolder": "Aggiungi cartella",
  "diagnose.clear": "Svuota",
  "diagnose.lockedToNobody": "Protetto, senza GUID",
  "diagnose.readFailed": "Impossibile leggere la selezione",
  ...
  "update.pitch": "Aggiorna per avere le ultime funzionalità e correzioni.",
  ...
  "designer.exportProxyHint":
    "Una versione leggera di questo modello con il suo vero layout UV, per dipingere in Blender o Substance. Ottieni un .glb e un .obj, più un modello e un PSD a livelli per ogni foglio. Il modello vero resta a te.",
  "designer.exportedProxy": "Proxy per verniciare salvato in {{dir}}",
  "designer.exportedProxyDesc": "Tenuti {{kept}} triangoli su {{of}}.",
  "designer.proxyTitle": "Proxy per verniciare di {{name}}",
  "designer.proxyShading": "Includi l'ombreggiatura del modello",
  "designer.proxyShadingHint": "Mette l'aspetto originale del modello sotto ogni modello di foglio come livello di riferimento. È il tuo lavoro, quindi solo se vuoi condividerlo.",
  "designer.proxyChoose": "Scegli una cartella…",
  "designer.proxyWriting": "Salvataggio…",
  "designer.proxyFromFile": "Proxy per verniciare da un file modello…",
  ...
  "designer.sheetFromImage": "Da un'immagine…",
  ...
  "designer.sheetUnbound": "Il modello non richiede mai questo nome, quindi questo foglio non dipinge nulla.",
  ...
  "track.save": "Salva",
  "track.saved": "Salvato “{{name}}”",
  "track.saveFailed": "Impossibile salvare",
  "track.open": "Apri pista…",
  "track.openFailed": "Impossibile aprire",
  "track.projectFile": "Progetto pista",
  ...
  "track.scale.normal": "Normale",
  "track.scale.pro": "Pro",
  "track.discipline.mx": "MX",
  "track.discipline.sx": "SX",
  "track.discipline.smx": "SMX",
  "track.border": "Bordi corsia",
  "track.border.soft": "Blocchi morbidi",
  "track.border.solid": "Blocchi rigidi",
  "track.border.banners": "Striscioni",
  "track.border.none": "Nessuno",
  "track.venue": "Sede",
  "track.venue.stadium": "Stadio",
  "track.venue.open": "All'aperto",
  "track.density": "Quanto carico",
  "track.density.sparse": "Rado",
  "track.density.real": "Reale",
  "track.density.packed": "Carico",
  ...
  "track.replaceBody": "Hai fatto modifiche che non sono state salvate. Caricare un'altra pista le scarta.",
  "track.replaceConfirm": "Scarta e carica",
  "track.anywayTitle": "Costruirla comunque?",
  "track.anywayBody": "Questa pista ha problemi che normalmente bloccherebbero la compilazione. Si compilerà: semplicemente non avrà le misure di una pista pubblicata. Puoi costruirla e vedere.",
  "track.anywayConfirm": "Costruisci comunque",
  ...
  "track.look.sand": "Sabbia",
  "track.look.grass": "Erba",
  "track.look.stadium": "Stadio",
  "track.look.own": "le tue immagini",
  "track.look.add": "Usa una tua immagine",
  "track.look.clear": "Torna alla nostra",
  "track.look.images": "Immagini",
  "track.slot.ground": "Fondo",
  "track.slot.line": "Traiettoria",
  "track.slot.rut": "Solchi",
  "track.slot.grass": "Intorno",
  ...
  "studioSettings.foldersWhy": "Vengono lette dalla stessa configurazione che scrive MXB App: è lei a trovare il gioco e a gestire la configurazione iniziale, così su dov'è MX Bikes c'è una sola risposta.",
  "studioSettings.getManager": "Scarica MXB App",
  "studioSettings.language": "Lingua",
  "studioSettings.theme": "Tema",
  "studioSettings.themeHint": "Il chiaro è il migliore per giudicare i colori. Lo scuro affatica meno gli occhi.",
  "studioSettings.themeLight": "Chiaro",
  "studioSettings.themeDark": "Scuro",
  "studioSettings.themeSystem": "Sistema",
  "studioSettings.model": "IA dello Studio",
  "studioSettings.modelHint":
    "Le piste vengono scritte tramite il tuo account MXB, a meno che tu non scelga un modello tuo. Una chiave Groq gratuita basta per «Solo impostazioni»; un giro intero richiede un modello potente come Claude Opus. La tua chiave resta su questo computer.",
  "studioSettings.modelAccount": "Account MXB",
  "studioSettings.modelCustom": "Altro (compatibile OpenAI)",
  "studioSettings.modelAddress": "Indirizzo",
  "studioSettings.modelName": "Modello",
  "studioSettings.modelKey": "Chiave API",
  "studioSettings.modelKeySaved": "Salvata. Scrivine una nuova per sostituirla.",
  "studioSettings.modelKeyNone": "Incolla la chiave. Un server locale non ne ha bisogno.",
  "studioSettings.modelTest": "Prova",
  "studioSettings.modelTesting": "Provo…",
  "studioSettings.modelSave": "Salva",
  "studioSettings.modelWorks": "Il modello ha risposto",
  "studioSettings.modelFailed": "Non ha funzionato",
  "studioSettings.modelSaved": "Salvato",
  "studioSettings.modelCleared": "Le piste passano di nuovo dal tuo account MXB",
  "track.settingsPicked": "{{ground}}, {{length}} m, {{corners}} curve per km",
  "track.picked.soil": "Terra",
  "track.picked.sand": "Sabbia",
  "track.picked.grass": "Erba",

  // Building a track from a real place: finding it, fetching its ground, tracing the lap.
  "place.title": "Da un luogo reale",
  "place.back": "Indietro",
  "place.searchLabel": "Nome del circuito o coordinate",
  ...
  "place.noHits": "Nessun risultato con quel nome, e sulla mappa non c’è nessun circuito che si chiami così. Cerca il paese più vicino, poi premi «Circuiti qui vicino».",
  "place.near": "Circuiti qui vicino",
  "place.nearSearching": "Cerco…",
  "place.nearHint": "Tutti i circuiti di motocross nel raggio di 40 km, presi dalla mappa. Senza coordinate.",
  "place.noneNear": "Nel raggio di 40 km non c’è nessun circuito di motocross mappato. Prova un paese più vicino, o indicalo sulla foto aerea.",
  "place.away": "a {{km}} km",
  "place.checking": "Controllo…",
  "place.coverageTitle": "Cosa è stato rilevato qui",
  "place.cells": "celle da {{cell}} m",
  "place.plot": "Dimensione del terreno",
  "place.plotHint": "Un giro intero richiede di solito 1000 m o più. Un terreno più grande allunga anche meno il rilievo, quindi più pista è misurata invece che indovinata.",
  "place.fetch": "Scarica il terreno",
  "place.fetching": "Download…",
  "place.fetched": "«{{name}}» scaricato",
  "place.fetchFailed": "Non è stato possibile scaricare quel luogo",
  "place.fetchingName": "Scaricamento di «{{name}}»",
  "place.stageElevation": "Scaricamento del terreno",
  "place.stageHillshade": "Disegno della forma del terreno",
  "place.stageImagery": "Scaricamento della foto aerea",
  "place.mapOpen": "Mostra la foto",
  "place.mapClose": "Chiudi la foto",
  "place.mapTitle": "Indica il circuito",
  "place.mapSpan": "{{span}} m di lato",
  "place.mapIn": "Più vicino",
  "place.mapOut": "Più largo",
  "place.mapLoading": "Caricamento della foto…",
  "place.mapHint": "Fai clic al centro del circuito per spostarci la croce, oppure trascina la foto. Ogni spostamento chiede una sola immagine, quindi non si scarica nulla mentre guardi.",
  "place.mapUse": "Usa questo punto",
  "place.places": "Luoghi su questo computer",
  "place.noPlaces": "Ancora niente scaricato.",
  "place.hasLap": "Giro tracciato",
  "place.relief": "{{relief}} m di dislivello",
  "place.trace": "Traccia il giro",
  "place.forget": "Dimentica",
  "place.forgetting": "Eliminazione…",
  "place.copyPaths": "Copia i percorsi",
  "place.copied": "Percorsi copiati",
  "place.importDem": "Importa un GeoTIFF",
  "place.importing": "Importazione…",
  "place.imported": "«{{name}}» importato",
  "place.importFailed": "Non è stato possibile importare quel file",
  "place.opening": "Apertura…",
  "place.layerImagery": "Foto aerea",
  "place.layerHillshade": "Forma del terreno",
  "place.layerBoth": "Entrambe",
  "place.closed": "Giro chiuso",
  "place.width": "Larghezza",
  "place.points": "{{count}} punti",
  "place.length": "{{length}} m a giro",
  "place.undo": "Annulla",
  "place.redo": "Ripeti",
  "place.clear": "Svuota",
  "place.saveTrace": "Salva il giro",
  "place.build": "Crea la pista",
  "place.building": "Creazione…",
  "place.built": "{{name}} è pronta e si trova nella cartella delle piste",
  "place.buildFailed": "Impossibile creare la pista",
  "place.saving": "Salvataggio…",
  "place.saved": "Giro salvato",
  "place.saveFailed": "Non è stato possibile salvare il giro",
  "place.traceHelp": "Clicca lungo il centro della traccia consumata, non sul bordo. Trascina un punto per spostarlo, alt-clic per toglierlo, doppio clic per fissare la partenza. Trascina col tasto destro per spostarti, rotella per lo zoom.",
  "place.noImagery": "Nessuna foto aerea con licenza aperta copre questo luogo, quindi traccia sulla forma del terreno.",
  "place.attribution": "Questo circuito deve portare questo credito",
};
