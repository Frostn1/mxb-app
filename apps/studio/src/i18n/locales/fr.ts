...
export const fr: Translation = {
  ...
  "bike.multiPartHint": "Ça ressemble à plus d'une pièce — châssis, suspension, roues… Studio ne peut pas encore séparer une moto entière en pièces, alors vérifie le rôle, ou apporte chaque pièce dans son propre fichier.",
