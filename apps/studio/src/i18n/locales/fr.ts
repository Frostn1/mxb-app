...
export const fr: Translation = {
  ...
  "bike.parts": "Pièces",
  "bike.addParts": "Ajouter des pièces…",
  "bike.adding": "Ajout {{n}} sur {{of}}…",
  "bike.partsEmpty": "Aucune pièce pour l'instant. Ajoute des fichiers .blend, .fbx ou .obj : Blender ouvre chacun en arrière-plan, rend une miniature et devine ce que c'est.",
  "bike.partStats": "{{tris}} triangles · {{empties}} points d'attache",
  "bike.partMissing": "Le fichier a disparu",
  "bike.partStale": "Le fichier a changé : actualise-le",
  "bike.dragToPlace": "Fais-la glisser sur la moto pour remplir son emplacement",
  "bike.multiPartHint": "Ça ressemble à plus d'une pièce — châssis, suspension, roues… Sépare-la en ses pièces, ou vérifie le rôle si tu voulais l'apporter comme une seule.",
  "bike.splitIntoParts": "Séparer en pièces",
  "bike.splitFailed": "Impossible de la séparer en pièces",
  "bike.roleHintsFound": "On dirait qu'il y a :",
  "bike.useAsBase": "Utiliser comme moto de base",
  "bike.useAsBaseFailed": "Impossible de l'utiliser comme moto de base",
  "bike.makeAPart": "Créer une pièce…",
  "bike.place": "Placer ▸",
  "bike.placed": "Placée",
  "bike.placeNeedsRole": "Définissez d'abord un rôle",
  "bike.placeFailed": "Impossible de placer la pièce",
  "bike.noRole": "Aucun rôle",
  "bike.guessed": "deviné",
  "bike.refreshPart": "Le repasser dans Blender",
  "bike.removePart": "Retirer de la bibliothèque (ton fichier reste)",
  "bike.slots": "Moto",
  "bike.slotsHint": "Une pièce par emplacement. Chaque emplacement liste les pièces de son rôle.",
  "bike.collapseSlots": "Réduire la liste",
  "bike.emptySlot": "Vide",
  "bike.noPartsForRole": "Aucune pièce avec ce rôle",
  "bike.libraryFailed": "Impossible de lire la bibliothèque de pièces",
  "bike.addFailed": "Impossible d'ajouter {{name}}",
  "bike.roleFailed": "Impossible de définir le rôle",
  "bike.removeFailed": "Impossible de retirer la pièce",
  "bike.slotFailed": "Impossible de remplir l'emplacement",
  "bike.role.chassis": "Châssis",
  "bike.role.steer": "Direction",
  "bike.role.fsusp": "Suspension avant",
  "bike.role.rsusp": "Suspension arrière",
  "bike.role.wheel_f": "Roue avant",
  "bike.role.wheel_r": "Roue arrière",
  "bike.role.levers": "Leviers",
  "bike.role.pedals": "Repose-pieds et pédales",
  "bike.modeAssemble": "Assembler",
  "bike.modeMaker": "Atelier de pièces",
  "bike.assemble": "Assemblage",
  "bike.addPlaceholder": "Ajouter la moto d'exemple",
  "bike.placeholderHint": "La moto de Studio elle-même, sans vraies pièces — utile pour essayer le montage avant d'avoir la géométrie d'une moto installée.",
  "bike.placeholderFailed": "Impossible de créer la moto d'exemple",
  "bike.template": "Modèle",
  ...
  "bike.startFromBikeScopeNote": "Tes motos de mods installées. Les motos OEM/de série livrées avec le jeu lui-même n'apparaissent pas encore ici.",
  "bike.bikeProtected": "Contenu protégé — cette version ne peut pas le lire",
  ...
  "bike.pickBaseBike": "Choisir une moto de base",
  ...
  "bike.assembleEmpty": "Remplis quelques emplacements à gauche pour voir la moto ici.",
  "bike.pickBaseFirst": "Choisissez une moto de base ci-dessus pour commencer.",
  "bike.assemblyFailed": "Impossible d'assembler la moto",
  "bike.pickToNudge": "Clique sur une pièce, ou choisis-en une ci-dessous, pour la déplacer.",
  "bike.nudgeFor": "Déplacer {{role}} :",
  "bike.forward": "Avant",
  "bike.back": "Arrière",
  "bike.up": "Haut",
  "bike.down": "Bas",
  "bike.left": "Gauche",
  "bike.right": "Droite",
  "bike.resetNudge": "Revenir au point d'accroche",
  "bike.removeFromSlot": "La retirer de cet emplacement (elle reste dans le bac)",
  "bike.nudged": "déplacée x {{x}} y {{y}} z {{z}} mm",
  "bike.nudgeFailed": "Impossible de déplacer la pièce",
  "bike.previewPartFailed": "{{role}} n'a pas pu se charger : {{message}}",
  "bike.snappedBy": "accrochée par {{by}}",
  "bike.by.empty": "son point d'attache",
  "bike.by.centre": "son centre",
  "bike.by.modelled": "sa position modélisée",
  ...
  "bike.shadow": "ombre",
  "bike.maker": "Atelier de pièces",
  "bike.makerHint": "Décris une pièce, ou choisis un modèle et règle ses curseurs. Blender la construit ; garde-la et elle rejoint le plateau avec son rôle.",
  "bike.briefPlaceholder": "ex. protège-mains enveloppants style KTM, orange, bas",
  "bike.makeIt": "Créer",
  "bike.addImages": "Images de référence",
  "bike.images": "Images",
  "bike.removeImage": "Retirer l'image",
  "bike.byWords": "lu dans les mots (configure un modèle dans les Réglages pour décrire librement)",
  "bike.byModel": "par {{model}}",
  "bike.askFailed": "Impossible de lire la description",
  "bike.makerFailed": "Impossible de charger les modèles de l'atelier",
  "bike.previewFailed": "Blender n'a pas pu construire la pièce",
  "bike.codeHint": "Aucun modèle ne convient, le modèle IA a donc écrit du code Blender. Il est vérifié avant de tourner : lis-le, puis lance-le.",
  "bike.runCode": "Lancer dans Blender",
  "bike.backToTemplate": "Revenir au modèle",
  "bike.makerTemplate": "Modèle",
  "bike.colour": "Couleur",
  "bike.updatePreview": "Mettre à jour l'aperçu",
  "bike.madeStats": "{{role}} · {{tris}} triangles",
  "bike.partName": "Nom de la pièce",
  "bike.keepPart": "Ajouter au plateau",
  "bike.kept": "{{name}} est dans le plateau",
  "bike.keepFailed": "Impossible de garder la pièce",
  "bike.role.handguards": "Protège-mains",
  "bike.role.plate": "Plaque numéro",
