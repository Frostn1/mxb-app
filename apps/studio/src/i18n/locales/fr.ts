...
export const fr: Translation = {
  ...
  "track.ask.program": "Tour complet",
  "track.ask.settings": "Réglages seuls",
  "track.generatingSettingsHint":
    "Le modèle choisit les réglages, puis un tour est tracé à partir d'eux. En général moins d'une minute.",
