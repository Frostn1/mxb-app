...
/**
 * Slim, dismissible bar across the top of the window when a newer signed build
 * is out. The manager's banner, as-is. Renders nothing when there's no update.
 */
    ...
    <div className="flex shrink-0 items-center gap-3 border-b border-primary/25 bg-primary/10 px-4 py-2 text-sm text-foreground">
      ...
      <span className="min-w-0 truncate">
        <span className="font-semibold">
          {t("update.available", { version: `v${available.version}` })}
        </span>
