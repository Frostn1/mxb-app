...
export const de: Translation = {
  ...
  "mods.sourceAll": "Alle Quellen",
  "mods.sourceMods": "mxb-mods",
  "mods.searchPlaceholder": "Mods suchen…",
  "mods.empty": "Keine Treffer.",
  "mods.shopStale": "Die Shop-Preise sind möglicherweise nicht aktuell.",
  "mods.help": "Ein Bildschirm für alle Kataloge. Wähle links, was du suchst, und zeige über den Quellenfilter mxb-mods, MXB Hub, den Shop oder alle drei zugleich. Kostenpflichtige Inhalte zeigen ihren Preis; alles andere steht auf Gratis.",
  "nav.browse": "Entdecken",
  "nav.shop": "Shop",
  "nav.hub": "MXB Hub",
  "nav.library": "Bibliothek",
  "nav.garage": "Garage",
  "nav.downloads": "Aktivität",
  "nav.locker": "Spind",
  "nav.presets": "Presets",
  "nav.servers": "Online",
  ...
  // ── FrostMod ───────────────────────────────────────────────────────────────
  "frostmod.checking": "Spielintegration wird geprüft…",
  "frostmod.running": "Spielintegration bereit",
  "frostmod.notRunning": "Spielintegration aus",
  "frostmod.notInGame": "Spielintegration wartet auf das Spiel",
  "frostmod.reloadGame": "Spiel neu laden",
  "frostmod.start": "Spielintegration starten",
  "frostmod.reloadedGame": "Die Spielintegration hat das Spiel neu geladen.",
  "frostmod.notRunningToast": "Die Spielintegration ist aus.",
  "frostmod.started": "Spielintegration gestartet",
  "frostmod.alreadyRunning": "Die Spielintegration läuft bereits",
  "frostmod.startFailed": "Spielintegration konnte nicht gestartet werden",
  "frostmod.stop": "Spielintegration beenden",
  "frostmod.stopped": "Spielintegration beendet",
  "frostmod.stopFailed": "Spielintegration konnte nicht beendet werden",
  ...
  "frostmod.installedToast": "Spielintegration {{version}} installiert",
  "frostmod.installedToastDesc":
    "Es lädt das Spiel live neu, sobald du Mods hinzufügst.",
  "frostmod.installedToastRestart": "Starte MX Bikes neu, um zu wechseln — das laufende Spiel nutzt noch die vorherige Integration.",
  "frostmod.installFailed": "Spielintegration konnte nicht installiert werden",
  ...
  "frostmod.askedReload": "Die Spielintegration wurde zum Neuladen aufgefordert.",
  "frostmod.andMore_one": "{{names}} und {{count}} weiterer",
  "frostmod.andMore_other": "{{names}} und {{count}} weitere",
  "frostmod.watchDesc": "{{names}} — die Spielintegration wurde zum Neuladen aufgefordert.",
  ...
  "setup.finishing": "{{game}} wird eingerichtet…",
  "setup.steamTitle": "Mit Steam anmelden",
  "setup.steamLead":
    "MX Bikes erkennt dich an deinem Steam-Konto — und alles, was du gekauft hast, ebenso.",
  "setup.steamReasonSealed":
    "Geschützte Tracks und Ausrüstung werden auf dem Konto freigeschaltet, dem sie gehören.",
  "setup.steamReasonStore": "Alles, was du in einem Shop kaufst, steht startklar zur Installation bereit.",
  "setup.steamReasonRanked": "Dein Ranked-Profil wird über dasselbe Konto gefunden.",
  "setup.steamNote":
    "Das öffnet Steam in deinem Browser. Die App sieht dein Passwort nie.",
  "setup.steamWaiting": "Warten auf Steam…",
  "setup.steamSignedIn": "Angemeldet als {{id}}",
  "setup.steamContinue": "Weiter",
  ...
  "tour.frostmod.title": "Spielintegration",
  "tour.frostmod.body":
  ...
  "runtime.bannerFrostmod": "Die Spielintegration braucht {{what}}, um zu laufen.",
  "runtime.pitch":
  ...
  "shopDetail.notOwned": "Nicht gekauft",
  ...
  "modDetail.openOnSite": "Auf {{site}} öffnen",
  "modsVerify.shown": "Schließ die Prüfung im Fenster „Zugriff auf {{site}} wird überprüft“ ab, um Mod-Seiten zu laden.",
  "modsVerify.cleared": "{{site}} bestätigt.",
  "modsVerify.dismissed": "Prüfung geschlossen — Mod-Seiten von {{site}} laden nicht in der App. Mit „Erneut versuchen“ wird sie wieder angezeigt.",
  ...
  "modDetail.inLibrary": "In der Bibliothek",
  "modDetail.notInstalled": "Nicht installiert",
  "modDetail.addToLibrary": "Zur Bibliothek hinzufügen",
  "modDetail.fromHost": "Von {{host}}",
  "modDetail.categoryLabel": "Kategorie",
  "modDetail.host": "Host",
  ...
  "settings.frostmod": "Spielintegration",
  ...
  "accounts.section": "Konten",
  "accounts.desc": "Alle Anmeldungen, die die App hält, und wofür jede da ist.",
  "accounts.steam": "Steam",
  "accounts.steamNot": "Nicht verknüpft.",
  "accounts.steamWhat": "Gibt die Schlüssel für die geschützten Mods frei, die dir gehören. Zum Ändern einfach neu anmelden.",
  "accounts.shop": "mxbikes-shop.com",
  "accounts.hub": "MXB Hub",
  "accounts.mods": "mxb-mods.com",
  "accounts.modsNone": "Kein Konto.",
  "accounts.modsNote": "Hier sind Stöbern und Herunterladen anonym, es gibt nichts anzumelden.",
  "accounts.shopNote": "Käufe werden aus einem offen gehaltenen Browserfenster gelesen, weil die Cloudflare-Prüfung des Shops einen normalen Client abweist. Das dauert ein paar Sekunden.",
  "accounts.hubNote": "Käufe kommen über den normalen Client, also antwortet dieser Shop schnell.",
  "accounts.signedIn": "Angemeldet",
  "accounts.signedOut": "Nicht angemeldet",
  "accounts.checking": "Wird geprüft…",
  "accounts.countUnknown": "Angemeldet. Käufe noch nicht gelesen.",
  "accounts.purchases_one": "{{count}} Kauf",
  "accounts.purchases_other": "{{count}} Käufe",
  "accounts.signIn": "Anmelden",
  "accounts.signOut": "Abmelden",
  "accounts.refreshFailed": "Deine Käufe konnten nicht gelesen werden",
  "accounts.signOutFailed": "Abmelden nicht möglich",
  "accounts.autoInstall": "Käufe automatisch installieren",
  "accounts.autoInstallDesc": "Nachdem die App eine Shop-Seite für dich geöffnet hat, beobachtet sie den Shop etwa zwei Minuten lang und installiert alles, was neu auftaucht.",
  "accounts.readTitle": "Wie ein Kauf gefunden wird",
  "accounts.readBody": "Keiner der beiden Shops sagt der App, wenn du etwas kaufst — die App muss also nachsehen. Solange sie beobachtet, sieht sie alle paar Sekunden nach und hört nach etwa zwei Minuten auf. mxbikes-shop.com wird aus einem offen gehaltenen Browserfenster gelesen und kann langsam sein; MXB Hub antwortet schnell. Kommt ein Kauf erst danach an, öffne Käufe und drücke Aktualisieren.",
  "accounts.installing": "{{name}} wird installiert",
  "accounts.pickFile": "{{name}} liegt auf deinem Konto. Es kommt in mehreren Dateien — wähle unter Käufe die gewünschte aus.",
  "accounts.manyNew": "Neue Käufe gefunden. Öffne Käufe, um sie zu installieren.",
  ...
  "settings.secRepair": "Fehlende Schlüssel",
  "settings.secRepairDesc": "Eine versehentlich gelöschte Schlüsseldatei zurückholen. Die App sichert deine Schlüssel selbst, meist ist dafür kein Internet nötig.",
  "settings.secRepairBtn": "Schlüssel wiederherstellen",
  "settings.secRepairBusy": "Wird wiederhergestellt…",
  "settings.secRepairOk_one": "{{count}} Schlüssel wiederhergestellt. Deine geschützten Inhalte funktionieren wieder.",
  "settings.secRepairOk_other": "{{count}} Schlüssel wiederhergestellt. Deine geschützten Inhalte funktionieren wieder.",
  "settings.secRepairNone_one": "{{count}} Datei geprüft — der Schlüssel ist vorhanden.",
  "settings.secRepairNone_other": "{{count}} Dateien geprüft — alle Schlüssel sind vorhanden.",
  ...
  "settings.checkNewer": "Nach einer neueren Spielintegration suchen",
  "settings.working": "Wird ausgeführt…",
  "settings.installFrostmod": "Spielintegration installieren",
  ...
  "join.closeAndJoin": "Spiel schließen & beitreten",
  ...
  "settings.autoUpdates": "Updates automatisch installieren",
  "settings.autoUpdatesDesc":
    "Updates werden beim Öffnen der App installiert oder wenn sie eine Weile nicht benutzt wurde. Nie, während MX Bikes läuft.",
  ...
  "serverBrowser.bikeNoProfile": "Es wurde kein MX-Bikes-Profil gefunden, daher konnte die App kein Motorrad für diesen Server auswählen.",
  "serverBrowser.bikeNoMatch": "Keines deiner installierten Motorräder entspricht den erlaubten Kategorien und Modellen dieses Servers.",
  ...
  "serverBrowser.install": "Installieren",
  "serverBrowser.installHint": "Installiert {{title}}, ohne dem Server beizutreten",
  ...
  "serverBrowser.unwedge": "Server-Browser reparieren",
  "serverBrowser.unwedgeBlurb": "Dafür, wenn die Browse-Ansicht von MX Bikes nach dem Verlassen eines Servers „connection timeout“ anzeigt. Behebt es, ohne das Spiel neu zu starten.",
  "serverBrowser.unwedgeSent": "Gesendet. Öffne Browse im Spiel erneut.",
  "serverBrowser.unwedgeNeedsFrostmod": "Dein FrostMod ist dafür zu alt. Aktualisiere es und versuche es erneut.",
  "serverBrowser.unwedgeNoFrostmod": "FrostMod läuft nicht, es gibt also nichts, wohin das gesendet werden könnte.",
  "serverBrowser.unwedgeFailed": "Das Spiel war nicht erreichbar.",
  ...
  "serverBrowser.viewTiles": "Kacheln",
  ...
  "connection.statusPage": "Ist MX Bikes offline?",
  ...
  "queue.turn": "Auf {{name}} ist ein Platz frei. Tritt jetzt im Spiel bei.",
  "queue.launching": "Ein Platz ist frei. Starte auf {{name}}.",
  "queue.joined": "Du bist auf {{name}}.",
  "queue.missed": "Dein Platz auf {{name}} ist verfallen, du hast die Warteschlange verlassen.",
  "queue.offline": "MXB App-Dienst nicht erreichbar. Neuer Versuch läuft.",
  "queue.joinFailed": "Konnte dich nicht anstellen",
  "queue.onlyApp": "In dieser Warteschlange stehen nur Fahrer mit MXB App.",
  "serverBrowser.copyAddress": "Adresse kopieren",
  "serverBrowser.copied": "Adresse kopiert",
  "serverBrowser.copyLink": "Serverlink kopieren",
  "serverBrowser.copyLinkHint": "Einen Link kopieren, der diesen Server in {{app}} öffnet",
  "serverBrowser.linkCopied": "Serverlink kopiert",
  "serverBrowser.copyFailed": "Link konnte nicht kopiert werden.",
  "deepLink.otherGame": "Dieser Link gehört zu {{game}} — wechsle das Spiel, um ihn zu öffnen.",
  ...
  "serverBrowser.pickServer": "Wähle einen Server, um zu sehen, was darauf läuft.",
  ...
  "serverBrowser.moreActions": "Mehr",
  ...
  "feel.control.throttle": "Gas",
  "feel.control.brake": "Vorderradbremse",
  "feel.control.rearBrake": "Hinterradbremse",
  "feel.control.clutch": "Kupplung",
  "feel.control.shiftUp": "Hochschalten",
  "feel.control.shiftDown": "Runterschalten",
  "feel.control.shiftUpPreload": "Hochschalten (Preload)",
  "feel.control.shiftDownPreload": "Runterschalten (Preload)",
  "feel.control.lean": "Neigen",
  "feel.control.leanForwardBack": "Fahrer vor/zurück",
  "feel.control.leanLeftRight": "Fahrer links/rechts",
  "feel.control.sit": "Sitzen",
  "feel.control.sitDirect": "Sitzen (direkt)",
  "feel.control.changeView": "Ansicht wechseln",
  "feel.control.lookBack": "Nach hinten schauen",
  "feel.control.heading": "Blickrichtung",
  ...
  "library.yours": "Deins",
  "owned.title": "Gekauft",
  "owned.loading": "Deine Käufe werden gelesen…",
  "owned.signedOut": "Melde dich bei einem Store an, um alles Gekaufte an einem Ort zu sehen.",
  "owned.openStores": "Stores öffnen",
  "owned.empty": "Noch nichts gekauft.",
  "owned.fromShop": "mxbikes-shop",
  "owned.fromHub": "MXB Hub",
  "owned.notInstalled": "Nicht installiert",
  "wishlist.title": "Wunschliste",
  "wishlist.add": "Auf die Wunschliste",
  "wishlist.remove": "Von der Wunschliste entfernen",
  "wishlist.empty": "Deine Wunschliste ist leer.",
  "wishlist.emptyHint":
    "Öffne eine Mod und tippe auf „Auf die Wunschliste“, um sie hier zu behalten.",
  "wishlist.wanted": "Auf deiner Wunschliste",
  ...
  "showcase.v0170.hero.title":
    "Einen Server finden, wenn das Spiel es nicht kann",
  "showcase.v0170.hero.body":
    "Die halbe Mühe mit dem Mehrspielermodus von MX Bikes sind nicht die Server. Es ist das „connection timeout“ ohne jeden Hinweis. Dieser Build repariert den Browser des Spiels und gibt dir eine Liste, die auch dann funktioniert, wenn er es nicht tut.",
  "showcase.v0170.browser":
    "Die Browse-Ansicht des Spiels läuft nicht mehr den ganzen Abend in Zeitüberschreitungen, nachdem du einen Server verlassen hast. FrostMod behebt das während du spielst.",
  "showcase.v0170.book":
    "Der Servers-Tab funktioniert weiter, wenn die Serverliste von MX Bikes ausfällt: Er fragt jeden Server direkt, aus einem gemeinsamen Adressbuch.",
  "showcase.v0170.check":
    "Wenn die Liste nicht lädt, sagt dir die App, ob es an den Servern von MX Bikes liegt oder an dir, und prüft deine Verbindung.",
  ...
  "plugins.installedStudio": "{{name}} ist installiert. Die Bereiche öffnen sich in Frost's Studio.",
  "plugins.inStudio": "Öffnet sich in Frost's Studio — es ist ein Werkzeug zum Erstellen, und dort liegen diese jetzt.",
  "plugins.openStudio": "In Studio öffnen",
  ...
  "ranked.manualOverride": "Zeigt eine selbst eingegebene GUID, nicht dein Steam-Konto.",
  "ranked.useSteam": "Mein Steam-Konto verwenden",
  ...
  "ranked.unracedTitle": "Noch keine gewerteten Rennen",
  "ranked.unracedBody": "MXB Ranked ermittelt deinen Rang aus Rennen auf den eigenen Servern. Tritt einem bei – es sind die Lobbys mit dem Namen MXB-Ranked.com – und dein Rang, die Saisonwerte und jedes Ergebnis erscheinen hier.",
  "ranked.unracedFind": "Gewerteten Server suchen",
  "ranked.unracedNotYou": "Du fährst bereits? Dann ist das nicht deine GUID – trag oben über die GUID-Schaltfläche die richtige ein.",
  "ranked.exp": "EXP",
  ...
  "setup.steamOptional": "Steam ist optional. Du brauchst es nur für geschützte Käufe und Ranked.",
  "setup.steamSkip": "Vorerst überspringen",
  "setup.integrationTitle": "Spielintegration aktivieren?",
  "setup.integrationIntro": "{{app}} funktioniert ohne Spielintegration. Aktiviere sie nur für geschützte Mods, sofortiges Neuladen und Lackierungs-Sync im Spiel.",
  "setup.integrationCrashFixes": "Ebenfalls enthalten: gezielte Korrekturen für bekannte Abstürze in {{game}}.",
  "setup.integrationInstallDisclosure": "Dabei werden frostmod.exe und frostmod.dll aus dem offiziellen FrostMod-Release auf GitHub in den eigenen Datenordner der App installiert. Der Download wird vorbereitet und anhand der Release-Metadaten geprüft, bevor etwas geändert wird.",
  "setup.integrationUseAppOnly": "Nur die App verwenden",
  "setup.integrationEnable": "Spielintegration aktivieren",
  "setup.integrationChooseInstall": "Spielordner wählen und aktivieren",
  "setup.integrationInstallRequired": "Installationsordner von {{game}} erforderlich",
  "setup.integrationInstallRequiredDesc": "Die Spielintegration benötigt den Ordner mit der Programmdatei des Spiels. Er wurde nicht automatisch gefunden. Wähle ihn aus, um fortzufahren.",
  "setup.integrationLearnMore": "Technische Details ansehen",
  "integration.title": "Spielintegration",
  "integration.poweredBy": "Unterstützt von FrostMod",
  "settings.integrationIntro": "Optionale Funktionen im Spiel für geschützte Mods, sofortiges Neuladen und Lackierungs-Sync. Standard-Mods brauchen sie nicht.",
  "integration.details": "Technische Details",
  "integration.detailsTitle": "Was die Spielintegration installiert",
  "integration.optional": "Optional",
  "integration.optionalDesc": "Standard-Mods funktionieren ohne Spielintegration. Vom Ersteller geschützte Mods benötigen sie.",
  "integration.protectedContentTitle": "So funktionieren geschützte Inhalte",
  "integration.protectedContentDesc": "Nachdem der Besitz über Steam bestätigt wurde, wird ein Offline-Schlüssel auf diesem PC gespeichert. Geschützte Dateien werden nur im Arbeitsspeicher geöffnet, während das Spiel sie nutzt; es wird keine entpackte Kopie auf die Festplatte geschrieben.",
  "integration.privacyTitle": "Deine Daten",
  "integration.privacyDesc": "Deine Mod-Dateien werden nicht hochgeladen. {{app}} erhält nie dein Steam-Passwort; Steam übernimmt die Anmeldung und gibt nur die Kontoidentität zurück, die zur Besitzprüfung nötig ist.",
  "integration.filesTitle": "Installierte Dateien",
  "integration.publisher": "Herausgeber",
  "integration.publisherValue": "MXB App · Unterstützt von FrostMod",
  "integration.source": "Downloadquelle",
  "integration.sourceValue": "Offizielle FrostMod-Releases auf GitHub",
  "integration.components": "Komponenten",
  "integration.componentsValue": "frostmod.exe und frostmod.dll",
  "integration.installLocation": "Installationsort",
  "integration.installLocationValue": "Privater Datenordner der App / frostmod",
  "integration.network": "Netzwerkdienste",
  "integration.networkValue": "GitHub für Integrations-Updates; MXB-App-Dienste zur Besitzprüfung und für aktivierte Online-Funktionen.",
  "integration.integrity": "Integritätsprüfungen",
  "integration.integrityValue": "Die Dateigröße wird immer geprüft. SHA-256 wird ebenfalls geprüft, wenn das Release den Wert bereitstellt.",
  "integration.control": "Deine Kontrolle",
  "integration.controlValue": "Die Spielintegration ist optional und kann jederzeit beendet werden.",
  "integration.standardMods": "Standard-Mods funktionieren auch ohne Spielintegration weiter.",
  "integration.protectedMods": "Vom Ersteller geschützte Mods benötigen die Spielintegration beim Spielen.",
  "activity.automaticTitle": "Automatische Aktivität",
  "activity.automaticDesc": "Aktionen, die die App ausgeführt oder versucht hat. Nur auf diesem Gerät gespeichert.",
  "activity.clear": "Leeren",
  "activity.clearAria": "Automatische Aktivität leeren",
  "activity.empty": "Noch keine automatischen Aktionen aufgezeichnet.",
  "activity.noMatches": "Keine automatische Aktivität entspricht deiner Suche.",
  "activity.completed": "Abgeschlossen",
  "activity.failed": "Fehlgeschlagen",
  "activity.notice": "Hinweis",
  "activity.integrationAppOnly": "Nur-App-Modus ausgewählt",
  "activity.integrationAppOnlyDesc": "Die Spielintegration wird nicht automatisch gestartet oder aktualisiert.",
  "activity.integrationEnabled": "Spielintegration aktiviert",
  "activity.integrationEnabledDesc": "Optionale Funktionen im Spiel sind auf diesem Gerät erlaubt.",
  "activity.integrationInstalled": "Spielintegration {{version}} installiert",
  "activity.integrationInstallFailed": "Installation der Spielintegration fehlgeschlagen",
  "mxbmrp3.title": "Probier MXBMRP3 für ein besseres HUD im Spiel",
  "mxbmrp3.what": "MXBMRP3 ist ein kostenloses Open-Source-HUD-Plugin von thomas4f. Es ergänzt {{game}} um Rangliste, Rundenzeiten, den Abstand zu deiner besten Runde, eine Streckenkarte und ein Radar.",
  "mxbmrp3.how": "Lade es von der offiziellen GitHub-Seite und installiere es mit seinem eigenen Installer. {{app}} prüft nur, ob es vorhanden ist. Es lädt nichts herunter und ändert nichts an deinem Spielordner.",
  "mxbmrp3.get": "MXBMRP3 holen",
  "mxbmrp3.notNow": "Nicht jetzt",
  "mxbmrp3.never": "Nicht mehr fragen",
  "mxbmrp3.installed": "MXBMRP3 ist installiert",
  "mxbmrp3.missing": "MXBMRP3 ist nicht installiert",
  "mxbmrp3.unknown": "Leg den Spielordner fest, um nach MXBMRP3 zu suchen",
  "mxbmrp3.settingsDesc": "MXBMRP3 ist ein kostenloses HUD-Plugin von thomas4f (Rangliste, Zeiten, Streckenkarte, Radar). {{app}} prüft nur den plugins-Ordner deines Spiels darauf.",
  "mxbmrp3.askAgain": "Wieder vorschlagen",
};
