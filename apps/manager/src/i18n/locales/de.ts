...
export const de: Translation = {
  ...
  "settings.secRepairRevoked_one": "Der Zugriff auf {{count}} Datei wurde vom Ersteller entfernt — ihr Schlüssel ist von diesem PC verschwunden.",
  "settings.secRepairRevoked_other": "Der Zugriff auf {{count}} Dateien wurde von den Erstellern entfernt — ihre Schlüssel sind von diesem PC verschwunden.",
  ...
  "settings.secReasonRevoked": "Der Ersteller hat deinen Zugriff entfernt. Der Schlüssel dafür wurde von diesem PC gelöscht.",
  ...
  "secure.revokedBody": "{{names}} — der Ersteller hat deinen Zugriff entfernt, daher wurde der Schlüssel von diesem PC gelöscht.",
