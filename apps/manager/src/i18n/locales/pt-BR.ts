...
export const ptBR: Translation = {
  ...
  "settings.secRepairRevoked_one": "O criador removeu o acesso a {{count}} arquivo — a chave dele saiu deste PC.",
  "settings.secRepairRevoked_other": "Os criadores removeram o acesso a {{count}} arquivos — as chaves deles saíram deste PC.",
  ...
  "settings.secReasonRevoked": "O criador removeu seu acesso. A chave foi apagada deste PC.",
  ...
  "secure.revokedBody": "{{names}} — o criador removeu seu acesso, então a chave foi apagada deste PC.",
