...
export const it: Translation = {
  ...
  "nav.mods": "Mod",
  "mods.type": "Tipo",
  "mods.category": "Categoria",
  "mods.sourceAll": "Tutte le fonti",
  "mods.sourceMods": "mxb-mods",
  "mods.searchPlaceholder": "Cerca mod…",
  "mods.empty": "Nessun risultato.",
  "mods.shopStale": "I prezzi dello shop potrebbero non essere aggiornati.",
  "mods.help": "Un'unica schermata per tutti i cataloghi. Scegli a sinistra cosa cerchi, poi usa il filtro della fonte per mostrare mxb-mods, MXB Hub, lo shop o tutti e tre insieme. Gli articoli a pagamento mostrano il prezzo; tutto il resto indica Gratis.",
  "nav.browse": "Esplora",
  "nav.shop": "Shop",
  "nav.hub": "MXB Hub",
  "nav.library": "Libreria",
  "nav.garage": "Garage",
  "nav.downloads": "Attività",
  ...
  // ── FrostMod ───────────────────────────────────────────────────────────────
  "frostmod.checking": "Controllo dell'integrazione di gioco…",
  "frostmod.running": "Integrazione di gioco pronta",
  "frostmod.notRunning": "Integrazione di gioco disattivata",
  "frostmod.notInGame": "L'integrazione sta aspettando il gioco",
  "frostmod.reloadGame": "Ricarica il gioco",
  "frostmod.start": "Avvia l'integrazione di gioco",
  "frostmod.reloadedGame": "L'integrazione ha ricaricato il gioco.",
  "frostmod.notRunningToast": "L'integrazione di gioco è disattivata.",
  "frostmod.started": "Integrazione di gioco avviata",
  "frostmod.alreadyRunning": "L'integrazione di gioco è già attiva",
  "frostmod.startFailed": "Impossibile avviare l'integrazione di gioco",
  "frostmod.stop": "Arresta l'integrazione di gioco",
  "frostmod.stopped": "Integrazione di gioco arrestata",
  "frostmod.stopFailed": "Impossibile arrestare l'integrazione di gioco",
  ...
  "frostmod.installedToast": "Integrazione di gioco {{version}} installata",
  "frostmod.installedToastDesc":
    "Ricaricherà il gioco in tempo reale quando aggiungi mod.",
  "frostmod.installedToastRestart": "Riavvia MX Bikes per passare alla nuova versione: il gioco aperto sta ancora usando l'integrazione precedente.",
  "frostmod.installFailed": "Impossibile installare l'integrazione di gioco",
  ...
  "frostmod.askedReload": "Richiesto all'integrazione di ricaricare il gioco.",
  "frostmod.andMore_one": "{{names}} e altra {{count}}",
  "frostmod.andMore_other": "{{names}} e altre {{count}}",
  "frostmod.watchDesc": "{{names}} — richiesto all'integrazione di ricaricare il gioco.",

  // ── Configurazione iniziale ────────────────────────────────────────────────
  "setup.title": "Benvenuto in {{app}}",
  ...
  "setup.finishing": "Configurazione di {{game}}…",
  "setup.steamTitle": "Accedi con Steam",
  "setup.steamLead":
    "MX Bikes ti identifica tramite il tuo account Steam, e lo stesso vale per tutto ciò che hai acquistato.",
  "setup.steamReasonSealed":
    "I track e il gear protetti si sbloccano sull'account che li possiede.",
  "setup.steamReasonStore": "Tutto ciò che compri su uno store compare pronto da installare.",
  "setup.steamReasonRanked": "Il tuo profilo Ranked viene trovato dallo stesso account.",
  "setup.steamNote":
    "Si apre Steam nel browser. L'app non vede mai la tua password.",
  "setup.steamWaiting": "In attesa di Steam…",
  "setup.steamSignedIn": "Accesso come {{id}}",
  "setup.steamContinue": "Continua",

  // ── Benvenuto ──────────────────────────────────────────────────────────────
  "welcome.intro.title": "Benvenuto in {{app}}",
  "welcome.intro.body":
  ...
  "tour.locker.body":
    "Cambia i modelli delle moto quando vuoi. {{app}} registra i pezzi in modo che il gioco li riconosca.",
  ...
  "tour.frostmod.title": "Integrazione di gioco",
  "tour.frostmod.body":
  ...
  "getStarted.title": "Per iniziare",
  "getStarted.body": "La tua cartella mods è vuota.",
  "getStarted.bikes.title": "Moto",
  "getStarted.bikes.action": "Installa il pacchetto OEM",
  "getStarted.tracks.title": "Tracciati",
  "getStarted.tracks.action": "Esplora i tracciati",
  "getStarted.rider.title": "Abbigliamento",
  "getStarted.rider.action": "Esplora l'abbigliamento",
  "getStarted.installing": "Installazione…",
  "getStarted.installed_one": "{{count}} installato.",
  "getStarted.installed_other": "{{count}} installati.",
  "getStarted.later": "Più tardi",
  ...
  "runtime.bannerFrostmod": "L'integrazione di gioco ha bisogno di {{what}} per funzionare.",
  "runtime.pitch":
  ...
  "shopDetail.notOwned": "Non acquistato",
  ...
  "installDialog.opensInBrowser":
    "Si apre nel browser — {{app}} completa l'installazione",
  ...
  "modDetail.openOnSite": "Apri su {{site}}",
  "modsVerify.shown": "Completa la verifica nella finestra «Verifica dell'accesso a {{site}}» per caricare le pagine delle mod.",
  "modsVerify.cleared": "{{site}} verificado.",
  "modsVerify.dismissed": "Verifica chiusa — le pagine delle mod di {{site}} non si caricheranno nell'app. Premi Riprova per rivederla.",
  ...
  "modDetail.inLibrary": "Nella libreria",
  "modDetail.notInstalled": "Non installato",
  ...
  "settings.downloads": "Mod e download",
  "settings.downloadsDesc":
    "Cosa succede durante l'installazione di una mod — quale file viene preso quando c'è una scelta, e cosa ne ricava il creatore dal tuo download.",
  "settings.secure": "Contenuti protetti",
  "settings.secureDesc":
    "Le mod bloccate che hai acquistato e le chiavi che le aprono su questa macchina. Mostrato solo su una build in grado di leggerle.",
  ...
  "settings.frostmod": "Integrazione di gioco",
  ...
  "settings.gameDesc":
    "Quale titolo sta gestendo {{app}}. Cartelle, libreria e preset appartengono tutti al gioco che scegli qui.",
  ...
  "settings.colorwayViolet": "Viola",
  "settings.colorwayRose": "Rosa",
  "settings.colorwaySlate": "Ardesia",
  ...
  "settings.launchAtStartupDesc":
    "Avvia {{app}} automaticamente quando accedi.",
  ...
  "settings.steamLinkedAs": "Accesso come {{id}}.",
  "settings.steamLinkBtn": "Accedi con Steam",
  "settings.steamRelink": "Ricollega",
  "settings.steamLinking": "In attesa…",

  // ── Accounts (Settings → Accounts) ───────────────────────────────
  "accounts.section": "Account",
  "accounts.desc": "Tutti gli accessi salvati dall'app e a cosa serve ciascuno.",
  "accounts.steam": "Steam",
  "accounts.steamNot": "Non collegato.",
  "accounts.steamWhat": "Rilascia le chiavi delle mod protette che possiedi. Per cambiarlo, accedi di nuovo.",
  "accounts.shop": "mxbikes-shop.com",
  "accounts.hub": "MXB Hub",
  "accounts.mods": "mxb-mods.com",
  "accounts.modsNone": "Nessun account.",
  "accounts.modsNote": "Qui la navigazione e i download sono anonimi, non c'è nulla a cui accedere.",
  "accounts.shopNote": "Gli acquisti vengono letti da una finestra del browser tenuta aperta, perché la verifica Cloudflare del negozio rifiuta un client normale. Servono alcuni secondi.",
  "accounts.hubNote": "Gli acquisti arrivano dal client normale, quindi la risposta è rapida.",
  "accounts.signedIn": "Connesso",
  "accounts.signedOut": "Non connesso",
  "accounts.checking": "Controllo…",
  "accounts.countUnknown": "Connesso. Acquisti non ancora letti.",
  "accounts.purchases_one": "{{count}} acquisto",
  "accounts.purchases_other": "{{count}} acquisti",
  "accounts.signIn": "Accedi",
  "accounts.signOut": "Esci",
  "accounts.refreshFailed": "Impossibile leggere i tuoi acquisti",
  "accounts.signOutFailed": "Impossibile uscire",
  "accounts.autoInstall": "Installa automaticamente gli acquisti",
  "accounts.autoInstallDesc": "Dopo che l'app ha aperto la pagina di un negozio, lo tiene d'occhio per circa due minuti e installa tutto ciò che compare di nuovo.",
  "accounts.readTitle": "Come viene trovato un acquisto",
  "accounts.readBody": "Nessuno dei due negozi avvisa l'app quando compri qualcosa, quindi l'app deve guardare. Mentre sorveglia controlla ogni pochi secondi e si ferma dopo circa due minuti. mxbikes-shop.com viene letto da una finestra del browser tenuta aperta e può essere lento; MXB Hub risponde in fretta. Se un acquisto arriva dopo la fine del controllo, apri Acquisti e premi Aggiorna.",
  "accounts.installing": "Installazione di {{name}}",
  "accounts.pickFile": "{{name}} è sul tuo account. Viene distribuito in più file, quindi scegli quello che vuoi in Acquisti.",
  "accounts.manyNew": "Trovati nuovi acquisti. Apri Acquisti per installarli.",
  "settings.steamLinkOpened": "Apertura di Steam nel browser — completa lì, poi torna qui.",
  ...
  "settings.secRepair": "Chiavi mancanti",
  "settings.secRepairDesc": "Rimetti a posto un file chiave cancellato per sbaglio. L'app tiene una copia delle tue chiavi, quindi di solito non serve internet.",
  "settings.secRepairBtn": "Ripristina chiavi",
  "settings.secRepairBusy": "Ripristino…",
  "settings.secRepairOk_one": "{{count}} chiave ripristinata. I tuoi contenuti protetti funzionano di nuovo.",
  "settings.secRepairOk_other": "{{count}} chiavi ripristinate. I tuoi contenuti protetti funzionano di nuovo.",
  "settings.secRepairNone_one": "Controllato {{count}} file — la chiave è al suo posto.",
  "settings.secRepairNone_other": "Controllati {{count}} file — tutte le chiavi sono al loro posto.",
  ...
  "settings.secReasonNotOwned": "Non è nella tua libreria su questo account.",
  "settings.secReasonNeedsSteam": "Accedi con Steam per verificare cosa possiedi.",
  ...
  "secure.provisioned": "Vincolato a {{id}}.",
  "secure.provisionedOk": "Vincolato — chiave salvata in locale",
  "secure.provisionFailed": "Impossibile vincolare la chiave",
  "secure.openOffline": "Apri offline",
  "secure.offlineOk": "Aperto offline e corrisponde.",
  "secure.offlineBad": "Aperto offline, ma non corrisponde.",
  "secure.offlineFailed": "Impossibile aprire offline",
  "secure.offlineMatches": "Aperto offline — corrisponde, nessun server",
  "secure.offlineMismatch": "Non corrisponde",
  ...
  "settings.checkingUpdates": "Controllo dell'ultima release su mxbsecure.com…",
  "settings.updateCheckFailed":
    "Impossibile controllare gli aggiornamenti — offline o mxbsecure.com non raggiungibile.",
  ...
  "settings.checkNewer": "Cerca un'integrazione di gioco più recente",
  "settings.working": "Elaborazione…",
  "settings.installFrostmod": "Installa l'integrazione di gioco",
  ...
  "join.closeAndJoin": "Chiudi il gioco ed entra",
  ...
  "settings.autoUpdates": "Installa gli aggiornamenti automaticamente",
  "settings.autoUpdatesDesc":
    "Gli aggiornamenti si installano all'apertura dell'app o quando non la usi da un po'. Mai mentre MX Bikes è in esecuzione.",
  ...
  "sync.installedState_one": "{{count}} grafica di un altro pilota è nella tua cartella mods",
  "sync.installedState_other": "{{count}} grafiche di altri piloti sono nella tua cartella mods",
  "sync.installedWhy": "Vengono scritte nella cartella mods perché il gioco possa disegnarle. Rimuovile per rimettere a posto la cartella — quelle che hai modificato restano.",
  "sync.remove": "Rimuovile",
  "sync.removed_one": "Rimossa {{count}} grafica sincronizzata",
  "sync.removed_other": "Rimosse {{count}} grafiche sincronizzate",
  "sync.removeKeptYours_one": "{{count}} è stata mantenuta — l'hai modificata dopo l'installazione.",
  "sync.removeKeptYours_other": "{{count}} sono state mantenute — le hai modificate dopo l'installazione.",
  "sync.removeFailed": "Impossibile rimuovere le grafiche sincronizzate",
  ...
  "serverBrowser.bikeNoProfile": "Non è stato trovato alcun profilo MX Bikes, quindi l'app non ha potuto scegliere una moto per questo server.",
  "serverBrowser.bikeNoMatch": "Nessuna delle moto installate corrisponde alle categorie e ai modelli consentiti da questo server.",
  ...
  "serverBrowser.install": "Installa",
  "serverBrowser.installHint": "Installa {{title}} senza entrare nel server",
  ...
  "serverBrowser.installFailed": "Impossibile installare {{title}}",
  "serverBrowser.unwedge": "Ripara il browser del gioco",
  "serverBrowser.unwedgeBlurb": "Per quando la schermata Browse di MX Bikes dice \"connection timeout\" dopo che hai lasciato un server. Lo risolve senza riavviare il gioco.",
  "serverBrowser.unwedgeSent": "Inviato. Riapri Browse nel gioco.",
  "serverBrowser.unwedgeNeedsFrostmod": "Il tuo FrostMod è troppo vecchio per questo. Aggiornalo e riprova.",
  "serverBrowser.unwedgeNoFrostmod": "FrostMod non è in esecuzione, quindi non c'è niente a cui inviarlo.",
  "serverBrowser.unwedgeFailed": "Non è stato possibile raggiungere il gioco.",
  "serverBrowser.buyTrack": "Acquista",
  "serverBrowser.buyHint": "Apre {{name}} nel negozio",
  "serverBrowser.inLine": "#{{position}} in coda",
  "serverBrowser.unnamed": "Server senza nome",
  "serverBrowser.full": "Server pieno",
  "serverBrowser.ping.title": "{{ms}} ms di andata e ritorno",
  "serverBrowser.viewTiles": "Riquadri",
  "serverBrowser.viewList": "Elenco",
  "serverBrowser.waitingCount": "{{count}} in coda",
  "serverBrowser.queueHint": "Pieno. MXB App entra per te quando si libera un posto.",

  // ── È il master server o sei tu? ──────────────────────────────────
  "connection.checking": "Controllo se il problema è solo tuo…",
  "connection.notYou": "I server di MX Bikes non rispondono",
  "connection.likelyYou": "Tutti gli altri ci riescono",
  ...
  "connection.verdict.unknown": "Non basta per dirlo: troppe poche app hanno controllato di recente. Riprova fra un minuto.",
  "connection.check.internet": "Internet",
  "connection.check.dns": "Indirizzo del master server",
  "connection.check.udp": "UDP in uscita",
  ...
  "queue.turn": "Si è liberato un posto su {{name}}. Entra ora dal gioco.",
  "queue.launching": "Si è liberato un posto. Avvio su {{name}}.",
  "queue.joined": "Sei su {{name}}.",
  "queue.missed": "Il tuo turno su {{name}} è passato, sei uscito dalla coda.",
  "queue.offline": "Impossibile raggiungere il servizio di MXB App. Riprovo.",
  "queue.joinFailed": "Impossibile metterti in coda",
  "queue.onlyApp": "In questa coda ci sono solo i piloti che usano MXB App.",
  "serverBrowser.copyAddress": "Copia l'indirizzo",
  "serverBrowser.copied": "Indirizzo copiato",
  "serverBrowser.copyLink": "Copia link del server",
  "serverBrowser.copyLinkHint": "Copia un link che apre questo server in {{app}}",
  "serverBrowser.linkCopied": "Link del server copiato",
  "serverBrowser.copyFailed": "Impossibile copiare il link.",
  "deepLink.otherGame": "Quel link è per {{game}} — cambia gioco per aprirlo.",
  "serverBrowser.location": "Posizione",
  "serverBrowser.running": "In corso",
  "serverBrowser.layout": "Tracciato",
  "serverBrowser.session": "Sessione",
  "serverBrowser.raceLength": "Durata",
  "serverBrowser.conditions": "Condizioni",
  "serverBrowser.changingWeather": "Meteo variabile",
  "serverBrowser.rules": "Regole",
  "serverBrowser.categories": "Categorie",
  "serverBrowser.bikes": "Moto",
  "serverBrowser.rating": "Classe di licenza",
  "serverBrowser.forceCockpit": "Solo vista pilota",
  "serverBrowser.noAids": "Nessun aiuto",
  "serverBrowser.limitedTyres": "Set di gomme limitati",
  "serverBrowser.connection": "Connessione",
  "serverBrowser.lanAddress": "Indirizzo dichiarato dal server",
  ...
  "serverBrowser.ridersUnknown":
    "MX Bikes dice all'app solo quanti piloti ci sono su un server. I nomi arrivano dai giocatori che usano {{app}}.",
  "serverBrowser.trackIsStock": "Incluso nel gioco",
  "serverBrowser.trackIsYours": "Hai questo tracciato",
  "serverBrowser.trackFrom": "Su {{where}}",
  ...
  "serverBrowser.trackStock": "È inclusa nel gioco — {{name}}",
  ...
  "serverBrowser.favesEmpty": "Nessuno dei tuoi preferiti è online con questo filtro.",
  "serverBrowser.hideEmpty": "Nascondi vuoti",
  "serverBrowser.filters": "Filtri",
  "serverBrowser.moreActions": "Altro",
  ...
  "feel.profile": "Profilo",
  "feel.saveCurrent": "Salva le impostazioni attuali come",
  "feel.namePlaceholder": "Supercross",
  "feel.save": "Salva",
  "feel.savedTitle": "Feeling salvati",
  "feel.noneHint":
    "Nessun feeling salvato. Imposta il gioco come ti piace per una disciplina e salvalo qui — poi rifallo per l'altra.",
  "feel.summary": "{{settings}} impostazioni · {{controls}} comandi regolati",
  "feel.apply": "Applica",
  "feel.applied": "{{name}} applicato.",
  "feel.restartHint": "Avvia il gioco per provarlo.",
  "feel.missingControls": "Non mappati in questo profilo: {{names}}",
  "feel.applyFailed": "Impossibile applicare questo feeling",
  "feel.saved": "{{name}} salvato.",
  "feel.saveFailed": "Impossibile salvare questo feeling",
  "feel.nameFirst": "Dai prima un nome al feeling.",
  "feel.pickProfile": "Scegli prima un profilo.",
  "feel.nothingToSave": "Questo profilo non ha ancora impostazioni da salvare.",
  "feel.deleted": "{{name}} eliminato.",
  "feel.share": "Condividi",
  "feel.shareTitle": "Condividi {{name}}",
  "feel.shareBody":
    "Invia questo codice a chi vuoi — contiene solo le impostazioni, mai i tuoi comandi, il controller o la modalità schermo.",
  "feel.shareFailed": "Impossibile creare il codice",
  "feel.import": "Importa",
  "feel.importTitle": "Importa un feeling",
  "feel.importBody": "Incolla un codice feeling per aggiungerlo alla tua lista.",
  "feel.importPlaceholder": "MXBF1-…",
  "feel.imported": "{{name}} importato.",
  "feel.importFailed": "Impossibile importare questo codice",
  "presets.duplicate": "Duplica",
  ...
  "feel.updated": "{{name}} aggiornato.",
  "feel.groupControls": "Feeling dei comandi",
  "feel.groupInput": "Input",
  "feel.groupAids": "Aiuti di guida",
  "feel.groupView": "Telecamera",
  "feel.groupExtView": "Telecamera esterna",
  "feel.groupGfx": "Qualità grafica",
  "feel.filter": "Trova un'impostazione",
  "feel.filterPlaceholder": "gas, inclinazione, telecamera…",
  "feel.noMatches": "Nessun risultato per “{{text}}”.",
  "feel.control.throttle": "Acceleratore",
  "feel.control.brake": "Freno anteriore",
  "feel.control.rearBrake": "Freno posteriore",
  "feel.control.clutch": "Frizione",
  "feel.control.shiftUp": "Marcia su",
  "feel.control.shiftDown": "Marcia giù",
  "feel.control.shiftUpPreload": "Marcia su (precarico)",
  "feel.control.shiftDownPreload": "Marcia giù (precarico)",
  "feel.control.lean": "Piega",
  "feel.control.leanForwardBack": "Pilota avanti/indietro",
  "feel.control.leanLeftRight": "Pilota sinistra/destra",
  "feel.control.sit": "Seduto",
  "feel.control.sitDirect": "Seduto (diretto)",
  "feel.control.changeView": "Cambia visuale",
  "feel.control.lookBack": "Guarda dietro",
  "feel.control.heading": "Direzione",
  ...
  "library.stock": "Inclusa nel gioco",
  "library.stockSection": "Piste originali",
  "library.stockSectionHint":
    "Le piste che MX Bikes porta con sé. Stanno dentro il tracks.pkz del gioco, quindi qui non c'è nessun file da spostare o rimuovere — guardane una in 3D, oppure estraila come .pkz a sé.",
  ...
  "library.yours": "Tuo",
  "owned.title": "Acquistato",
  "owned.loading": "Lettura dei tuoi acquisti…",
  "owned.signedOut": "Accedi a uno store per vedere tutti i tuoi acquisti in un unico posto.",
  "owned.openStores": "Apri gli store",
  "owned.empty": "Non hai ancora acquistato nulla.",
  "owned.fromShop": "mxbikes-shop",
  "owned.fromHub": "MXB Hub",
  "owned.notInstalled": "Non installato",
  "wishlist.title": "Lista dei desideri",
  "wishlist.add": "Aggiungi alla lista dei desideri",
  "wishlist.remove": "Rimuovi dalla lista dei desideri",
  "wishlist.empty": "La tua lista dei desideri è vuota.",
  "wishlist.emptyHint":
    "Apri un mod e premi Aggiungi alla lista dei desideri per tenerlo qui.",
  "wishlist.wanted": "Nella tua lista dei desideri",
  ...
  "library.openModsFolder": "Apri la cartella {{type}}",
  ...
  "share.replacesTag": "Sostituisce il tuo",
  "share.willReplace_one": "1 di questi sostituisce qualcosa che hai già — l'importazione lo sovrascrive.",
  "share.willReplace_other": "{{count}} di questi sostituiscono cose che hai già — l'importazione le sovrascrive.",
  ...
  "share.secondsLeft": "Circa {{n}} s rimanenti",
  "share.minutesLeft": "Circa {{n}} min rimanenti",
  ...
  "live.moreActions": "Altre azioni",
  "live.adoptTitle": "Pubblica da un altro computer",
  "live.adoptHint":
    "Incolla una chiave proprietario copiata dal computer che ha creato il codice. Permette a questo computer di pubblicarne gli aggiornamenti.",
  ...
  "downloads.timeLeft": "{{time}} rimanenti",
  "downloads.moveToFront": "Sposta in cima alla coda",
  "downloads.sectionActive": "In corso",
  "downloads.sectionQueued": "In attesa",
  ...
  "voice.proximity": "Senti i piloti da dove si trovano",
  "voice.proximityDesc": "Un pilota accanto a te è forte e dal suo lato; uno a due curve di distanza è debole. Disattivalo per sentire tutti allo stesso volume. Torna da solo al volume piatto quando il gioco non comunica le posizioni.",

  "overlay.shortcutUpdated": "Scorciatoia overlay aggiornata",
  "overlay.shortcutRejected": "Impossibile usare questa scorciatoia",
  "overlay.coachLinked": "MXB Coach è collegato: le sue schede compaiono nell'overlay e questa scorciatoia apre entrambi.",
  "overlay.registerFailed": "Impossibile registrare la scorciatoia dell'overlay",
  "overlay.needsSetup": "Completa prima la configurazione di {{app}} nella finestra principale — deve sapere dov'è la tua cartella {{game}}.",
  ...
  "showcase.v0170.hero.title":
    "Trovare un server quando il gioco non ci riesce",
  "showcase.v0170.hero.body":
    "Metà dei problemi del multigiocatore di MX Bikes non sono i server. È sentirsi dire \"connection timeout\" e nient'altro. Questa versione ripara il browser del gioco e ti dà una lista che funziona quando lui non funziona.",
  "showcase.v0170.browser":
    "La schermata Browse del gioco smette di andare in timeout per tutta la serata dopo che hai lasciato un server. FrostMod la sblocca mentre giochi.",
  "showcase.v0170.book":
    "La scheda Servers continua a funzionare quando la lista di MX Bikes è giù: chiede a ogni server direttamente, da una rubrica condivisa.",
  "showcase.v0170.check":
    "Quando la lista non si carica, l'app dice se sono i server di MX Bikes o qualcosa dalla tua parte, e controlla la tua connessione.",
  ...
  "showcase.v0150.hero.body":
    "Su un server con una pista gratuita che non hai, un pulsante installa la pista ed entra. Se il server è pieno, ti mette in coda.",
  "showcase.v0150.pictures":
    "Le schede dei server mostrano l'immagine della pista anche se non ce l'hai, con un segno per capirlo a colpo d'occhio.",
  "showcase.v0150.prices":
    "Le piste vendute nello shop mostrano il prezzo sulla scheda, e il pulsante apre la loro pagina nello shop.",
  "showcase.v0150.feel":
  ...
  "showcase.v0124.hero.body":
    "MX Bikes non trasmette contenuti personalizzati, quindi una lobby di sconosciuti è sempre stata una lobby di livree predefinite. {{app}} ora condivide quello che indossi con i piloti attorno a te e installa le loro — su qualsiasi server, senza nulla da fare per l'host e senza codici.",
  ...
  "showcase.v0124.everyone":
    "Vedrai ogni pilota che ha anch'esso {{app}}. Più ce ne sono nella tua lobby, più la griglia appare giusta.",
  ...
  "showcase.v0124.stats":
    "{{app}} ora conta in modo anonimo quali pagine e funzioni vengono usate — un ID casuale e nulla su di te. Impostazioni → Generali lo disattiva.",
  ...
  "showcase.v080.hero.title": "{{app}} gestisce anche GP Bikes",
  ...
  "showcase.v070.languages": "{{app}} parla sei lingue — scegli la tua in Impostazioni → Aspetto.",
  ...
  "settings.logs": "Log",
  "logs.desc":
    "I file da inviare quando qualcosa non va. {{app}}, FrostMod e {{game}} tengono ciascuno i propri — apri la cartella che ti serve, salvali tutti in un unico zip, oppure condividili come link da incollare in una segnalazione.",
  "logs.appLogs": "{{app}}",
  ...
  "settings.supportersDesc": "Chi tiene in piedi {{app}} su Buy Me a Coffee.",
  "supporters.intro":
    "{{app}} è gratuita, e resta così. I caffè qui sotto pagano il tempo che ci sta dietro: chi li ha offerti è il motivo per cui c'è una nuova build da installare.",
  ...
  "reshade.loosePreset": "Nella tua cartella di gioco — non installato da {{app}}",
  ...
  "track.openStudio": "Apri lo Studio Tracciati",
  "track.buildingTitle": "Compilazione di “{{name}}”",
  "track.compiled": "Compilato",
  "track.getTools": "Scarica gli strumenti pista",
  "track.gettingTools": "Scaricamento…",
  "track.toolsReady": "Strumenti pista pronti",
  "track.toolsFailed": "Impossibile scaricare gli strumenti pista",
  "track.stillNeeded": "Compila la pista con TerrainEd e la installa — poi scegliila in MX Bikes. Aprila in TrackEd se vuoi spostare le telecamere.",
  ...
  "plugins.installedStudio": "{{name}} è installato. I suoi pannelli si aprono in Frost's Studio.",
  "plugins.inStudio": "Si apre in Frost's Studio: è uno strumento da creatore, ed è lì che stanno adesso.",
  "plugins.openStudio": "Apri nello Studio",
  ...
  "ranked.manualOverride": "Stai vedendo un GUID inserito a mano, non il tuo account Steam.",
  "ranked.useSteam": "Usa il mio account Steam",
  ...
  "ranked.unracedTitle": "Nessuna gara classificata",
  "ranked.unracedBody": "MXB Ranked calcola il tuo rango dalle gare sui propri server. Entra in uno — sono le lobby chiamate MXB-Ranked.com — e rango, statistiche di stagione e ogni risultato compariranno qui.",
  "ranked.unracedFind": "Trova un server classificato",
  "ranked.unracedNotYou": "Stai già gareggiando? Allora questo non è il tuo GUID: inserisci quello giusto con il pulsante GUID qui sopra.",
  "ranked.exp": "EXP",
  ...
  "setup.steamOptional": "Steam è facoltativo. Ti serve solo per gli acquisti protetti e Ranked.",
  "setup.steamSkip": "Salta per ora",
  "setup.integrationTitle": "Attivare l'integrazione di gioco?",
  "setup.integrationIntro": "{{app}} funziona senza l'integrazione di gioco. Attivala solo se vuoi mod protette, ricaricamento istantaneo e sincronizzazione delle grafiche nel gioco.",
  "setup.integrationCrashFixes": "Include anche correzioni mirate per arresti anomali noti di {{game}}.",
  "setup.integrationInstallDisclosure": "Questo installa frostmod.exe e frostmod.dll dalla release ufficiale di FrostMod su GitHub nella cartella dati privata dell'app. Il download viene preparato e controllato usando i metadati della release prima di apportare modifiche.",
  "setup.integrationUseAppOnly": "Usa solo l'app",
  "setup.integrationEnable": "Attiva l'integrazione di gioco",
  "setup.integrationChooseInstall": "Scegli la cartella del gioco e attiva",
  "setup.integrationInstallRequired": "Serve la cartella di installazione di {{game}}",
  "setup.integrationInstallRequiredDesc": "L'integrazione richiede la cartella che contiene l'eseguibile del gioco. Non è stata rilevata automaticamente; selezionala per continuare.",
  "setup.integrationLearnMore": "Vedi i dettagli tecnici",
  "integration.title": "Integrazione di gioco",
  "integration.poweredBy": "Basata su FrostMod",
  "settings.integrationIntro": "Funzioni facoltative nel gioco per mod protette, ricaricamento istantaneo e sincronizzazione delle grafiche. Le mod standard non ne hanno bisogno.",
  "integration.details": "Dettagli tecnici",
  "integration.detailsTitle": "Cosa installa l'integrazione di gioco",
  "integration.optional": "Facoltativa",
  "integration.optionalDesc": "Le mod standard funzionano senza integrazione di gioco. Le mod protette dal creatore la richiedono.",
  "integration.protectedContentTitle": "Come funzionano i contenuti protetti",
  "integration.protectedContentDesc": "Dopo la verifica della proprietà tramite Steam, su questo PC viene salvata una chiave offline. I file protetti vengono aperti in memoria solo mentre il gioco li usa; nessuna copia estratta viene scritta su disco.",
  "integration.privacyTitle": "I tuoi dati",
  "integration.privacyDesc": "I file delle tue mod non vengono caricati. {{app}} non riceve mai la tua password Steam; Steam gestisce l'accesso e restituisce solo l'identità dell'account necessaria per verificare la proprietà.",
  "integration.filesTitle": "File installati",
  "integration.publisher": "Editore",
  "integration.publisherValue": "MXB App · Basata su FrostMod",
  "integration.source": "Fonte del download",
  "integration.sourceValue": "Release ufficiali di FrostMod su GitHub",
  "integration.components": "Componenti",
  "integration.componentsValue": "frostmod.exe e frostmod.dll",
  "integration.installLocation": "Percorso d'installazione",
  "integration.installLocationValue": "Cartella dati privata dell'app / frostmod",
  "integration.network": "Servizi di rete",
  "integration.networkValue": "GitHub per gli aggiornamenti dell'integrazione; servizi MXB App per la verifica della proprietà e le funzioni online attivate.",
  "integration.integrity": "Controlli d'integrità",
  "integration.integrityValue": "La dimensione del file viene sempre controllata. Anche SHA-256 viene controllato quando la release lo fornisce.",
  "integration.control": "Il tuo controllo",
  "integration.controlValue": "L'integrazione di gioco è facoltativa e può essere arrestata in qualsiasi momento.",
  "integration.standardMods": "Le mod standard continuano a funzionare senza integrazione di gioco.",
  "integration.protectedMods": "Le mod protette dal creatore richiedono l'integrazione mentre giochi.",
  "activity.automaticTitle": "Attività automatica",
  "activity.automaticDesc": "Azioni eseguite o tentate dall'app. Salvate solo su questo dispositivo.",
  "activity.clear": "Cancella",
  "activity.clearAria": "Cancella l'attività automatica",
  "activity.empty": "Nessuna azione automatica registrata.",
  "activity.noMatches": "Nessuna attività automatica corrisponde alla ricerca.",
  "activity.completed": "Completata",
  "activity.failed": "Non riuscita",
  "activity.notice": "Avviso",
  "activity.integrationAppOnly": "Modalità solo app selezionata",
  "activity.integrationAppOnlyDesc": "L'integrazione di gioco non si avvierà né si aggiornerà automaticamente.",
  "activity.integrationEnabled": "Integrazione di gioco attivata",
  "activity.integrationEnabledDesc": "Le funzioni facoltative nel gioco sono consentite su questo dispositivo.",
  "activity.integrationInstalled": "Integrazione di gioco {{version}} installata",
  "activity.integrationInstallFailed": "Installazione dell'integrazione di gioco non riuscita",
  "mxbmrp3.title": "Prova MXBMRP3 per un HUD migliore nel gioco",
  "mxbmrp3.what": "MXBMRP3 è un plugin HUD gratuito e open source di thomas4f. Aggiunge a {{game}} classifica, tempi sul giro, il distacco dal tuo giro migliore, una mappa del tracciato e un radar.",
  "mxbmrp3.how": "Scaricalo dalla sua pagina GitHub ufficiale e installalo con il suo installer. {{app}} controlla solo se c'è. Non lo scarica mai e non modifica la cartella del gioco.",
  "mxbmrp3.get": "Ottieni MXBMRP3",
  "mxbmrp3.notNow": "Non ora",
  "mxbmrp3.never": "Non chiedere più",
  "mxbmrp3.installed": "MXBMRP3 è installato",
  "mxbmrp3.missing": "MXBMRP3 non è installato",
  "mxbmrp3.unknown": "Imposta la cartella del gioco per cercare MXBMRP3",
  "mxbmrp3.settingsDesc": "MXBMRP3 è un plugin HUD gratuito di thomas4f (classifica, tempi, mappa del tracciato, radar). {{app}} lo cerca solo nella cartella plugins del gioco.",
  "mxbmrp3.askAgain": "Suggeriscilo di nuovo",
};
