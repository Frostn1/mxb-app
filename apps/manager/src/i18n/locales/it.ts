...
export const it: Translation = {
  ...
  "settings.secRepairRevoked_one": "Il creatore ha rimosso l'accesso a {{count}} file — la sua chiave non è più su questo PC.",
  "settings.secRepairRevoked_other": "I creatori hanno rimosso l'accesso a {{count}} file — le loro chiavi non sono più su questo PC.",
  ...
  "settings.secReasonRevoked": "Il creatore ti ha rimosso l'accesso. La chiave è stata eliminata da questo PC.",
  ...
  "secure.revokedBody": "{{names}} — il creatore ti ha rimosso l'accesso, quindi la chiave è stata eliminata da questo PC.",
