...
export const en = {
  ...
  "settings.secRepairRevoked_one": "Access to {{count}} file was removed by its creator — its key is gone from this PC.",
  "settings.secRepairRevoked_other": "Access to {{count}} files was removed by their creators — their keys are gone from this PC.",
  ...
  "settings.secReasonRevoked": "The creator removed your access. The key for this has been deleted from this PC.",
  ...
  "secure.revokedBody": "{{names}} — the creator removed your access, so the key has been deleted from this PC.",
