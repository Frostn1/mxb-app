...
export const es: Translation = {
  ...
  "settings.secRepairRevoked_one": "El creador retiró el acceso a {{count}} archivo — su clave ya no está en este PC.",
  "settings.secRepairRevoked_other": "Los creadores retiraron el acceso a {{count}} archivos — sus claves ya no están en este PC.",
  ...
  "settings.secStatusRevoked": "Acceso retirado",
  "settings.secReasonRevoked": "El creador te retiró el acceso. Su clave se ha borrado de este PC.",
  ...
  "secure.revokedTitle_one": "Ya no tienes acceso a un mod protegido",
  "secure.revokedTitle_other": "Ya no tienes acceso a {{count}} mods protegidos",
  "secure.revokedBody": "{{names}} — el creador te retiró el acceso, así que la clave se ha borrado de este PC.",
