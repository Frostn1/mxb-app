 ...
 *
 * Product names ({{app}}, FrostMod, MX Bikes) are never translated.
 */
export const es: Translation = {
  ...
  "tour.locker.body":
    "Cambia los modelos de las motos a tu gusto. {{app}} registra las piezas para que el juego las reconozca.",
  ...
  "installDialog.opensInBrowser":
    "Se abre en el navegador — {{app}} termina la instalación",
  ...
  "settings.gameDesc":
    "Qué juego está gestionando {{app}}. Tus carpetas, tu biblioteca y tus presets pertenecen al juego que elijas aquí.",
  ...
  "settings.colorwaySlate": "Pizarra",
  ...
  "settings.launchAtStartupDesc":
    "Inicia {{app}} automáticamente al iniciar sesión.",
  ...
  "secure.provisionedOk": "Vinculado — clave guardada localmente",
  "secure.provisionFailed": "No se pudo vincular la clave",
  "secure.openOffline": "Abrir sin conexión",
  "secure.offlineOk": "Abierto sin conexión y coincide.",
  "secure.offlineBad": "Abierto sin conexión, pero no coincide.",
  "secure.offlineFailed": "No se pudo abrir sin conexión",
  "secure.offlineMatches": "Abierto sin conexión — coincide, sin servidor",
  "secure.offlineMismatch": "No coincide",
  ...
  "sync.installedState_one": "{{count}} pintura de otro piloto está en tu carpeta mods",
  "sync.installedState_other": "{{count}} pinturas de otros pilotos están en tu carpeta mods",
  "sync.installedWhy": "Se escriben en tu carpeta mods para que el juego pueda dibujarlas. Quítalas para dejar la carpeta como estaba — lo que hayas editado se conserva.",
  "sync.remove": "Quitarlas",
  "sync.removed_one": "Se quitó {{count}} pintura sincronizada",
  "sync.removed_other": "Se quitaron {{count}} pinturas sincronizadas",
  "sync.removeKeptYours_one": "{{count}} se conservó — la has editado desde que se instaló.",
  "sync.removeKeptYours_other": "{{count}} se conservaron — las has editado desde que se instalaron.",
  "sync.removeFailed": "No se pudieron quitar las pinturas sincronizadas",
  ...
  "serverBrowser.location": "Ubicación",
  "serverBrowser.running": "En curso",
  "serverBrowser.layout": "Trazado",
  "serverBrowser.session": "Sesión",
  "serverBrowser.raceLength": "Duración",
  "serverBrowser.conditions": "Condiciones",
  "serverBrowser.changingWeather": "Clima variable",
  "serverBrowser.rules": "Reglas",
  "serverBrowser.categories": "Categorías",
  "serverBrowser.bikes": "Motos",
  "serverBrowser.rating": "Clase de licencia",
  "serverBrowser.forceCockpit": "Solo vista de piloto",
  "serverBrowser.noAids": "Sin ayudas",
  "serverBrowser.limitedTyres": "Juegos de neumáticos limitados",
  "serverBrowser.connection": "Conexión",
  "serverBrowser.lanAddress": "Dirección informada por el servidor",
  ...
  "serverBrowser.ridersUnknown":
    "MX Bikes solo le dice a la app cuántos pilotos hay en un servidor. Los nombres vienen de los jugadores que usan {{app}}.",
  ...
  "feel.profile": "Perfil",
  "feel.saveCurrent": "Guardar los ajustes actuales como",
  "feel.namePlaceholder": "Supercross",
  "feel.save": "Guardar",
  "feel.savedTitle": "Ajustes guardados",
  "feel.noneHint":
    "Aún no hay ajustes guardados. Deja el juego como te gusta para una disciplina y guárdalo aquí — y repite para la otra.",
  "feel.summary": "{{settings}} ajustes · {{controls}} controles afinados",
  "feel.apply": "Aplicar",
  "feel.applied": "{{name}} aplicado.",
  "feel.restartHint": "Abre el juego para probarlo.",
  "feel.missingControls": "Sin asignar en este perfil: {{names}}",
  "feel.applyFailed": "No se pudo aplicar ese ajuste",
  "feel.saved": "{{name}} guardado.",
  "feel.saveFailed": "No se pudo guardar ese ajuste",
  "feel.nameFirst": "Primero ponle un nombre.",
  "feel.pickProfile": "Elige un perfil primero.",
  "feel.nothingToSave": "Ese perfil todavía no tiene ajustes que guardar.",
  "feel.deleted": "{{name}} eliminado.",
  "feel.share": "Compartir",
  "feel.shareTitle": "Compartir {{name}}",
  "feel.shareBody":
    "Envía este código a quien quieras — solo lleva los ajustes, nunca tus controles, tu mando ni el modo de pantalla.",
  "feel.shareFailed": "No se pudo crear el código",
  "feel.import": "Importar",
  "feel.importTitle": "Importar un ajuste",
  "feel.importBody": "Pega un código para añadirlo a tu lista.",
  "feel.importPlaceholder": "MXBF1-…",
  "feel.imported": "{{name}} importado.",
  "feel.importFailed": "No se pudo importar ese código",
  "presets.duplicate": "Duplicar",
  "presets.duplicated": "Duplicado como {{name}}.",
  "feel.edit": "Ver y cambiar lo que contiene",
  "feel.editTitle": "{{name}}",
  "feel.editName": "Nombre",
  "feel.editNameClash": "Ya hay un ajuste llamado “{{name}}”.",
  "feel.editSave": "Guardar cambios",
  "feel.updated": "{{name}} actualizado.",
  "feel.groupControls": "Tacto de los controles",
  "feel.groupInput": "Entrada",
  "feel.groupAids": "Ayudas de pilotaje",
  "feel.groupView": "Cámara",
  "feel.groupExtView": "Cámara exterior",
  "feel.groupGfx": "Calidad gráfica",
  "feel.filter": "Buscar un ajuste",
  "feel.filterPlaceholder": "gas, inclinación, cámara…",
  "feel.noMatches": "Nada coincide con “{{text}}”.",
  ...
  "share.replacesTag": "Reemplaza el tuyo",
  "share.willReplace_one": "1 de estos reemplaza algo que ya tienes — importar lo sobrescribe.",
  "share.willReplace_other": "{{count}} de estos reemplazan cosas que ya tienes — importar las sobrescribe.",
  ...
  "live.moreActions": "Más acciones",
  "live.adoptTitle": "Publicar desde otro equipo",
  "live.adoptHint":
    "Pega una clave de propietario copiada del equipo que creó el código. Permite que este equipo publique sus actualizaciones.",
  ...
  "overlay.openMainTitle": "Cierra el overlay y abre la ventana principal de {{app}}",
  "overlay.needsSetup": "Termina de configurar {{app}} en su ventana principal — necesita saber dónde está tu carpeta de {{game}}.",
  ...
  "showcase.v0137.hero.body":
    "La pestaña Servidores lista todos los servidores de la lista maestra con su ping real, el circuito que se está rodando y la sesión en curso. Sigue funcionando con MX Bikes abierto: la app pregunta a cada servidor directamente, así que nada compite con el juego por tu cuenta.",
  "showcase.v0137.whoson":
    "Abre un servidor para ver quién está dentro, qué permite y el circuito que corre — con su imagen si lo tienes, y dónde conseguirlo si no.",
  "showcase.v0137.cheats":
    "Los servidores que anuncian cheats quedan ocultos, con las mismas reglas que usa FrostMod en el juego. La pestaña dice cuántos ocultó y te deja verlos.",
  "showcase.v0137.livecodes":
    "Códigos que se mantienen al día. Envía un código corto una vez y publica nuevas versiones en él: quien lo pegó las recibe, y Auto las instala.",
  "showcase.v0137.viewer":
    "La vista 3D dibuja el suelo real del circuito: cada capa con su propia textura a través de las máscaras del propio circuito, su escenografía con sus texturas y el cielo que trae.",
  "showcase.v0137.ranked":
    "Una pestaña Ranked con tu rango de MXB Ranked, MXP, estadísticas de temporada y tus últimas 50 carreras. Nada que registrar: saca tu GUID de Steam.",
  "showcase.v0137.look":
    "Nuevo aspecto. La navegación pasa a una barra superior, así las imágenes de los mods ocupan todo el ancho — siete por fila en vez de cinco.",
  "showcase.v0124.hero.title":
    "Toda la parrilla con la pintura que de verdad eligió",
  "showcase.v0124.hero.body":
    "MX Bikes no envía contenido personalizado, así que una sala de desconocidos siempre ha sido una sala de libreas por defecto. {{app}} ahora comparte lo que llevas con los pilotos que te rodean e instala las suyas — en cualquier servidor, sin que el anfitrión haga nada y sin códigos.",
  ...
  "showcase.v0124.everyone":
    "Verás a cualquier piloto que también tenga {{app}}. Cuantos más haya en tu sala, más parrilla se ve como debe.",
  ...
  "showcase.v0124.stats":
    "{{app}} ahora cuenta de forma anónima qué páginas y funciones se usan — un ID aleatorio y nada sobre ti. Ajustes → General lo desactiva.",
  ...
  "showcase.v080.hero.title": "{{app}} también maneja GP Bikes",
  ...
  "showcase.v070.languages": "{{app}} habla seis idiomas — elige el tuyo en Ajustes → Apariencia.",
  ...
  "logs.desc":
    "Los archivos que hay que enviar cuando algo falla. {{app}}, FrostMod y {{game}} guardan los suyos por separado — abre la carpeta que necesites, guárdalos todos en un zip, o compártelos como un enlace para pegar en un informe.",
  "logs.appLogs": "{{app}}",
  ...
  "settings.supportersDesc": "Quienes mantienen {{app}} en Buy Me a Coffee.",
  "supporters.intro":
    "{{app}} es gratis, y así seguirá. Los cafés de abajo son los que pagan el tiempo que hay detrás: quienes los invitaron son la razón de que haya una versión nueva que instalar.",
  ...
  "reshade.loosePreset": "En tu carpeta del juego — no lo instaló {{app}}",
  ...
  "track.installed": "Vista previa instalada",
  "track.installFailed": "No se pudo instalar",
  ...
  "track.openStudio": "Abrir el Estudio de circuitos",
  "track.buildingTitle": "Compilando “{{name}}”",
  "track.compiled": "Compilado",
  "track.getTools": "Descargar las herramientas de pista",
  "track.gettingTools": "Descargando…",
  "track.toolsReady": "Herramientas de pista listas",
  "track.toolsFailed": "No se pudieron descargar las herramientas",
  "track.stillNeeded": "Compila la pista con TerrainEd y la instala — luego elígela en MX Bikes. Ábrela en TrackEd si quieres mover las cámaras.",
  ...
  "ranked.refresh": "Actualizar",
  "ranked.openSite": "En mxb-ranked",
  "ranked.loading": "Leyendo tu perfil en mxb-ranked.com…",
  "ranked.retry": "Reintentar",
  "ranked.refreshFailed": "No se pudo actualizar desde mxb-ranked.com",
  "ranked.noGuid": "MXB Ranked identifica a los pilotos por su GUID de MX Bikes. La tuya se deduce de la cuenta de Steam con la que has iniciado sesión — si compraste MX Bikes directamente, introduce la GUID de tu perfil de mxb-ranked.",
  "ranked.enterGuid": "Introducir GUID",
  "ranked.guidTitle": "GUID de MX Bikes",
  "ranked.guidHelp": "Qué perfil mostrar. Pega una GUID o un enlace a un perfil de mxb-ranked; déjalo vacío para volver a tu propia cuenta de Steam.",
  "ranked.since": "miembro desde {{date}}",
  "ranked.manualGuid": "introducida a mano",
  "ranked.exp": "EXP",
  "ranked.riderRating": "Valoración",
  "ranked.penaltyPoints": "Pts de penalización",
  "ranked.globalAvg": "Media global: {{value}}",
  "ranked.rank": "Puesto {{rank}}",
  "ranked.races": "Carreras",
  "ranked.avgPosition": "Posición media",
  "ranked.wins": "Victorias",
  "ranked.podiums": "Podios",
  "ranked.wrLaps": "Vueltas WR",
  "ranked.pbLaps": "Vueltas PB",
  "ranked.holeshots": "Holeshots",
  "ranked.track": "Circuito",
