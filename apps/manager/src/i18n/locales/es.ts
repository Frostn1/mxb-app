...
export const es: Translation = {
  ...
  "mods.sourceAll": "Todas las fuentes",
  "mods.sourceMods": "mxb-mods",
  "mods.searchPlaceholder": "Buscar mods…",
  "mods.empty": "No hay resultados.",
  "mods.shopStale": "Los precios de la tienda pueden estar desactualizados.",
  "mods.help": "Una sola pantalla para todos los catálogos. Elige a la izquierda lo que buscas y usa el filtro de fuente para mostrar mxb-mods, MXB Hub, la tienda o los tres a la vez. Los artículos de pago muestran su precio; el resto indica Gratis.",
  "nav.browse": "Explorar",
  "nav.shop": "Tienda",
  "nav.hub": "MXB Hub",
  "nav.library": "Biblioteca",
  "nav.garage": "Garaje",
  "nav.downloads": "Actividad",
  "nav.locker": "Taquilla",
  "nav.presets": "Presets",
  ...
  // ── FrostMod ───────────────────────────────────────────────────────────────
  "frostmod.checking": "Comprobando la integración con el juego…",
  "frostmod.running": "Integración con el juego lista",
  "frostmod.notRunning": "Integración con el juego desactivada",
  "frostmod.notInGame": "La integración está esperando al juego",
  "frostmod.reloadGame": "Recargar el juego",
  "frostmod.start": "Iniciar la integración con el juego",
  "frostmod.reloadedGame": "La integración recargó el juego.",
  "frostmod.notRunningToast": "La integración con el juego está desactivada.",
  "frostmod.started": "Integración con el juego iniciada",
  "frostmod.alreadyRunning": "La integración con el juego ya está activa",
  "frostmod.startFailed": "No se pudo iniciar la integración con el juego",
  "frostmod.stop": "Detener la integración con el juego",
  "frostmod.stopped": "Integración con el juego detenida",
  "frostmod.stopFailed": "No se pudo detener la integración con el juego",
  ...
  "frostmod.installedToast": "Integración con el juego {{version}} instalada",
  "frostmod.installedToastDesc":
    "Recargará el juego en caliente cuando añadas mods.",
  "frostmod.installedToastRestart": "Reinicia MX Bikes para cambiarla: el juego abierto sigue usando la integración anterior.",
  "frostmod.installFailed": "No se pudo instalar la integración con el juego",
  ...
  "frostmod.askedReload": "Se pidió a la integración que recargara el juego.",
  "frostmod.andMore_one": "{{names}} y {{count}} más",
  "frostmod.andMore_other": "{{names}} y {{count}} más",
  "frostmod.watchDesc": "{{names}} — se pidió a la integración que recargara el juego.",
  ...
  "presets.openWindowsSecurity": "Abrir Seguridad de Windows",
  ...
  "tour.frostmod.title": "Integración con el juego",
  "tour.frostmod.body":
  ...
  "runtime.bannerFrostmod": "La integración con el juego necesita {{what}} para funcionar.",
  "runtime.pitch":
  ...
  "shopDetail.notOwned": "No comprado",
  ...
  "libraryDetail.securedLockedNote": "Contenido protegido con mxbsecure. Desbloquéalo para ver sus detalles y jugarlo: inicia sesión con Steam si aún no lo has hecho. También se desbloquea solo al iniciar el juego.",
  ...
  "modDetail.openOnSite": "Abrir en {{site}}",
  "modsVerify.shown": "Completa la verificación en la ventana «Verificando acceso a {{site}}» para cargar las páginas de mods.",
  "modsVerify.cleared": "{{site}} verificado.",
  "modsVerify.dismissed": "Verificación cerrada — las páginas de mods de {{site}} no se cargarán en la app. Pulsa Reintentar para volver a verla.",
  ...
  "modDetail.inLibrary": "En la biblioteca",
  "modDetail.notInstalled": "No instalado",
  "modDetail.addToLibrary": "Añadir a la biblioteca",
  "modDetail.fromHost": "Desde {{host}}",
  "modDetail.categoryLabel": "Categoría",
  "modDetail.host": "Host",
  ...
  "settings.frostmod": "Integración con el juego",
  ...
  "settings.queueRestartGame": "Cerrar el juego cuando te toque en la cola",
  "settings.queueRestartGameDesc": "Cuando te toque en la cola de un servidor y el juego esté abierto, se cierra y se vuelve a abrir directamente en el servidor.",
  ...
  "accounts.desc": "Todos los inicios de sesión que guarda la app y para qué sirve cada uno.",
  "accounts.steam": "Steam",
  "accounts.steamNot": "Sin vincular.",
  "accounts.steamWhat": "Libera las claves de las mods protegidas que tienes. Para cambiarlo, inicia sesión otra vez.",
  "accounts.shop": "mxbikes-shop.com",
  "accounts.hub": "MXB Hub",
  "accounts.mods": "mxb-mods.com",
  "accounts.modsNone": "Sin cuenta.",
  "accounts.modsNote": "Aquí navegar y descargar es anónimo, no hay nada a lo que iniciar sesión.",
  "accounts.shopNote": "Las compras se leen desde una ventana del navegador que se mantiene abierta, porque el reto de Cloudflare de la tienda rechaza a un cliente normal. Tarda unos segundos.",
  "accounts.hubNote": "Las compras llegan por el cliente normal, así que esta responde rápido.",
  "accounts.signedIn": "Sesión iniciada",
  "accounts.signedOut": "Sin sesión",
  "accounts.checking": "Comprobando…",
  "accounts.countUnknown": "Sesión iniciada. Compras aún sin leer.",
  "accounts.purchases_one": "{{count}} compra",
  "accounts.purchases_other": "{{count}} compras",
  "accounts.signIn": "Iniciar sesión",
  "accounts.signOut": "Cerrar sesión",
  "accounts.refreshFailed": "No se pudieron leer tus compras",
  "accounts.signOutFailed": "No se pudo cerrar la sesión",
  "accounts.autoInstall": "Instalar las compras automáticamente",
  "accounts.autoInstallDesc": "Después de que la app te abra la página de una tienda, la vigila unos dos minutos e instala todo lo que aparezca nuevo.",
  "accounts.readTitle": "Cómo se encuentra una compra",
  "accounts.readBody": "Ninguna de las dos tiendas avisa a la app cuando compras algo, así que la app tiene que mirar. Mientras vigila mira cada pocos segundos y para al cabo de unos dos minutos. mxbikes-shop.com se lee desde una ventana del navegador que se mantiene abierta y puede ser lento; MXB Hub responde rápido. Si una compra llega después de que pare la vigilancia, abre Compras y pulsa Actualizar.",
  "accounts.installing": "Instalando {{name}}",
  "accounts.pickFile": "{{name}} está en tu cuenta. Viene en varios archivos, así que elige el que quieras en Compras.",
  "accounts.manyNew": "Se han encontrado compras nuevas. Abre Compras para instalarlas.",
  ...
  "settings.secRepair": "Claves que faltan",
  "settings.secRepairDesc": "Recupera un archivo de clave borrado sin querer. La app guarda su propia copia de tus claves, así que normalmente no hace falta internet.",
  "settings.secRepairBtn": "Restaurar claves",
  "settings.secRepairBusy": "Restaurando…",
  "settings.secRepairOk_one": "{{count}} clave restaurada. Tu contenido protegido vuelve a funcionar.",
  "settings.secRepairOk_other": "{{count}} claves restauradas. Tu contenido protegido vuelve a funcionar.",
  "settings.secRepairNone_one": "Se revisó {{count}} archivo: su clave está en su sitio.",
  "settings.secRepairNone_other": "Se revisaron {{count}} archivos: todas las claves están en su sitio.",
  "settings.secRepairFail": "No se pudieron restaurar todas las claves",
  "settings.secRepairFailDesc_one": "{{count}} archivo necesita que estés en línea y con la sesión iniciada. Las claves se vuelven a emitir gratis, pero esa tiene que venir del servidor.",
  "settings.secRepairFailDesc_other": "{{count}} archivos necesitan que estés en línea y con la sesión iniciada. Las claves se vuelven a emitir gratis, pero esas tienen que venir del servidor.",
  ...
  "settings.secStatusReady": "Listo para desbloquear",
  "settings.secReasonReady": "Es tuyo: se desbloquea al abrir la Biblioteca o iniciar el juego.",
  "settings.secStatusNotOwned": "No está en tu biblioteca",
  "settings.secStatusUnavailable": "No disponible",
  "settings.secStatusNeedsSteam": "Inicia sesión con Steam",
  "settings.secStatusUnreadable": "Archivo no reconocido",
  "settings.secReasonNotOwned": "No está en tu biblioteca en esta cuenta.",
  "settings.secReasonNeedsSteam": "Inicia sesión con Steam para ver qué posees.",
  ...
  "settings.checkingUpdates":
    "Comprobando la última versión en mxbsecure.com…",
  "settings.updateCheckFailed":
    "No se pudieron comprobar las actualizaciones — sin conexión o mxbsecure.com no disponible.",
  ...
  "settings.cacheTitle": "Caché de texturas de pistas",
  "settings.cacheDesc": "Texturas de pistas generadas en tus sesiones. Puedes borrarlas con MX Bikes cerrado; el juego recreará solo las que vuelvas a usar.",
  "settings.cacheUsage": "{{size}} en {{count}} archivos de caché",
  "settings.cacheClear": "Borrar caché",
  "settings.cacheConfirmTitle": "¿Borrar la caché de texturas de pistas?",
  "settings.cacheConfirmDesc": "Esto elimina {{size}} de texturas de pistas generadas. Tus pistas y mods seguirán instalados; MX Bikes reconstruirá la caché al rodar.",
  "settings.cacheCleared": "Caché de texturas de pistas borrada",
  "settings.cacheClearedDesc": "Se liberaron {{size}} de {{count}} archivos de caché.",
  "settings.cacheClearFailed": "No se pudo borrar la caché de texturas de pistas",
  ...
  "settings.checkNewer": "Buscar una integración con el juego más reciente",
  "settings.working": "Trabajando…",
  "settings.installFrostmod": "Instalar la integración con el juego",
  ...
  "join.closeAndJoin": "Cerrar el juego y entrar",
  ...
  "settings.autoUpdates": "Instalar actualizaciones automáticamente",
  "settings.autoUpdatesDesc":
    "Las actualizaciones se instalan al abrir la app o cuando lleva un rato sin usarse. Nunca mientras MX Bikes está abierto.",
  ...
  "serverBrowser.bikeNoProfile": "No se encontró ningún perfil de MX Bikes, así que la aplicación no pudo elegir una moto para este servidor.",
  "serverBrowser.bikeNoMatch": "Ninguna de tus motos instaladas coincide con las categorías y modelos permitidos por este servidor.",
  "serverBrowser.waitInLine": "Hacer cola",
  "serverBrowser.trackMissing": "No tienes esta pista",
  "serverBrowser.notInstalled": "No instalada",
  "serverBrowser.cachedLocal": "Última lista, {{age}}",
  "serverBrowser.cachedShared": "Lista compartida, {{age}}",
  "serverBrowser.install": "Instalar",
  "serverBrowser.installHint": "Instala {{title}} sin unirse al servidor",
  "serverBrowser.installJoin": "Instalar y unirse",
  "serverBrowser.installJoinHint": "Instala {{title}} desde mxb-mods.com y luego se une",
  "serverBrowser.installing": "Instalando",
  "serverBrowser.installFailed": "No se pudo instalar {{title}}",
  "serverBrowser.unwedge": "Arreglar el navegador del juego",
  "serverBrowser.unwedgeBlurb": "Para cuando la pantalla Browse de MX Bikes dice \"connection timeout\" después de salir de un servidor. Lo arregla sin reiniciar el juego.",
  "serverBrowser.unwedgeSent": "Enviado. Abre Browse en el juego otra vez.",
  "serverBrowser.unwedgeNeedsFrostmod": "Tu FrostMod es demasiado antiguo para esto. Actualízalo e inténtalo de nuevo.",
  "serverBrowser.unwedgeNoFrostmod": "FrostMod no está en ejecución, así que no hay a dónde enviarlo.",
  "serverBrowser.unwedgeFailed": "No se pudo contactar con el juego.",
  "serverBrowser.buyTrack": "Comprar",
  "serverBrowser.buyHint": "Abre {{name}} en la tienda",
  "serverBrowser.inLine": "#{{position}} en la cola",
  "serverBrowser.unnamed": "Servidor sin nombre",
  "serverBrowser.full": "Servidor lleno",
  "serverBrowser.ping.title": "{{ms}} ms de ida y vuelta",
  "serverBrowser.viewTiles": "Mosaico",
  "serverBrowser.viewList": "Lista",
  "serverBrowser.waitingCount": "{{count}} en la cola",
  "serverBrowser.queueHint": "Lleno. MXB App entra por ti cuando se libere un hueco.",

  // ── ¿Es el servidor maestro o eres tú? ────────────────────────────
  "connection.checking": "Comprobando si solo te pasa a ti…",
  "connection.notYou": "Los servidores de MX Bikes no responden",
  "connection.likelyYou": "A todos los demás les funciona",
  ...
  "connection.verdict.unknown": "Aún no hay datos suficientes: han comprobado muy pocas apps hace poco. Prueba otra vez en un minuto.",
  "connection.check.internet": "Internet",
  "connection.check.dns": "Dirección del servidor maestro",
  "connection.check.udp": "UDP saliente",
  ...
  "queue.leave": "Salir de la cola",
  "queue.turn": "Hay un hueco libre en {{name}}. Entra ahora desde el juego.",
  "queue.launching": "Se liberó un hueco. Abriendo {{name}}.",
  "queue.joined": "Estás en {{name}}.",
  "queue.missed": "Tu turno en {{name}} pasó y saliste de la cola.",
  "queue.offline": "No se puede contactar con el servicio de MXB App. Reintentando.",
  "queue.joinFailed": "No se pudo entrar en la cola",
  "queue.onlyApp": "En esta cola solo esperan los pilotos que usan MXB App.",
  "serverBrowser.copyAddress": "Copiar la dirección",
  "serverBrowser.copied": "Dirección copiada",
  "serverBrowser.copyLink": "Copiar enlace del servidor",
  "serverBrowser.copyLinkHint": "Copiar un enlace que abre este servidor en {{app}}",
  "serverBrowser.linkCopied": "Enlace del servidor copiado",
  "serverBrowser.copyFailed": "No se pudo copiar el enlace.",
  "deepLink.otherGame": "Ese enlace es de {{game}} — cambia de juego para abrirlo.",
  ...
  "serverBrowser.trackIsStock": "Viene con el juego",
  "serverBrowser.trackIsYours": "Tienes esta pista",
  "serverBrowser.trackFrom": "En {{where}}",
  ...
  "serverBrowser.favesEmpty": "Ninguno de tus favoritos está en línea con este filtro.",
  "serverBrowser.hideEmpty": "Ocultar vacíos",
  "serverBrowser.filters": "Filtros",
  "serverBrowser.moreActions": "Más",
  ...
  "feel.control.throttle": "Acelerador",
  "feel.control.brake": "Freno delantero",
  "feel.control.rearBrake": "Freno trasero",
  "feel.control.clutch": "Embrague",
  "feel.control.shiftUp": "Subir marcha",
  "feel.control.shiftDown": "Bajar marcha",
  "feel.control.shiftUpPreload": "Subir marcha (precarga)",
  "feel.control.shiftDownPreload": "Bajar marcha (precarga)",
  "feel.control.lean": "Inclinar",
  "feel.control.leanForwardBack": "Piloto adelante/atrás",
  "feel.control.leanLeftRight": "Piloto izquierda/derecha",
  "feel.control.sit": "Sentarse",
  "feel.control.sitDirect": "Sentarse (directo)",
  "feel.control.changeView": "Cambiar vista",
  "feel.control.lookBack": "Mirar atrás",
  "feel.control.heading": "Dirección",
  "feel.control.tearOff": "Tear-off",
  ...
  "library.securedLocked": "mxbsecure — bloqueado, inicia sesión para desbloquear",
  "library.securedUnlocked": "mxbsecure — desbloqueado",
  "library.stock": "Incluida con el juego",
  "library.stockSection": "Pistas originales",
  "library.stockSectionHint":
    "Las pistas que trae MX Bikes. Están dentro del tracks.pkz del juego, así que aquí no hay ningún archivo que mover o eliminar: mira una en 3D o extráela como su propio .pkz.",
  ...
  "library.yours": "Tuyo",
  "owned.title": "Comprado",
  "owned.loading": "Leyendo lo que has comprado…",
  "owned.signedOut": "Inicia sesión en una tienda para ver todo lo que has comprado en un solo sitio.",
  "owned.openStores": "Abrir las tiendas",
  "owned.empty": "Aún no has comprado nada.",
  "owned.fromShop": "mxbikes-shop",
  "owned.fromHub": "MXB Hub",
  "owned.notInstalled": "No instalado",
  "wishlist.title": "Lista de deseos",
  "wishlist.add": "Añadir a la lista de deseos",
  "wishlist.remove": "Quitar de la lista de deseos",
  "wishlist.empty": "Tu lista de deseos está vacía.",
  "wishlist.emptyHint":
    "Abre cualquier mod y pulsa Añadir a la lista de deseos para guardarlo aquí.",
  "wishlist.wanted": "En tu lista de deseos",
  ...
  "share.partsUploaded": "{{done}} de {{total}} partes subidas",
  "share.secondsLeft": "Quedan unos {{n}} s",
  "share.minutesLeft": "Quedan unos {{n}} min",
  ...
  "overlay.coachLinked": "MXB Coach está conectado: sus pestañas aparecen en el overlay y este atajo abre ambos.",
  ...
  "showcase.v0170.hero.title":
    "Encontrar un servidor cuando el juego no puede",
  "showcase.v0170.hero.body":
    "La mitad del problema del multijugador de MX Bikes no son los servidores. Es que te diga \"connection timeout\" y nada más. Esta versión arregla el navegador del propio juego y te da una lista que funciona cuando él no.",
  "showcase.v0170.browser":
    "La pantalla Browse del juego deja de agotar el tiempo el resto de la tarde después de salir de un servidor. FrostMod lo arregla mientras juegas.",
  "showcase.v0170.book":
    "La pestaña Servers sigue funcionando cuando la lista de MX Bikes se cae: pregunta a cada servidor directamente desde una libreta de direcciones compartida.",
  "showcase.v0170.check":
    "Cuando la lista no carga, la app dice si son los servidores de MX Bikes o algo tuyo, y comprueba tu conexión por ti.",
  ...
  "supporters.kind.code": "Contribuciones de código",
  "supporters.kind.codeDesc":
    "Código que escribieron, funcionando en la versión que usas.",
  "supporters.kind.testing": "Pruebas",
  "supporters.kind.testingDesc":
    "Rompieron la app a propósito, en versiones que nadie más tenía.",
  "supporters.kind.ideas": "Ideas y comentarios",
  "supporters.kind.ideasDesc": "Sugirieron algo que acabó en la app.",
  ...
  "plugins.installedStudio": "{{name}} está instalado. Sus paneles se abren en Frost's Studio.",
  "plugins.inStudio": "Se abre en Frost's Studio: es una herramienta de creación, y ahí es donde viven ahora.",
  "plugins.openStudio": "Abrir en Studio",
  ...
  "ranked.manualOverride": "Se muestra un GUID que escribiste, no tu cuenta de Steam.",
  "ranked.useSteam": "Usar mi cuenta de Steam",
  ...
  "ranked.unracedTitle": "Aún no hay carreras clasificadas",
  "ranked.unracedBody": "MXB Ranked calcula tu rango a partir de las carreras en sus propios servidores. Únete a uno (son las salas llamadas MXB-Ranked.com) y tu rango, las estadísticas de la temporada y cada resultado aparecerán aquí.",
  "ranked.unracedFind": "Buscar un servidor clasificado",
  "ranked.unracedNotYou": "¿Ya estás corriendo? Entonces esta no es tu GUID: pon la correcta con el botón GUID de arriba.",
  "ranked.exp": "EXP",
  ...
  "setup.steamOptional": "Steam es opcional. Solo lo necesitas para compras protegidas y Ranked.",
  "setup.steamSkip": "Omitir por ahora",
  "setup.integrationTitle": "¿Activar la integración con el juego?",
  "setup.integrationIntro": "{{app}} funciona sin la integración con el juego. Actívala solo si quieres mods protegidos, recargas instantáneas y sincronización de pinturas dentro del juego.",
  "setup.integrationCrashFixes": "También incluye correcciones específicas para fallos conocidos de {{game}}.",
  "setup.integrationInstallDisclosure": "Esto instala frostmod.exe y frostmod.dll desde la versión oficial de FrostMod en GitHub en la carpeta de datos propia de la app. La descarga se prepara y se comprueba con los metadatos de la versión antes de realizar ningún cambio.",
  "setup.integrationUseAppOnly": "Usar solo la app",
  "setup.integrationEnable": "Activar la integración con el juego",
  "setup.integrationChooseInstall": "Elegir carpeta del juego y activar",
  "setup.integrationInstallRequired": "Se necesita la carpeta de instalación de {{game}}",
  "setup.integrationInstallRequiredDesc": "La integración necesita la carpeta que contiene el ejecutable del juego. No se encontró automáticamente; selecciónala para continuar.",
  "setup.integrationLearnMore": "Ver detalles técnicos",
  "integration.title": "Integración con el juego",
  "integration.poweredBy": "Con tecnología de FrostMod",
  "settings.integrationIntro": "Funciones opcionales dentro del juego para mods protegidos, recargas instantáneas y sincronización de pinturas. Los mods estándar no las necesitan.",
  "integration.details": "Detalles técnicos",
  "integration.detailsTitle": "Qué instala la integración con el juego",
  "integration.optional": "Opcional",
  "integration.optionalDesc": "Los mods estándar funcionan sin la integración. Los mods protegidos por su creador la necesitan.",
  "integration.protectedContentTitle": "Cómo funciona el contenido protegido",
  "integration.protectedContentDesc": "Tras verificar la propiedad con Steam, se guarda una clave sin conexión en este PC. Los archivos protegidos solo se abren en memoria mientras el juego los usa; no se escribe ninguna copia desempaquetada en el disco.",
  "integration.privacyTitle": "Tus datos",
  "integration.privacyDesc": "Tus archivos de mods no se suben. {{app}} nunca recibe tu contraseña de Steam; Steam gestiona el inicio de sesión y solo devuelve la identidad de la cuenta necesaria para verificar la propiedad.",
  "integration.filesTitle": "Archivos instalados",
  "integration.publisher": "Editor",
  "integration.publisherValue": "MXB App · Con tecnología de FrostMod",
  "integration.source": "Fuente de descarga",
  "integration.sourceValue": "Versiones oficiales de FrostMod en GitHub",
  "integration.components": "Componentes",
  "integration.componentsValue": "frostmod.exe y frostmod.dll",
  "integration.installLocation": "Ubicación de instalación",
  "integration.installLocationValue": "Carpeta privada de datos de la app / frostmod",
  "integration.network": "Servicios de red",
  "integration.networkValue": "GitHub para actualizaciones de la integración; servicios de MXB App para verificar la propiedad y las funciones en línea activadas.",
  "integration.integrity": "Comprobaciones de integridad",
  "integration.integrityValue": "El tamaño del archivo se comprueba siempre. SHA-256 también se comprueba cuando la versión lo proporciona.",
  "integration.control": "Tu control",
  "integration.controlValue": "La integración con el juego es opcional y se puede detener en cualquier momento.",
  "integration.standardMods": "Los mods estándar siguen funcionando sin la integración con el juego.",
  "integration.protectedMods": "Los mods protegidos por su creador necesitan la integración mientras juegas.",
  "activity.automaticTitle": "Actividad automática",
  "activity.automaticDesc": "Acciones que la app realizó o intentó realizar. Se guardan solo en este dispositivo.",
  "activity.clear": "Borrar",
  "activity.clearAria": "Borrar la actividad automática",
  "activity.empty": "Aún no hay acciones automáticas registradas.",
  "activity.noMatches": "Ninguna actividad automática coincide con tu búsqueda.",
  "activity.completed": "Completada",
  "activity.failed": "Fallida",
  "activity.notice": "Aviso",
  "activity.integrationAppOnly": "Modo solo app seleccionado",
  "activity.integrationAppOnlyDesc": "La integración con el juego no se iniciará ni actualizará automáticamente.",
  "activity.integrationEnabled": "Integración con el juego activada",
  "activity.integrationEnabledDesc": "Las funciones opcionales dentro del juego están permitidas en este dispositivo.",
  "activity.integrationInstalled": "Integración con el juego {{version}} instalada",
  "activity.integrationInstallFailed": "Falló la instalación de la integración con el juego",
  "mxbmrp3.title": "Prueba MXBMRP3 para un HUD mejor en el juego",
  "mxbmrp3.what": "MXBMRP3 es un plugin de HUD gratuito y de código abierto de thomas4f. Añade a {{game}} clasificación, tiempos por vuelta, la diferencia con tu mejor vuelta, un mapa del circuito y un radar.",
  "mxbmrp3.how": "Descárgalo desde su página oficial de GitHub e instálalo con su propio instalador. {{app}} solo comprueba si está. Nunca lo descarga ni cambia tu carpeta del juego.",
  "mxbmrp3.get": "Conseguir MXBMRP3",
  "mxbmrp3.notNow": "Ahora no",
  "mxbmrp3.never": "No volver a preguntar",
  "mxbmrp3.installed": "MXBMRP3 está instalado",
  "mxbmrp3.missing": "MXBMRP3 no está instalado",
  "mxbmrp3.unknown": "Elige la carpeta del juego para buscar MXBMRP3",
  "mxbmrp3.settingsDesc": "MXBMRP3 es un plugin de HUD gratuito de thomas4f (clasificación, tiempos, mapa del circuito, radar). {{app}} solo lo busca en la carpeta plugins de tu juego.",
  "mxbmrp3.askAgain": "Volver a sugerirlo",
};
