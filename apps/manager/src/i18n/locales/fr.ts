...
export const fr: Translation = {
  ...
  "settings.secRepairRevoked_one": "Le créateur a retiré l'accès à {{count}} fichier — sa clé n'est plus sur ce PC.",
  "settings.secRepairRevoked_other": "Les créateurs ont retiré l'accès à {{count}} fichiers — leurs clés ne sont plus sur ce PC.",
  ...
  "settings.secReasonRevoked": "Le créateur vous a retiré l'accès. Sa clé a été supprimée de ce PC.",
  ...
  "secure.revokedBody": "{{names}} — le créateur vous a retiré l'accès, la clé a donc été supprimée de ce PC.",
