...
export const fr: Translation = {
  ...
  // ── FrostMod ───────────────────────────────────────────────────────────────
  "frostmod.checking": "Vérification de l'intégration au jeu…",
  "frostmod.running": "Intégration au jeu prête",
  "frostmod.notRunning": "Intégration au jeu désactivée",
  "frostmod.notInGame": "L'intégration attend le jeu",
  "frostmod.reloadGame": "Recharger le jeu",
  "frostmod.start": "Démarrer l'intégration au jeu",
  "frostmod.reloadedGame": "L'intégration a rechargé le jeu.",
  "frostmod.notRunningToast": "L'intégration au jeu est désactivée.",
  "frostmod.started": "Intégration au jeu démarrée",
  "frostmod.alreadyRunning": "L'intégration au jeu est déjà active",
  "frostmod.startFailed": "Impossible de démarrer l'intégration au jeu",
  "frostmod.stop": "Arrêter l'intégration au jeu",
  "frostmod.stopped": "Intégration au jeu arrêtée",
  "frostmod.stopFailed": "Impossible d'arrêter l'intégration au jeu",
  ...
  "frostmod.installedToast": "Intégration au jeu {{version}} installée",
  "frostmod.installedToastDesc":
    "Il rechargera le jeu à chaud dès que vous ajouterez des mods.",
  "frostmod.installedToastRestart": "Redémarrez MX Bikes pour basculer — le jeu en cours utilise encore l'intégration précédente.",
  "frostmod.installFailed": "Impossible d'installer l'intégration au jeu",
  ...
  "frostmod.askedReload": "Demande de rechargement envoyée à l'intégration.",
  "frostmod.andMore_one": "{{names}} et {{count}} autre",
  "frostmod.andMore_other": "{{names}} et {{count}} autres",
  "frostmod.watchDesc": "{{names}} — demande de rechargement envoyée à l'intégration.",
  ...
  "setup.finishing": "Configuration de {{game}}…",
  "setup.steamTitle": "Se connecter avec Steam",
  "setup.steamLead":
    "MX Bikes vous identifie par votre compte Steam, et tout ce que vous avez acheté aussi.",
  "setup.steamReasonSealed":
    "Les tracks et l'équipement protégés se déverrouillent sur le compte qui les possède.",
  "setup.steamReasonStore": "Tout ce qui est acheté sur une boutique arrive prêt à installer.",
  "setup.steamReasonRanked": "Votre profil Ranked est retrouvé depuis ce même compte.",
  "setup.steamNote":
    "Cela ouvre Steam dans votre navigateur. L'app ne voit jamais votre mot de passe.",
  "setup.steamWaiting": "En attente de Steam…",
  "setup.steamSignedIn": "Connecté en tant que {{id}}",
  "setup.steamContinue": "Continuer",
  ...
  "tour.frostmod.title": "Intégration au jeu",
  "tour.frostmod.body":
  ...
  "getStarted.title": "Pour commencer",
  "getStarted.body": "Votre dossier mods est vide.",
  ...
  "runtime.bannerFrostmod": "L'intégration au jeu a besoin de {{what}} pour fonctionner.",
  "runtime.pitch":
  ...
  "shopDetail.notOwned": "Non acheté",
  ...
  "modDetail.openOnSite": "Ouvrir sur {{site}}",
  "modsVerify.shown": "Termine la vérification dans la fenêtre « Vérification de l'accès à {{site}} » pour charger les pages de mods.",
  "modsVerify.cleared": "{{site}} vérifié.",
  "modsVerify.dismissed": "Vérification fermée — les pages de mods de {{site}} ne se chargeront pas dans l'app. Clique sur Réessayer pour la revoir.",
  ...
  "modDetail.inLibrary": "Dans la bibliothèque",
  "modDetail.notInstalled": "Non installé",
  "modDetail.addToLibrary": "Ajouter à la bibliothèque",
  "modDetail.fromHost": "Depuis {{host}}",
  "modDetail.categoryLabel": "Catégorie",
  ...
  "settings.frostmod": "Intégration au jeu",
  ...
  "accounts.section": "Comptes",
  "accounts.desc": "Toutes les connexions gardées par l'app, et à quoi sert chacune.",
  "accounts.steam": "Steam",
  "accounts.steamNot": "Non lié.",
  "accounts.steamWhat": "Libère les clés des mods protégés que vous possédez. Pour en changer, reconnectez-vous.",
  "accounts.shop": "mxbikes-shop.com",
  "accounts.hub": "MXB Hub",
  "accounts.mods": "mxb-mods.com",
  "accounts.modsNone": "Aucun compte.",
  "accounts.modsNote": "Ici, la navigation et les téléchargements sont anonymes : il n'y a rien à quoi se connecter.",
  "accounts.shopNote": "Les achats sont lus depuis une fenêtre de navigateur laissée ouverte, car le défi Cloudflare de la boutique refuse un client ordinaire. Comptez quelques secondes.",
  "accounts.hubNote": "Les achats arrivent par le client habituel, donc la réponse est rapide.",
  "accounts.signedIn": "Connecté",
  "accounts.signedOut": "Non connecté",
  "accounts.checking": "Vérification…",
  "accounts.countUnknown": "Connecté. Achats pas encore lus.",
  "accounts.purchases_one": "{{count}} achat",
  "accounts.purchases_other": "{{count}} achats",
  "accounts.signIn": "Se connecter",
  "accounts.signOut": "Se déconnecter",
  "accounts.refreshFailed": "Impossible de lire vos achats",
  "accounts.signOutFailed": "Impossible de se déconnecter",
  "accounts.autoInstall": "Installer les achats automatiquement",
  "accounts.autoInstallDesc": "Une fois que l'app vous a ouvert la page d'une boutique, elle la surveille environ deux minutes et installe tout ce qui apparaît de nouveau.",
  "accounts.readTitle": "Comment un achat est trouvé",
  "accounts.readBody": "Aucune des deux boutiques ne prévient l'app quand vous achetez quelque chose : l'app doit donc aller voir. Pendant la surveillance elle regarde toutes les quelques secondes, et s'arrête au bout d'environ deux minutes. mxbikes-shop.com est lu depuis une fenêtre de navigateur laissée ouverte et peut être lent ; MXB Hub répond vite. Si un achat arrive après l'arrêt de la surveillance, ouvrez Achats et appuyez sur Actualiser.",
  "accounts.installing": "Installation de {{name}}",
  "accounts.pickFile": "{{name}} est sur votre compte. Il est livré en plusieurs fichiers : choisissez celui que vous voulez dans Achats.",
  "accounts.manyNew": "Nouveaux achats trouvés. Ouvrez Achats pour les installer.",
  ...
  "settings.secRepair": "Clés manquantes",
  "settings.secRepairDesc": "Récupère un fichier de clé supprimé par erreur. L'appli garde sa propre copie de tes clés, donc aucune connexion n'est généralement nécessaire.",
  "settings.secRepairBtn": "Restaurer les clés",
  "settings.secRepairBusy": "Restauration…",
  "settings.secRepairOk_one": "{{count}} clé restaurée. Ton contenu sécurisé refonctionne.",
  "settings.secRepairOk_other": "{{count}} clés restaurées. Ton contenu sécurisé refonctionne.",
  "settings.secRepairNone_one": "{{count}} fichier vérifié — sa clé est en place.",
  "settings.secRepairNone_other": "{{count}} fichiers vérifiés — toutes les clés sont en place.",
  ...
  "settings.secReasonNotOwned": "Absent de votre bibliothèque sur ce compte.",
  "settings.secReasonNeedsSteam": "Connectez-vous avec Steam pour voir ce que vous possédez.",
  ...
  "settings.cacheTitle": "Cache des textures de circuits",
  "settings.cacheDesc": "Textures de circuits générées pendant vos roulages. Vous pouvez les supprimer lorsque MX Bikes est fermé : le jeu ne recréera que celles des circuits que vous roulez ensuite.",
  "settings.cacheUsage": "{{size}} dans {{count}} fichiers en cache",
  "settings.cacheClear": "Vider le cache",
  "settings.cacheConfirmTitle": "Vider le cache des textures de circuits ?",
  "settings.cacheConfirmDesc": "Cela supprime {{size}} de textures de circuits générées. Vos circuits et vos mods restent installés ; MX Bikes recréera le cache quand vous roulerez.",
  "settings.cacheCleared": "Cache des textures de circuits vidé",
  "settings.cacheClearedDesc": "{{size}} libérés depuis {{count}} fichiers en cache.",
  "settings.cacheClearFailed": "Impossible de vider le cache des textures de circuits",
  ...
  "settings.checkNewer": "Chercher une intégration au jeu plus récente",
  "settings.working": "Traitement…",
  "settings.installFrostmod": "Installer l'intégration au jeu",
  ...
  "join.alreadyRunning":
    "{{game}} est déjà ouvert — fermez-le, puis rejoignez depuis ici.",
  "join.gameOpen":
  ...
  "serverBrowser.bikeNoProfile": "Aucun profil MX Bikes n'a été trouvé. L'application n'a donc pas pu choisir de moto pour ce serveur.",
  "serverBrowser.bikeNoMatch": "Aucune de vos motos installées ne correspond aux catégories et modèles autorisés par ce serveur.",
  "serverBrowser.waitInLine": "Faire la queue",
  "serverBrowser.trackMissing": "Tu n'as pas cette piste",
  "serverBrowser.notInstalled": "Non installée",
  "serverBrowser.cachedLocal": "Dernière liste, {{age}}",
  "serverBrowser.cachedShared": "Liste partagée, {{age}}",
  "serverBrowser.install": "Installer",
  "serverBrowser.installHint": "Installe {{title}} sans rejoindre le serveur",
  ...
  "serverBrowser.unwedge": "Réparer le navigateur du jeu",
  "serverBrowser.unwedgeBlurb": "Pour quand l'écran Browse de MX Bikes affiche \"connection timeout\" après avoir quitté un serveur. Corrige le problème sans redémarrer le jeu.",
  "serverBrowser.unwedgeSent": "Envoyé. Rouvre Browse dans le jeu.",
  "serverBrowser.unwedgeNeedsFrostmod": "Ton FrostMod est trop ancien pour ça. Mets-le à jour et réessaie.",
  "serverBrowser.unwedgeNoFrostmod": "FrostMod n'est pas lancé, il n'y a donc rien à qui envoyer ça.",
  "serverBrowser.unwedgeFailed": "Le jeu n'a pas répondu.",
  ...
  "serverBrowser.viewTiles": "Vignettes",
  "serverBrowser.viewList": "Liste",
  "serverBrowser.waitingCount": "{{count}} en attente",
  "serverBrowser.queueHint": "Complet. MXB App te connecte dès qu'une place se libère.",

  // ── Est-ce le serveur maître, ou est-ce toi ? ─────────────────────
  "connection.checking": "Vérification : est-ce que ça n'arrive qu'à toi ?",
  "connection.notYou": "Les serveurs de MX Bikes ne répondent pas",
  "connection.likelyYou": "Ça passe pour tout le monde",
  "connection.failed": "La liste des serveurs ne s'est pas chargée",
  "connection.failingFor": "En panne depuis au moins {{minutes}} min",
  "connection.runCheck": "Vérifier ma connexion",
  "connection.statusPage": "MX Bikes est hors service ?",
  "connection.verdict.upstream": "C'est le serveur maître de MX Bikes, pas ta connexion. Il n'y a rien à réparer chez toi : ça revient généralement en quelques minutes.",
  "connection.verdict.local": "Ça passe pour tout le monde en ce moment, donc ça vient de cette machine ou de ce réseau.",
  "connection.verdict.fine": "Tout fonctionne. Quoi que c'était, c'est passé.",
  "connection.verdict.unknown": "Pas encore de quoi trancher : trop peu d'apps ont vérifié récemment. Réessaie dans une minute.",
  "connection.check.internet": "Internet",
  "connection.check.dns": "Adresse du serveur maître",
  "connection.check.udp": "UDP sortant",
  "connection.check.master": "Liste des serveurs",
  "connection.check.others": "Tout le monde",
  "connection.checkFootnote": "L'UDP sortant montre seulement que le datagramme a pu sortir, pas que quelque chose y a répondu.",

  "registerServer.action": "Ajoute ton serveur",
  "registerServer.title": "Ajoute ton serveur à la liste partagée",
  "registerServer.blurb": "Pour que l'app se souvienne de ton serveur même quand les serveurs de MX Bikes ne répondent pas.",
  "registerServer.note": "Utile seulement pour un serveur qui n'apparaît pas dans la liste : un nouveau, ou un privé. Tout ce que le jeu liste est déjà mémorisé tout seul.",
  "registerServer.submit": "Ajouter",
  "registerServer.done": "{{address}} est dans la liste partagée",
  "registerServer.failed": "Impossible d'ajouter ce serveur",

  "queue.banner": "#{{position}} dans la file pour {{name}}",
  "queue.turnBanner": "À toi : rejoins {{name}}",
  "queue.launchingBanner": "Connexion à {{name}}",
  "queue.leave": "Quitter la file",
  "queue.turn": "Une place est libre sur {{name}}. Rejoins-le depuis le jeu maintenant.",
  "queue.launching": "Une place s'est libérée. Lancement sur {{name}}.",
  "queue.joined": "Tu es sur {{name}}.",
  "queue.missed": "Ton tour sur {{name}} est passé, tu as quitté la file.",
  "queue.offline": "Impossible de joindre le service MXB App. Nouvel essai en cours.",
  "queue.joinFailed": "Impossible de rejoindre la file",
  "queue.onlyApp": "Seuls les pilotes qui utilisent MXB App attendent dans cette file.",
  "serverBrowser.copyAddress": "Copier l'adresse",
  "serverBrowser.copied": "Adresse copiée",
  "serverBrowser.copyLink": "Copier le lien du serveur",
  "serverBrowser.copyLinkHint": "Copier un lien qui ouvre ce serveur dans {{app}}",
  "serverBrowser.linkCopied": "Lien du serveur copié",
  "serverBrowser.copyFailed": "Impossible de copier le lien.",
  "deepLink.otherGame": "Ce lien concerne {{game}} — changez de jeu pour l'ouvrir.",
  ...
  "serverBrowser.trackIsStock": "Fourni avec le jeu",
  "serverBrowser.trackIsYours": "Vous avez ce circuit",
  "serverBrowser.trackFrom": "Sur {{where}}",
  ...
  "serverBrowser.pickServer": "Choisissez un serveur pour voir ce qui y tourne.",
  ...
  "serverBrowser.filters": "Filtres",
  "serverBrowser.moreActions": "Plus",
  ...
  "feel.control.throttle": "Accélérateur",
  "feel.control.brake": "Frein avant",
  "feel.control.rearBrake": "Frein arrière",
  "feel.control.clutch": "Embrayage",
  "feel.control.shiftUp": "Monter un rapport",
  "feel.control.shiftDown": "Descendre un rapport",
  "feel.control.shiftUpPreload": "Monter un rapport (précharge)",
  "feel.control.shiftDownPreload": "Descendre un rapport (précharge)",
  "feel.control.lean": "Inclinaison",
  "feel.control.leanForwardBack": "Pilote avant/arrière",
  "feel.control.leanLeftRight": "Pilote gauche/droite",
  "feel.control.sit": "S'asseoir",
  "feel.control.sitDirect": "S'asseoir (direct)",
  "feel.control.changeView": "Changer de vue",
  "feel.control.lookBack": "Regarder derrière",
  "feel.control.heading": "Direction",
  ...
  "library.stock": "Fournie avec le jeu",
  "library.stockSection": "Pistes d'origine",
  "library.stockSectionHint":
    "Les pistes livrées avec MX Bikes. Elles se trouvent dans le tracks.pkz du jeu : il n'y a donc ici aucun fichier à déplacer ou à supprimer — voyez-en une en 3D, ou extrayez-la dans son propre .pkz.",
  ...
  "library.yours": "À vous",
  "owned.title": "Acheté",
  "owned.loading": "Lecture de vos achats…",
  "owned.signedOut": "Connectez-vous à une boutique pour voir tous vos achats au même endroit.",
  "owned.openStores": "Ouvrir les boutiques",
  "owned.empty": "Rien acheté pour l’instant.",
  "owned.fromShop": "mxbikes-shop",
  "owned.fromHub": "MXB Hub",
  "owned.notInstalled": "Non installé",
  "wishlist.title": "Liste de souhaits",
  "wishlist.add": "Ajouter à la liste de souhaits",
  "wishlist.remove": "Retirer de la liste de souhaits",
  "wishlist.empty": "Votre liste de souhaits est vide.",
  "wishlist.emptyHint":
    "Ouvrez un mod et appuyez sur Ajouter à la liste de souhaits pour le garder ici.",
  "wishlist.wanted": "Dans votre liste de souhaits",
  ...
  "downloads.moveToFront": "Placer en tête de file",
  "downloads.sectionActive": "En cours",
  "downloads.sectionQueued": "En attente",
  ...
  "overlay.coachLinked": "MXB Coach est connecté : ses onglets apparaissent dans l'overlay, et ce raccourci ouvre les deux.",
  ...
  "showcase.v0170.hero.title":
    "Trouver un serveur quand le jeu n'y arrive pas",
  "showcase.v0170.hero.body":
    "La moitié des ennuis du multijoueur de MX Bikes ne vient pas des serveurs. Elle vient du \"connection timeout\" sans la moindre explication. Cette version répare le navigateur du jeu et te donne une liste qui marche quand lui ne marche pas.",
  "showcase.v0170.browser":
    "L'écran Browse du jeu ne passe plus la soirée en délai d'attente après que tu as quitté un serveur. FrostMod le débloque pendant que tu joues.",
  "showcase.v0170.book":
    "L'onglet Servers continue de fonctionner quand la liste de MX Bikes tombe : il interroge chaque serveur directement, depuis un carnet d'adresses partagé.",
  "showcase.v0170.check":
    "Quand la liste ne charge pas, l'app dit si ce sont les serveurs de MX Bikes ou quelque chose chez toi, et teste ta connexion.",
  ...
  "supporters.kind.code": "Contributions de code",
  "supporters.kind.codeDesc":
    "Du code qu'ils ont écrit, qui tourne dans la version que tu utilises.",
  "supporters.kind.testing": "Tests",
  "supporters.kind.testingDesc":
    "Ont cassé l'app exprès, sur des versions que personne d'autre n'avait.",
  "supporters.kind.ideas": "Idées & retours",
  "supporters.kind.ideasDesc": "Ont proposé quelque chose qui est bel et bien sorti.",
  ...
  "plugins.installedStudio": "{{name}} est installé. Ses panneaux s'ouvrent dans Frost's Studio.",
  "plugins.inStudio": "S'ouvre dans Frost's Studio — c'est un outil de création, et c'est là qu'ils vivent désormais.",
  "plugins.openStudio": "Ouvrir dans Studio",
  ...
  "ranked.unracedTitle": "Aucune course classée",
  "ranked.unracedBody": "MXB Ranked établit votre rang à partir des courses sur ses propres serveurs. Rejoignez-en un — ce sont les salons nommés MXB-Ranked.com — et votre rang, vos statistiques de saison et chaque résultat apparaîtront ici.",
  "ranked.unracedFind": "Trouver un serveur classé",
  "ranked.unracedNotYou": "Vous courez déjà ? Alors ce n'est pas votre GUID : indiquez le bon avec le bouton GUID ci-dessus.",
  "ranked.exp": "EXP",
  ...
  "setup.steamOptional": "Steam est facultatif. Il ne sert que pour les achats protégés et le mode Ranked.",
  "setup.steamSkip": "Ignorer pour l'instant",
  "setup.integrationTitle": "Activer l'intégration au jeu ?",
  "setup.integrationIntro": "{{app}} fonctionne sans l'intégration au jeu. Activez-la uniquement pour les mods protégés, le rechargement instantané et la synchronisation des peintures en jeu.",
  "setup.integrationCrashFixes": "Également inclus : des correctifs ciblés pour des plantages connus de {{game}}.",
  "setup.integrationInstallDisclosure": "Cela installe frostmod.exe et frostmod.dll depuis la version officielle de FrostMod sur GitHub dans le dossier de données propre à l'application. Le téléchargement est préparé puis vérifié avec les métadonnées de la version avant toute modification.",
  "setup.integrationUseAppOnly": "Utiliser uniquement l'application",
  "setup.integrationEnable": "Activer l'intégration au jeu",
  "setup.integrationChooseInstall": "Choisir le dossier du jeu et activer",
  "setup.integrationInstallRequired": "Dossier d'installation de {{game}} requis",
  "setup.integrationInstallRequiredDesc": "L'intégration a besoin du dossier contenant l'exécutable du jeu. Il n'a pas été détecté automatiquement ; sélectionnez-le pour continuer.",
  "setup.integrationLearnMore": "Voir les détails techniques",
  "integration.title": "Intégration au jeu",
  "integration.poweredBy": "Propulsé par FrostMod",
  "settings.integrationIntro": "Fonctions facultatives en jeu pour les mods protégés, le rechargement instantané et la synchronisation des peintures. Les mods standard n'en ont pas besoin.",
  "integration.details": "Détails techniques",
  "integration.detailsTitle": "Ce que l'intégration au jeu installe",
  "integration.optional": "Facultatif",
  "integration.optionalDesc": "Les mods standard fonctionnent sans l'intégration. Les mods protégés par leur créateur en ont besoin.",
  "integration.protectedContentTitle": "Fonctionnement du contenu protégé",
  "integration.protectedContentDesc": "Après vérification de la propriété par Steam, une clé hors ligne est stockée sur ce PC. Les fichiers protégés ne sont ouverts en mémoire que pendant leur utilisation par le jeu ; aucune copie décompressée n'est écrite sur le disque.",
  "integration.privacyTitle": "Vos données",
  "integration.privacyDesc": "Vos fichiers de mods ne sont pas envoyés. {{app}} ne reçoit jamais votre mot de passe Steam ; Steam gère la connexion et ne renvoie que l'identité du compte nécessaire à la vérification de propriété.",
  "integration.filesTitle": "Fichiers installés",
  "integration.publisher": "Éditeur",
  "integration.publisherValue": "MXB App · Propulsé par FrostMod",
  "integration.source": "Source du téléchargement",
  "integration.sourceValue": "Versions officielles de FrostMod sur GitHub",
  "integration.components": "Composants",
  "integration.componentsValue": "frostmod.exe et frostmod.dll",
  "integration.installLocation": "Emplacement d'installation",
  "integration.installLocationValue": "Dossier de données privé de l'application / frostmod",
  "integration.network": "Services réseau",
  "integration.networkValue": "GitHub pour les mises à jour de l'intégration ; services MXB App pour la vérification de propriété et les fonctions en ligne activées.",
  "integration.integrity": "Contrôles d'intégrité",
  "integration.integrityValue": "La taille du fichier est toujours contrôlée. Le SHA-256 l'est également lorsque la version le fournit.",
  "integration.control": "Votre contrôle",
  "integration.controlValue": "L'intégration au jeu est facultative et peut être arrêtée à tout moment.",
  "integration.standardMods": "Les mods standard continuent de fonctionner sans l'intégration au jeu.",
  "integration.protectedMods": "Les mods protégés par leur créateur nécessitent l'intégration pendant que vous jouez.",
  "activity.automaticTitle": "Activité automatique",
  "activity.automaticDesc": "Actions effectuées ou tentées par l'application. Enregistrées uniquement sur cet appareil.",
  "activity.clear": "Effacer",
  "activity.clearAria": "Effacer l'activité automatique",
  "activity.empty": "Aucune action automatique enregistrée pour l'instant.",
  "activity.noMatches": "Aucune activité automatique ne correspond à votre recherche.",
  "activity.completed": "Terminée",
  "activity.failed": "Échec",
  "activity.notice": "Information",
  "activity.integrationAppOnly": "Mode application seule sélectionné",
  "activity.integrationAppOnlyDesc": "L'intégration au jeu ne démarrera pas et ne se mettra pas à jour automatiquement.",
  "activity.integrationEnabled": "Intégration au jeu activée",
  "activity.integrationEnabledDesc": "Les fonctions facultatives en jeu sont autorisées sur cet appareil.",
  "activity.integrationInstalled": "Intégration au jeu {{version}} installée",
  "activity.integrationInstallFailed": "Échec de l'installation de l'intégration au jeu",
  "mxbmrp3.title": "Essayez MXBMRP3 pour un meilleur HUD en jeu",
  "mxbmrp3.what": "MXBMRP3 est un plugin HUD gratuit et open source de thomas4f. Il ajoute à {{game}} le classement, les temps au tour, l'écart avec votre meilleur tour, une carte du circuit et un radar.",
  "mxbmrp3.how": "Téléchargez-le depuis sa page GitHub officielle et installez-le avec son propre installateur. {{app}} vérifie seulement s'il est présent. Il ne le télécharge jamais et ne modifie pas votre dossier de jeu.",
  "mxbmrp3.get": "Obtenir MXBMRP3",
  "mxbmrp3.notNow": "Pas maintenant",
  "mxbmrp3.never": "Ne plus demander",
  "mxbmrp3.installed": "MXBMRP3 est installé",
  "mxbmrp3.missing": "MXBMRP3 n'est pas installé",
  "mxbmrp3.unknown": "Choisissez le dossier du jeu pour rechercher MXBMRP3",
  "mxbmrp3.settingsDesc": "MXBMRP3 est un plugin HUD gratuit de thomas4f (classement, chronos, carte du circuit, radar). {{app}} se contente de le chercher dans le dossier plugins de votre jeu.",
  "mxbmrp3.askAgain": "Le suggérer à nouveau",
};
