...
export const fr: Translation = {
  ...
  "setup.title": "Bienvenue dans {{app}}",
  ...
  // ── Bienvenue ──────────────────────────────────────────────────────────────
  "welcome.intro.title": "Bienvenue dans {{app}}",
  "welcome.intro.body":
  ...
  "tour.locker.body":
    "Changez les modèles de moto à volonté. {{app}} enregistre les pièces pour que le jeu les reconnaisse.",
  ...
  "installDialog.opensInBrowser":
    "S'ouvre dans le navigateur — {{app}} termine l'installation",
  ...
  "settings.gameDesc":
    "Le jeu que {{app}} pilote. Vos dossiers, votre bibliothèque et vos presets appartiennent tous au jeu choisi ici.",
  ...
  "settings.launchAtStartupDesc":
    "Démarrer {{app}} automatiquement à votre connexion.",
  ...
  "secure.provisioned": "Lié à {{id}}.",
  "secure.provisionedOk": "Lié — clé stockée localement",
  "secure.provisionFailed": "Impossible de lier la clé",
  "secure.openOffline": "Ouvrir hors ligne",
  "secure.offlineOk": "Ouvert hors ligne et identique.",
  "secure.offlineBad": "Ouvert hors ligne, mais ne correspond pas.",
  "secure.offlineFailed": "Échec de l'ouverture hors ligne",
  "secure.offlineMatches": "Ouvert hors ligne — identique, sans serveur",
  "secure.offlineMismatch": "Ne correspond pas",
  ...
  "sync.installedState_one": "{{count}} peinture d'un autre pilote est dans votre dossier mods",
  "sync.installedState_other": "{{count}} peintures d'autres pilotes sont dans votre dossier mods",
  "sync.installedWhy": "Elles sont écrites dans votre dossier mods pour que le jeu puisse les afficher. Les retirer remet le dossier en état — celles que vous avez modifiées restent.",
  "sync.remove": "Les retirer",
  "sync.removed_one": "{{count}} peinture synchronisée retirée",
  "sync.removed_other": "{{count}} peintures synchronisées retirées",
  "sync.removeKeptYours_one": "{{count}} a été conservée — vous l'avez modifiée depuis son installation.",
  "sync.removeKeptYours_other": "{{count}} ont été conservées — vous les avez modifiées depuis leur installation.",
  "sync.removeFailed": "Impossible de retirer les peintures synchronisées",
  ...
  "serverBrowser.location": "Emplacement",
  "serverBrowser.running": "En cours",
  "serverBrowser.layout": "Tracé",
  "serverBrowser.session": "Session",
  "serverBrowser.raceLength": "Durée",
  "serverBrowser.conditions": "Conditions",
  "serverBrowser.changingWeather": "Météo évolutive",
  "serverBrowser.rules": "Règles",
  "serverBrowser.categories": "Catégories",
  "serverBrowser.bikes": "Motos",
  "serverBrowser.rating": "Classe de licence",
  "serverBrowser.forceCockpit": "Vue pilote imposée",
  "serverBrowser.noAids": "Aucune aide",
  "serverBrowser.limitedTyres": "Trains de pneus limités",
  "serverBrowser.connection": "Connexion",
  "serverBrowser.lanAddress": "Adresse annoncée par le serveur",
  ...
  "serverBrowser.ridersUnknown":
    "MX Bikes indique seulement à l'app combien de pilotes sont sur un serveur. Les noms viennent des joueurs qui utilisent {{app}}.",
  ...
  "serverBrowser.trackStock": "Fourni avec le jeu — {{name}}",
  ...
  "serverBrowser.favesEmpty": "Aucun de vos favoris n'est en ligne avec ce filtre.",
  ...
  "feel.summary": "{{settings}} réglages · {{controls}} commandes ajustées",
  "feel.apply": "Appliquer",
  "feel.applied": "{{name}} appliqué.",
  "feel.restartHint": "Lance le jeu pour l'essayer.",
  "feel.missingControls": "Non assignées dans ce profil : {{names}}",
  "feel.applyFailed": "Impossible d'appliquer ce feeling",
  "feel.saved": "{{name}} enregistré.",
  "feel.saveFailed": "Impossible d'enregistrer ce feeling",
  "feel.nameFirst": "Donne-lui d'abord un nom.",
  "feel.pickProfile": "Choisis d'abord un profil.",
  "feel.nothingToSave": "Ce profil n'a pas encore de réglages à enregistrer.",
  "feel.deleted": "{{name}} supprimé.",
  "feel.share": "Partager",
  "feel.shareTitle": "Partager {{name}}",
  "feel.shareBody":
    "Envoie ce code à qui tu veux — il ne contient que les réglages, jamais tes commandes, ta manette ou ton mode d'écran.",
  "feel.shareFailed": "Impossible de créer le code",
  "feel.import": "Importer",
  "feel.importTitle": "Importer un feeling",
  "feel.importBody": "Colle un code pour l'ajouter à ta liste.",
  ...
  "live.moreActions": "Autres actions",
  "live.adoptTitle": "Publier depuis une autre machine",
  "live.adoptHint":
    "Colle une clé propriétaire copiée depuis la machine qui a créé le code. Elle permet à cette machine d'y publier des mises à jour.",
  ...
  "overlay.needsSetup": "Termine d'abord la configuration de {{app}} dans sa fenêtre principale — elle doit savoir où se trouve ton dossier {{game}}.",
  ...
  "showcase.v0137.hero.body":
    "L'onglet Serveurs liste tous les serveurs de la liste maître avec leur vrai ping, le circuit réellement roulé et la session en cours. Il continue de fonctionner pendant que MX Bikes tourne : l'app interroge chaque serveur directement, donc rien ne se dispute ton compte avec le jeu.",
  "showcase.v0137.whoson":
    "Ouvre un serveur pour voir qui y roule, ce qu'il autorise et le circuit en cours — avec son image si tu l'as, et où l'obtenir sinon.",
  "showcase.v0137.cheats":
    "Les serveurs qui affichent des cheats sont masqués, selon les mêmes règles que FrostMod applique en jeu. L'onglet indique combien il en a masqués et te laisse les voir.",
  "showcase.v0137.livecodes":
    "Des codes de partage qui restent à jour. Envoie un code court une fois, puis publie de nouvelles versions dedans : tous ceux qui l'ont collé les reçoivent, et Auto les installe.",
  "showcase.v0137.viewer":
    "La vue 3D dessine le vrai sol d'un circuit : chaque couche avec sa propre texture à travers les masques du circuit, ses décors dans leurs textures et le ciel qu'il embarque.",
  "showcase.v0137.ranked":
    "Un onglet Ranked avec ton rang MXB Ranked, tes MXP, tes stats de saison et tes 50 dernières courses. Rien à créer : ton GUID vient de Steam.",
  "showcase.v0137.look":
    "Un nouveau look. La navigation passe dans une barre en haut, les visuels des mods prennent toute la largeur — sept par ligne au lieu de cinq.",
  "showcase.v0124.hero.title":
    "Toute la grille dans la peinture qu'elle a vraiment choisie",
  "showcase.v0124.hero.body":
    "MX Bikes ne transmet aucun contenu personnalisé : un lobby d'inconnus a toujours été un lobby de livrées par défaut. {{app}} partage désormais ce que vous portez avec les pilotes autour de vous et installe les leurs — sur n'importe quel serveur, sans rien à faire côté hébergeur et sans code à saisir.",
  ...
  "showcase.v0124.everyone":
    "Vous verrez tout pilote qui a aussi {{app}}. Plus votre lobby en compte, plus la grille est correcte.",
  ...
  "showcase.v0124.stats":
    "{{app}} compte désormais anonymement quelles pages et fonctions sont utilisées — un identifiant aléatoire et rien sur vous. Paramètres → Général le désactive.",
  ...
  "showcase.v080.hero.title": "{{app}} gère aussi GP Bikes",
  ...
  "showcase.v070.languages": "{{app}} parle six langues — choisis la tienne dans Paramètres → Apparence.",
  ...
  "logs.desc":
    "Les fichiers à envoyer quand quelque chose ne va pas. {{app}}, FrostMod et {{game}} ont chacun les leurs — ouvre le dossier qu'il te faut, enregistre le tout dans un zip, ou partage-le sous forme de lien à coller dans un rapport.",
  "logs.appLogs": "{{app}}",
  ...
  "settings.supportersDesc": "Les personnes qui font vivre {{app}} sur Buy Me a Coffee.",
  "supporters.intro":
    "{{app}} est gratuite, et le restera. Les cafés ci-dessous paient le temps passé dessus : celles et ceux qui les ont offerts sont la raison pour laquelle il y a une nouvelle version à installer.",
  ...
  "reshade.loosePreset": "Dans ton dossier de jeu — pas installé par {{app}}",
  ...
  "protect.ownDesc": "L'identité sous laquelle MX Bikes te connaît. Elle n'est dans aucun fichier — Steam la fournit à la connexion — donc l'app la lit dans le jeu en cours d'exécution.",
  "protect.copy": "Copier",
  "protect.copied": "Copié",
  "track.ground": "Terrain",
  "track.features": "Éléments",
  "track.corners": "Virages",
  "track.problems": "À corriger",
  "track.install": "Installer",
  "track.installed": "Aperçu installé",
  "track.installFailed": "Installation impossible",
  ...
  "track.openStudio": "Ouvrir le Studio de circuits",
  "track.buildingTitle": "Compilation de « {{name}} »",
  "track.compiled": "Compilé",
  "track.getTools": "Télécharger les outils de piste",
  "track.gettingTools": "Téléchargement…",
  "track.toolsReady": "Outils de piste prêts",
  ...
  "plugins.redeemed": "{{name}} est sous licence sur ce compte.",
  "plugins.available": "Disponibles",
  "plugins.refresh": "Actualiser",
  "plugins.loading": "Vérification de vos licences…",
  "plugins.none": "Rien de disponible pour l'instant.",
  "plugins.install": "Installer",
  "plugins.update": "Mettre à jour",
  "plugins.installed": "{{name}} est installé et actif.",
  ...
  "plugins.updateDetail": "vous avez la {{installed}}, la {{latest}} est sortie.",
  "plugins.needsCheck": "Vérification requise",
  "plugins.needsCheckDetail": "cela fait une semaine que le control plane est injoignable. Connectez-vous et actualisez.",
  "plugins.lapsed": "Expiré",
  "plugins.lapsedDetail": "votre licence a expiré le {{date}}. Utilisez une clé pour continuer.",
  "plugins.notLicensed": "Sans licence",
  "plugins.notLicensedDetail": "utilisez une clé ci-dessus pour le débloquer.",
  ...
  // ── MXB Ranked ─────────────────────────────────────────────────────────────
  "nav.ranked": "Ranked",
  "nav.serverBrowser": "Navigateur",
  "ranked.changeGuid": "GUID",
  "ranked.refresh": "Actualiser",
  "ranked.openSite": "Sur mxb-ranked",
  "ranked.loading": "Lecture de votre profil sur mxb-ranked.com…",
  ...
  "ranked.since": "membre depuis le {{date}}",
  "ranked.manualGuid": "saisi à la main",
  "ranked.exp": "EXP",
  "ranked.riderRating": "Note pilote",
  "ranked.penaltyPoints": "Pts de pénalité",
  "ranked.globalAvg": "Moyenne globale : {{value}}",
  "ranked.rank": "Rang {{rank}}",
  "ranked.races": "Courses",
  "ranked.avgPosition": "Position moy.",
  "ranked.wins": "Victoires",
  "ranked.podiums": "Podiums",
  "ranked.wrLaps": "Tours WR",
  "ranked.pbLaps": "Tours PB",
  "ranked.holeshots": "Holeshots",
  "ranked.track": "Circuit",
  "ranked.server": "Serveur",
  "ranked.position": "Pos",
  "ranked.bike": "Moto",
  "ranked.mxp": "MXP",
