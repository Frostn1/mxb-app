...
export const RELEASES: Release[] = [
  {
    ...
    hero: {
      icon: Globe,
      title: "showcase.v0170.hero.title",
      body: "showcase.v0170.hero.body",
    },
    highlights: [
      { icon: RefreshCw, text: "showcase.v0170.browser" },
      { icon: Users, text: "showcase.v0170.book" },
      { icon: Zap, text: "showcase.v0170.check" },
    ],
  },
  {
    version: "0.16.0",
    hero: {
      icon: Shield,
      title: "showcase.v0160.hero.title",
      body: "showcase.v0160.hero.body",
    },
    highlights: [
      { icon: FolderInput, text: "showcase.v0160.trainers" },
      { icon: Gauge, text: "showcase.v0160.reports" },
      { icon: Shield, text: "showcase.v0160.steam" },
    ],
  },
  {
    version: "0.15.0",
    hero: {
      icon: Download,
      title: "showcase.v0150.hero.title",
      body: "showcase.v0150.hero.body",
    },
    highlights: [
      { icon: Mountain, text: "showcase.v0150.pictures" },
  ...
  },
  {
    ...
    hero: {
      icon: Globe,
      title: "showcase.v0137.hero.title",
      body: "showcase.v0137.hero.body",
    },
    highlights: [
      { icon: Users, text: "showcase.v0137.whoson" },
      { icon: ShieldAlert, text: "showcase.v0137.cheats" },
      { icon: Share2, text: "showcase.v0137.livecodes" },
      { icon: Mountain, text: "showcase.v0137.viewer" },
      { icon: BarChart3, text: "showcase.v0137.ranked" },
      { icon: Monitor, text: "showcase.v0137.look" },
    ],
  },
  {
    version: "0.12.4",
