...
export const es: Record<keyof typeof en, string> = {
  ...
  "modType.autoDest": "Motos o Piloto, según lo que contenga",
  ...
  "trackViewer.gameView": "Vista de juego",
  ...
  "overlay.tab.locker": "Taquilla",
  "overlay.tab.browse": "Explorar",
  "overlay.tab.manage": "Modo carrera",
  "overlay.tab.tips": "Consejos",
  ...
  "uninstall.label": "Desinstalar {{app}}",
  "uninstall.desc": "Elimina esta app de tu ordenador. El juego MX Bikes y tus otras apps no se tocan.",
  "uninstall.manual": "Esta copia se instaló con el gestor de paquetes de tu sistema, así que elimínala desde ahí:",
  "uninstall.copy": "Copiar",
  "uninstall.button": "Desinstalar",
  "uninstall.title": "¿Desinstalar {{app}}?",
  "uninstall.whatLaunch": "{{app}} se cerrará y se abrirá su desinstalador para terminar.",
  "uninstall.whatTrash": "{{app}} se cerrará y se moverá a la Papelera.",
  "uninstall.whatDelete": "{{app}} se cerrará y borrará su AppImage.",
  "uninstall.kept": "Tu carpeta del juego MX Bikes, los mods y las grabaciones se quedan donde están.",
  "uninstall.deleteData": "Borrar también mis datos",
  "uninstall.deleteDataDesc": "Elimina también los ajustes, cachés y registros de esta app. Si está desactivado, al reinstalar sigues donde lo dejaste.",
  "uninstall.deleteDataShared": "No disponible mientras {{apps}} esté instalado: guarda sus ajustes en la misma carpeta.",
  "uninstall.nsisNote": "El desinstalador también tiene una casilla \"Borrar los datos de la aplicación\". Elimina la misma carpeta que el interruptor de arriba.",
  "uninstall.nsisShared": "Deja sin marcar la casilla \"Borrar los datos de la aplicación\" del desinstalador: esa carpeta se comparte con {{apps}} y marcarla lo restablecería.",
  "uninstall.typeName": "Escribe {{app}} para confirmar",
  "uninstall.cancel": "Cancelar",
  "uninstall.confirm": "Desinstalar {{app}}",
  "uninstall.working": "Cerrando…",
};
