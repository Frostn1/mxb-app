...
export const de: Record<keyof typeof en, string> = {
  ...
  "modType.autoDest": "Motorräder oder Fahrer, je nach Inhalt",
  ...
  // ── Umfrage ────────────────────────────────────────────────────────────────
  "survey.eyebrow": "Kurze Frage",
  "survey.mood.ask": "Wie läuft {{app}} bei dir?",
  "survey.mood.bad": "Schlecht",
  "survey.mood.fine": "Geht so",
  "survey.mood.good": "Gut",
  "survey.followUp.whatHappened": "Was ist passiert?",
  "survey.followUp.anythingElse": "Möchtest du etwas ergänzen?",
  "survey.reason.crash": "Abgestürzt oder eingefroren",
  "survey.reason.slow": "Zu langsam",
  "survey.reason.confusing": "Schwer, etwas zu finden",
  "survey.reason.broken": "Etwas hat nicht funktioniert",
  "survey.reason.missing": "Etwas fehlt",
  "survey.reason.other": "Etwas anderes",
  "survey.note.placeholder": "Möchtest du etwas ergänzen? (optional)",
  "survey.note.hint":
    "Wird genau so gesendet, wie du es schreibst — bitte nichts Persönliches.",
  "survey.send": "Senden",
  "survey.skip": "Überspringen",
  "survey.thanks": "Danke — das hilft uns.",
  "survey.setting.label": "Gelegentliche Fragen",
  "survey.setting.desc":
    "Erlaubt der App, ab und zu zu fragen, wie es läuft und was du von etwas Neuem hältst. Aus heißt: sie fragt nie.",
  "uninstall.label": "{{app}} deinstallieren",
  "uninstall.desc": "Entfernt diese App von deinem Computer. Das Spiel MX Bikes und deine anderen Apps bleiben unberührt.",
  "uninstall.manual": "Diese Kopie wurde über die Paketverwaltung deines Systems installiert. Entferne sie dort:",
  "uninstall.copy": "Kopieren",
  "uninstall.button": "Deinstallieren",
  "uninstall.title": "{{app}} deinstallieren?",
  "uninstall.whatLaunch": "{{app}} wird geschlossen, und das Deinstallationsprogramm öffnet sich, um den Rest zu erledigen.",
  "uninstall.whatTrash": "{{app}} wird geschlossen und verschiebt sich in den Papierkorb.",
  "uninstall.whatDelete": "{{app}} wird geschlossen und löscht sein AppImage.",
  "uninstall.kept": "Dein MX-Bikes-Spielordner, deine Mods und Aufzeichnungen bleiben, wo sie sind.",
  "uninstall.deleteData": "Auch meine Daten löschen",
  "uninstall.deleteDataDesc": "Entfernt auch die Einstellungen, Caches und Logs dieser App. Aus heißt: Nach einer Neuinstallation geht es dort weiter, wo du aufgehört hast.",
  "uninstall.deleteDataShared": "Nicht verfügbar, solange {{apps}} installiert ist: Es speichert seine Einstellungen im selben Ordner.",
  "uninstall.nsisNote": "Das Deinstallationsprogramm hat auch ein Kästchen „Anwendungsdaten löschen“. Es entfernt denselben Ordner wie der Schalter oben.",
  "uninstall.nsisShared": "Lass das Kästchen „Anwendungsdaten löschen“ im Deinstallationsprogramm leer: Der Ordner wird mit {{apps}} geteilt, und ein Haken würde es zurücksetzen.",
  "uninstall.typeName": "Gib zur Bestätigung {{app}} ein",
  "uninstall.cancel": "Abbrechen",
  "uninstall.confirm": "{{app}} deinstallieren",
  "uninstall.working": "Wird geschlossen…",
};
