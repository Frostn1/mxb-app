...
export const en = {
  ...
  "uninstall.desc": "Removes this app from your computer. The MX Bikes game and your other apps aren't touched.",
  "uninstall.manual": "This copy was installed by your system's package manager, so remove it from there:",
  "uninstall.copy": "Copy",
  "uninstall.button": "Uninstall",
  "uninstall.title": "Uninstall {{app}}?",
  "uninstall.whatLaunch": "{{app}} will close and its uninstaller will open to finish the job.",
  "uninstall.whatTrash": "{{app}} will close and move itself to the Trash.",
  "uninstall.whatDelete": "{{app}} will close and delete its AppImage.",
  "uninstall.kept": "Your MX Bikes game folder, mods and recordings stay where they are.",
  "uninstall.deleteData": "Also delete my data",
  "uninstall.deleteDataDesc": "Removes this app's settings, caches and logs too. Off means a reinstall picks up where you left off.",
  "uninstall.deleteDataShared": "Not available while {{apps}} is installed: it keeps its settings in the same folder.",
  "uninstall.nsisNote": "The uninstaller also has a \"Delete the application data\" box. It removes the same folder as the switch above.",
  "uninstall.nsisShared": "Leave the uninstaller's \"Delete the application data\" box unticked: that folder is shared with {{apps}}, and ticking it would reset them.",
  "uninstall.typeName": "Type {{app}} to confirm",
  "uninstall.cancel": "Cancel",
  "uninstall.confirm": "Uninstall {{app}}",
  "uninstall.working": "Closing…",
} as const;
