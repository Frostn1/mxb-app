...
export const it: Record<keyof typeof en, string> = {
  ...
  "modType.bikelifeInline": "mod bikelife",
  "modType.autoDest": "Moto o Pilota, in base al contenuto",
  ...
  "trackViewer.gameView": "Vista di gioco",
  ...
  "overlay.tab.presets": "Preset",
  "overlay.tab.locker": "Armadietto",
  "overlay.tab.browse": "Esplora",
  "overlay.tab.manage": "Modalità gara",
  "overlay.tab.tips": "Consigli",
  ...
  "uninstall.desc": "Rimuove questa app dal computer. Il gioco MX Bikes e le altre app non vengono toccati.",
  "uninstall.manual": "Questa copia è stata installata dal gestore di pacchetti del sistema, quindi rimuovila da lì:",
  "uninstall.copy": "Copia",
  "uninstall.button": "Disinstalla",
  "uninstall.title": "Disinstallare {{app}}?",
  "uninstall.whatLaunch": "{{app}} si chiuderà e si aprirà il suo programma di disinstallazione per finire.",
  "uninstall.whatTrash": "{{app}} si chiuderà e si sposterà nel Cestino.",
  "uninstall.whatDelete": "{{app}} si chiuderà ed eliminerà il suo AppImage.",
  "uninstall.kept": "La cartella del gioco MX Bikes, le mod e le registrazioni restano dove sono.",
  "uninstall.deleteData": "Elimina anche i miei dati",
  "uninstall.deleteDataDesc": "Rimuove anche impostazioni, cache e log di questa app. Se è disattivato, reinstallando riprendi da dove eri.",
  "uninstall.deleteDataShared": "Non disponibile finché {{apps}} è installato: tiene le sue impostazioni nella stessa cartella.",
  "uninstall.nsisNote": "Il programma di disinstallazione ha anche una casella \"Elimina i dati dell'applicazione\". Rimuove la stessa cartella dell'interruttore sopra.",
  "uninstall.nsisShared": "Lascia deselezionata la casella \"Elimina i dati dell'applicazione\" del programma di disinstallazione: quella cartella è condivisa con {{apps}} e selezionarla lo reimposterebbe.",
  "uninstall.typeName": "Scrivi {{app}} per confermare",
  "uninstall.cancel": "Annulla",
  "uninstall.confirm": "Disinstalla {{app}}",
  "uninstall.working": "Chiusura…",
};
