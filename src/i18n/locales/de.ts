...
export const de: Translation = {
  ...
  "track.previewOnly": "Die Vorschau ist nur Gelände — das Spiel listet sie auf und lädt sie nicht. Führe TerrainEd über den exportierten Ordner aus, um eine fahrbare Strecke zu erhalten.",
  "track.at": "Bei",
  "track.kind": "Art",
  "track.height": "Höhe",
  "track.length": "Länge",
