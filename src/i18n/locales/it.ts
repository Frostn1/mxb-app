...
export const it: Translation = {
  ...
  "pose.dragHint": "Trascina i punti sul pilota per muovere un arto: a ruotare è l'articolazione sopra quella che afferri. Gli slider servono per la torsione e i valori esatti.",
