...
export const en = {
  ...
  "track.previewOnly": "The preview is terrain only — the game will list it and fail to load it. Run TerrainEd over the exported folder to get a track you can ride.",
  "track.at": "At",
  "track.kind": "Kind",
  "track.height": "Height",
  "track.length": "Length",
