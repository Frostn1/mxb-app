...
export const es: Translation = {
  ...
  "overlay.borderlessNote": "Pon MX Bikes en modo sin bordes o en ventana desde Options → Video. Nada se puede dibujar sobre un juego en pantalla completa exclusiva — el overlay incluido.",
